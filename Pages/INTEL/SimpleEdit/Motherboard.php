...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-INTEL/Category: Simple Edit/Motherboard select</TITLE>
...
<SECTION>
          ...
          <?php
            if (isset($_POST["hiddenButton"])) {
              if ($_POST["hiddenInput"] == "CPU") {
                ...
                echo '<form action="../../../../Pages/INTEL/SimpleEdit/PCCase" method="post" id="formButtonChange" name="formButtonChange">
    ...
    if ($_POST["brandModelCPU"] != "") {
        ...
        if ($notSearch == 0) {
          ...
          $sql = "SELECT * FROM MOTHERBOARD WHERE Category='Simple Edit' AND Description LIKE '%$search_expression%'";
          $result = $conn->query($sql);
          if ($result->num_rows <=0 ) {
            $sql = "SELECT * FROM MOTHERBOARD WHERE Category='Simple Edit' AND Description LIKE '%$search_post%'";
            $result = $conn->query($sql);
            if ($result->num_rows <=0 ) {
              $sql = "SELECT * FROM MOTHERBOARD WHERE Category='Simple Edit'$keywords";
              $result = $conn->query($sql);
            }
          }
          if ($result->num_rows > 0) {
                  ...
                  if ($cpuMod == "INTEL" && $row["Socket"] == $_POST["SocketCPU"]) {
                    foreach($microMod as $microMod) {     //echo $microMod. '<br>'; 
                      ...
                      if ($_POST["hiddenInput"] == "CPU") {
                        ...
                        echo '<form action="../../../../Pages/INTEL/SimpleEdit/PCCase" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                              <input type="hidden" id="hiddenInput" name="hiddenInput" value="CASE">';
                              //DATA FROM RAM CHOOSE
                              echo '<input type="hidden" id="RamPiece" name="RamPiece" value="Ram">';
                              echo '<input type="hidden" id="brandModelRAM" name="brandModelRAM" value="'. $_POST["brandModelRAM"]. '">';
                    ...
                    //DATA FROM BLUETOOTH ADAPTERS
                        ...
                        echo '</div>';
                        echo '<input type="hidden" id="categoryMOTHER" name="categoryMOTHER" value="Simple Edit">';
		...
		<center><div class="no-results-search-message">
            ...
            $sql = "SELECT * FROM MOTHERBOARD WHERE Category='Simple Edit'";
            $result = $conn->query($sql);
