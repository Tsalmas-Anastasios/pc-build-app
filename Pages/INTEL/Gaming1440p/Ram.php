...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-INTEL/Category: Hard Gaming in 1440p/Ram select</TITLE>
...
<SECTION>
    ...
    if ($_POST["brandModelCPU"] != "") {
        ...
        if ($notSearch == 0) {
          ...
          $sql = "SELECT * FROM RAM WHERE Category='Hard Gaming in 1440p' AND Description LIKE '%$search_expression%'";
          $result = $conn->query($sql);
          if ($result->num_rows <=0 ) {
            $sql = "SELECT * FROM RAM WHERE Category='Hard Gaming in 1440p' AND Description LIKE '%$search_post%'";
            $result = $conn->query($sql);
            if ($result->num_rows <=0 ) {
              $sql = "SELECT * FROM RAM WHERE Category='Hard Gaming in 1440p'$keywords";
              $result = $conn->query($sql);
              if ($result->num_rows <= 0) {
                $sql = "SELECT * FROM RAM WHERE Category='Hard Gaming in 1440p'";
                $result = $conn->query($sql);
          ...
          if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                  ...
                  if ($ramSpMod == $row["speed"]) {
                    ...
                    //DATA FROM BLUETOOTH ADAPTERS
                      ...
                      echo '<button type="button" class="productCard-Button"></font></button>
                              ...
                              echo '</div>';
                      echo '</div>';
                      echo '<input type="hidden" id="categoryRAM" name="categoryRAM" value="Hard Gaming in 1440p">';
              ...
              if ($metra == "0") {
                ...
                echo "<br><br><br>";
                echo '<form action="../../../../Pages/INTEL/Gaming1440p/Motherboard" method="post" name="NothingForm">';
