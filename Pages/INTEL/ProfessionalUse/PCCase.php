...
<head>
	...
	<TITLE>PC Build App-PC Builder-INTEL/Category: Heavy Professional Use/PC Case select</TITLE>
    ...
    <link rel="stylesheet" href="../../../../StyleSheets/INTEL/ModalBoxFilters.css">
    <link rel="stylesheet" href="../../../../StyleSheets/INTEL/specsRadioButtonsFilters.css">
    <link rel="stylesheet" href="../../../../StyleSheets/INTEL/CheckBoxForFilters.css">
...
<div id="error" style="display:none;">
  ...
  &nbsp;&nbsp;&nbsp;<font color="#333333">or you can make your </font><b><a href="../../../../Pages/PCBuilderINTEL" style="text-decoration: none; color: #1a0033fa;">INTEL PC BUILD</a></b><font color="#333333"> or </font><b><a href="../../../../Pages/PCBuilderINTEL" style="text-decoration: none; color: #1a0033fa;">INTEL PC BUILD</a></b></font></font>
<br><br><br>
...
<!--<div class="header">
  ...
  <div class="categoryHeader">
    <center><p><b>Heavy Professional Use</b></p></center>
  </div>
</header>
</div>-->
...
<SECTION>
    ...
    <div class="backToCategoriesButton"> 
          ...
          <?php
            if (isset($_POST["hiddenButton"])) {
              if ($_POST["hiddenInput"] == "CPU") {
                echo '<form action="../../../../Pages/INTEL/ProfessionalUse/CPU" method="post" id="formButtonChange" name="formButtonChange">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="CPU">';
              } elseif ($_POST["hiddenInput"] == "MOTHERBOARD") {
                echo '<form action="../../../../Pages/INTEL/ProfessionalUse/Motherboard" method="post" id="formButtonChange" name="formButtonChange">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="MOTHERBOARD">';
              } elseif ($_POST["hiddenInput"] == "RAM") {
                echo '<form action="../../../../Pages/INTEL/ProfessionalUse/RAM" method="post" id="formButtonChange" name="formButtonChange">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="RAM">';
              } elseif ($_POST["hiddenInput"] == "GPU") {
                echo '<form action="../../../../Pages/INTEL/ProfessionalUse/GPU" method="post" id="formButtonChange" name="formButtonChange">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="GPU">';
              } elseif ($_POST["hiddenInput"] == "PSU") {
                echo '<form action="../../../../Pages/INTEL/ProfessionalUse/PSU" method="post" id="formButtonChange" name="formButtonChange">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="PSU">';
              } elseif ($_POST["hiddenInput"] == "HARD") {
                echo '<form action="../../../../Pages/INTEL/ProfessionalUse/HardDrive" method="post" id="formButtonChange" name="formButtonChange">
                ...
                echo '<form action="../../../../Pages/PCBuilderPCBuild" method="post" id="formButtonChange" name="formButtonChange">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="OK">';
        ...
        <!--<br>-->
          <script>
              function cpuFun() {
                  document.getElementById("goToListForm").action = "../../../../Pages/INTEL/ProfessionalUse/CPU";
                  var submitForm = document.getElementsByName('goToListForm')
                  submitForm[0].submit();
              }

              function motherFun() {
                  document.getElementById("goToListForm").action = "../../../../Pages/INTEL/ProfessionalUse/Motherboard";
                  var submitForm = document.getElementsByName('goToListForm')
                  submitForm[0].submit();
              }

              function ramFun() {
                  document.getElementById("goToListForm").action = "../../../../Pages/INTEL/ProfessionalUse/Ram";
                  var submitForm = document.getElementsByName('goToListForm')
                  submitForm[0].submit();
              }

              function gpuFun() {
                        document.getElementById("goToListForm").action = "../../../../Pages/INTEL/ProfessionalUse/GPU";
                        var submitForm = document.getElementsByName('goToListForm')
                        submitForm[0].submit();
              }

              function psuFun() {
                        document.getElementById("goToListForm").action = "../../../../Pages/INTEL/ProfessionalUse/PSU";
                        var submitForm = document.getElementsByName('goToListForm')
                        submitForm[0].submit();
              }

              function hardFun() {
                        document.getElementById("goToListForm").action = "../../../../Pages/INTEL/ProfessionalUse/HardDrive";
                        var submitForm = document.getElementsByName('goToListForm')
                        submitForm[0].submit();
              }
            </script>
        <div class="goToList" id="goToList">
          <form method="post" id="goToListForm" name="goToListForm">
            ...
            <input type="hidden" id="hiddenButton" name="hiddenButton" value="1">
                <input type="hidden" id="cpubrand" name="brandModelCPU" value="<?php $_POST["brandModelCPU"] ?>">
          <?php
            //FOR CPU
            echo '<input type="hidden" id="MicroCPU" name="MicroCPU" value="'. $_POST["MicroCPU"]. '">';
            echo '<input type="hidden" id="SocketCPU" name="SocketCPU" value="'. $_POST["SocketCPU"]. '">';
            ...
            //DATA FROM BLUETOOTH ADAPTERS
          ?>
          <CENTER><font color="#42a832"><B><a onclick="cpuFun()" CLASS="readyPiece"><i class="fas fa-check-circle"></i>  CPU </a></font><font color="#0071c5"><i class="fas fa-long-arrow-alt-right"></i></font></B>
          <b><font color="#42a832"><a onclick="motherFun()" class="readyPiece"><i class="fas fa-check-circle"></i> Motherboard</a></font></b> <font color="#0071c5"><i class="fas fa-long-arrow-alt-right"></i></font>
          <b><font color="#42a832"><a onclick="ramFun()" class="readyPiece"><i class="fas fa-check-circle"></i> Ram</a></font></b><font color="#0071c5"><i class="fas fa-long-arrow-alt-right"></i></font>
          <b><font color="#42a832"><a onclick="gpuFun()" class="readyPiece"><i class="fas fa-check-circle"></i> GPU</a></font></b><font color="#0071c5"><i class="fas fa-long-arrow-alt-right"></i></font>
          <b><font color="#42a832"><a onclick="psuFun()" class="readyPiece"><i class="fas fa-check-circle"></i> PSU</a></font></b><font color="#0071c5"><i class="fas fa-long-arrow-alt-right"></i></font>
          <b><font color="#42a832"><a onclick="hardFun()" class="readyPiece"><i class="fas fa-check-circle"></i> Hard Drive</a></font></b><font color="#0071c5"><i class="fas fa-long-arrow-alt-right"></i></font>
          <b><u>PC Case</u></b></CENTER>
        </form>
      </div>
...
<br><div class="frameForProductCards">
  <?php
        ...
        echo '<form method="post"><div class="modal" id="modal1">
            ...
            <section class="modal-content">
                ...
                <input type="hidden" id="hiddenInput" name="hiddenInput" value="CASE">';
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                      $motherboardSizeChar = "";
                      $motherSizeExplode = explode(',', $row["motherboard"]);
                      foreach($motherSizeExplode as $motherSizeExplode) {
                        if ($motherSizeExplode == $_POST["MOTHERsize"]) {
                          $motherboardSizeChar == $motherSizeExplode;
                          $motherSize++;
                          if ($row["size"] == "Midi Tower") {
                            $midi++;
                          } elseif ($row["size"] == "Full Tower") {
                            $full++;
                          } elseif ($row["size"] == "Mini Tower") {
                            $mini++;
                          } elseif ($row["size"] == "Micro Tower") {
                            $micro++;
                          } elseif ($row["size"] == "Cube") {
                            $cube++;
                          } elseif ($row["size"] == "Home Theater") {
                            $home++;
                          } elseif ($row["size"] == "Ultra Tower") {
                            $ultra++;
                          } elseif ($row["size"] == "Tiny") {
                            $tiny++;
                          }
                        } else {
                          $motherboardSizeChar = "";
                    ...
                    if ($midi > 0 or $full > 0 or $mini > 0 or $micro > 0 or $cube > 0 or $home > 0 or $ultra > 0 or $tiny > 0) {
                    ...
                    if ($midi > 0) {
                      echo '<label class="containerRadioButton">Midi Tower ('. $midi. ')
                        <input type="radio" name="caseType" id="midiTower" value="midiTower" onclick="enabledButtons()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>';
                    }
                    if ($full > 0) {
                      echo '<label class="containerRadioButton">Full Tower ('. $full. ')
                        <input type="radio" name="caseType" id="fullTower" value="fullTower" onclick="enabledButtons()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>';
                    }
                    if ($mini > 0) {
                      echo '<label class="containerRadioButton">Mini Tower ('. $mini. ')
                        <input type="radio" name="caseType" id="miniTower" value="miniTower" onclick="enabledButtons()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>';
                    }
                    if ($micro > 0) {
                      echo '<label class="containerRadioButton">Micro Tower ('. $micro. ')
                        <input type="radio" name="caseType" id="microTower" value="microTower" onclick="enabledButtons()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>';
                    }
                    if ($cube > 0) {
                      echo '<label class="containerRadioButton">Cube ('. $cube. ')
                        <input type="radio" name="caseType" id="Cube" value="Cube" onclick="enabledButtons()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>';
                    }
                    if ($home > 0) {
                      echo '<label class="containerRadioButton">Home Theater ('. $home. ')
                        <input type="radio" name="caseType" id="homeTheater" value="homeTheater" onclick="enabledButtons()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>';
                    }
                    if ($ultra > 0) {
                      echo '<label class="containerRadioButton">Ultra Tower ('. $ultra. ')
                        <input type="radio" name="caseType" id="ultraTower" value="ultraTower" onclick="enabledButtons()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>';
                    }
                    if ($tiny > 0) {
                      echo '<label class="containerRadioButton">Tiny ('. $tiny. ')
                        <input type="radio" name="caseType" id="tiny" value="tiny" onclick="enabledButtons()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>';
                    }
                  }
                ...
                echo '<input type="hidden" id="EkptwshHARD" name="EkptwshHARD" value="'. $_POST["EkptwshHARD"]. '">';
                //DATA FROM HARD DRIVE CHOOSE
                //DATA IF ISSET PC CASE
                if (isset($_POST["CASEPiece"])) {
                  //DATA FROM PC CASE CHOOSE
                  echo '<input type="hidden" id="CASEPiece" name="CASEPiece" value="PC Case">';
                  echo '<input type="hidden" id="brandModelCASE" name="brandModelCASE" value="'. $_POST["brandModelCASE"]. '">';
                  echo '<input type="hidden" id="ProductCodeCASE" name="ProductCodeCASE" value="'. $_POST["ProductCodeCASE"]. '">';
              ...
              <footer class="modal-footer" id="buttonsForFilters" style="display:none;">
                <div>
                  <p>
                    ...
                    <button class="clearButtonOnModalBox" name="clearFilters" value="clear">Clear</button>
                  </p>
                </div>
              </footer>
            <!----------------------Buttons for form---------------------->
        ...
        if(isset($_POST["searchBar"])) {
          ...
          if ($searcher == 1) {
            if ($notSearch == 0) {
              ...
              $sql = "SELECT * FROM PCCase WHERE Description LIKE '%$search_expression%'";
              $result = $conn->query($sql);
              if ($result->num_rows <= 0) {
                $sql = "SELECT * FROM PCCase WHERE Description LIKE '%$search_post%'";
                $result = $conn->query($sql);
                if ($result->num_rows <=0 ) {
                  $sql = "SELECT * FROM PCCase WHERE $keywords";
                  $result = $conn->query($sql);
                  if ($result->num_rows <= 0) {
                  $sql = "SELECT * FROM PCCase";
                  $result = $conn->query($sql);
		...
		<center><div class="no-one-character-message">
            ...
            if ($result->num_rows > 0) {
              ...
              while($row=$result->fetch_assoc()) {
                ...
                if ($_POST["hiddenInput"] == "CPU") {
                  echo '<form action="../../../../Pages/INTEL/ProfessionalUse/CPU" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                    <input type="hidden" id="hiddenInput" name="hiddenInput" value="CPU">';
                } elseif ($_POST["hiddenInput"] == "MOTHERBOARD") {
                  echo '<form action="../../../../Pages/INTEL/ProfessionalUse/Motherboard" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                    <input type="hidden" id="hiddenInput" name="hiddenInput" value="MOTHERBOARD">';
                } elseif ($_POST["hiddenInput"] == "RAM") {
                  echo '<form action="../../../../Pages/INTEL/ProfessionalUse/RAM" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                    <input type="hidden" id="hiddenInput" name="hiddenInput" value="RAM">';
                } elseif ($_POST["hiddenInput"] == "GPU") {
                  echo '<form action="../../../../Pages/INTEL/ProfessionalUse/GPU" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                    <input type="hidden" id="hiddenInput" name="hiddenInput" value="GPU">';
                } elseif ($_POST["hiddenInput"] == "PSU") {
                  echo '<form action="../../../../Pages/INTEL/ProfessionalUse/PSU" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                    <input type="hidden" id="hiddenInput" name="hiddenInput" value="PSU">';
                } elseif ($_POST["hiddenInput"] == "HARD") {
                  echo '<form action="../../../../Pages/INTEL/ProfessionalUse/HardDrive" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                    <input type="hidden" id="hiddenInput" name="hiddenInput" value="HARD">';
                } elseif ($_POST["hiddenInput"] == "CASE") {
                ...
                echo '<input type="hidden" id="brandModelCASE" name="brandModelCASE" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                echo '<b><font size="2px">Product Code: '. $row["ProductCode"]. '</font></b>';  
                echo '<input type="hidden" id="ProductCodeCASE" name="ProductCodeCASE" value="'. $row["ProductCode"]. '">';
                echo '<br><br><font color="#ccc"><b>'. $caseType. '</b></font><br><br>';
                echo '<button type="button" class="productCard-Button"></font></button>
                  <div class="specs">';
                    ...
                    echo '<center><font color="black"><table class="tableSpecs">
                      ...
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Compatible Motherboards</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["motherboard"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                      ...
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Maximum GPU Length</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["gpu"]. '</td>
                      </tr>
                      <tr class="tableSpecs">
                        <th class="rowsOnSpecs">Divice Positions</th>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">External Connections 5.25"</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["ekswterikes25"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">External Connection 3.5"</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["ekswterikes35"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Internal Connections 3.5"</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["eswterikes35"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Internal Connections 2.5"</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["eswterikes25"]. '</td>
                      </tr>
                      <tr class="tableSpecs">
                        <th class="rowsOnSpecs">Fan Positions</th>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Front Postions</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["mpFridge"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Back Positions</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["piFridge"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Side Positions</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["plFridge"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Upper Positions</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["anFridge"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Lower Positions</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["kaFridge"]. '</td>
                      </tr>
                      <tr class="tableSpecs">
                        <th class="rowsOnSpecs">Water Cooling support</th>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Fridge Position</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["fridge"]. '</td>
                      </tr>
                      <tr class="tableSpecs">
                        <th class="rowsOnSpecs">Features</th>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Connectivity</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["conn"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Additives</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["plus"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Gaming</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["gaming"]. '</td>
                      </tr>
                      <tr class="tableSpecs">
                      ...
                      <tr class="rowsOnSpecsTR">
                        ...
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["color"]. '</td>
                      </tr>
                    </table></font></center>';
                  echo '</div>';
                echo '</div>';
                echo '<input type="hidden" id="categoryCASE" name="categoryCASE" value="---">';
                //INFO OF PRODUCTS-END
                //PRICE OF PRODUCTS
                echo '<div class="productCardpreview">';
                if ($ekptwshPrice == $PriceMod) {
                  echo '<h2 align="right">'. $row["Price"]. '€</h2>';
                  echo '<input type="hidden" id="PriceCASE" name="PriceCASE" value="'. $row["Price"]. '">';
                  echo '<input type="hidden" id="EkptwshCASE" name="EkptwshCASE" value="">';
                  ...
                  echo '<input type="hidden" id="PriceCASE" name="PriceCASE" value="'. $row["PriceEkptwsh"]. '">';
                  echo '<input type="hidden" id="EkptwshCASE" name="EkptwshCASE" value="'. $row["Price"]. '">';
                }
                if ($brINbutton = 0) {
                ...
                echo '<div class="cardMin" id="cardMin'. $onoma_for_title. '">';
                  ...
                  echo '<input type="hidden" id="categoryHARD" name="categoryHARD" value="'. $_POST["categoryHARD"]. '">';
                  echo '<input type="hidden" id="PriceHARD" name="PriceHARD" value="'. $_POST["PriceHARD"]. '">';
                  echo '<input type="hidden" id="EkptwshCPU" name="EkptwshHARD" value="'. $_POST["EkptwshHARD"]. '">';
                  //DATA FROM HARD DRIVE CHOOSE
        
                  echo '<input type="hidden" id="pieceCASE" name="CASEPiece" value="PC Case">';
                  ...
                  echo '<input type="hidden" id="brandModelCASE" name="brandModelCASE" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                  echo '<input type="hidden" id="ProductCodeCASE" name="ProductCodeCASE" value="'. $row["ProductCode"]. '">';
                  echo '<input type="hidden" id="categoryCASE" name="categoryCASE" value="---"><font color="#ccc">'. $caseType. '</font><br>';
                  if ($ekptwshPrice == $PriceMod) {
                    ...
                    echo '<div class="contentMin">';
                      echo '<table class="tableSpecsMin">
                        <!--ONE CATEGORY OF SPECS-->
                          ...
                          <!--ONE SPEC-->
                            <tr>
                              <td class="NameOfSpecsMin">Compatible Motherboards</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["motherboard"]. '</td>
                            </tr>
                          <!--ONE SPEC-->
                          <!--ONE SPEC-->
                            <tr>
                          ...
                          <!--ONE SPEC-->
                            <tr>
                              <td class="NameOfSpecsMin">Maximum GPU Length</td>
                            </tr>
                            <tr>
                        ...
                        <!--ONE CATEGORY OF SPECS-->
                          <tr>
                            <th class="KEFALIDAmin">Device Positions</th>
                          </tr>
                          <!--ONE SPEC-->
                            <tr>
                              <td class="NameOfSpecsMin">External Connections 5.25"</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["ekswterikes25"]. '</td>
                            </tr>
                          <!--ONE SPEC-->
                          <!--ONE SPEC-->
                            <tr>
                              <td class="NameOfSpecsMin">External Connections 3.5"</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["ekswterikes35"]. '</td>
                            </tr>
                          <!--ONE SPEC-->
                          <!--ONE SPEC-->
                            <tr>
                              <td class="NameOfSpecsMin">Internal Connections 3.5</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["eswterikes25"]. '</td>
                            </tr>
                          <!--ONE SPEC-->
                          <!--ONE SPEC-->
                            <tr>
                              <td class="NameOfSpecsMin">Internal Connections 2.5"</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["eswterikes25"]. '</td>
                            </tr>
                        ...
                        <!--ONE CATEGORY OF SPECS-->
                          <tr>
                            <th class="KEFALIDAmin">Fan Positions</th>
                          </tr>
                          <!--ONE SPEC-->
                            <tr>
                              <td class="NameOfSpecsMin">Front Positions</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["mpFridge"]. '</td>
                            </tr>
                          <!--ONE SPEC-->
                          <!--ONE SPEC-->
                            <tr>
                              <td class="NameOfSpecsMin">Back Positions</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["piFridge"]. '</td>
                            </tr>
                          <!--ONE SPEC-->
                          <!--ONE SPEC-->
                            <tr>
                              <td class="NameOfSpecsMin">Side Positions</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["plFridge"]. '</td>
                            </tr>
                          <!--ONE SPEC-->
                          <!--ONE SPEC-->
                            <tr>
                              <td class="NameOfSpecsMin">Upper Positions</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["anFridge"]. '</td>
                            </tr>
                          <!--ONE SPEC-->
                          <!--ONE SPEC-->
                            <tr>
                              <td class="NameOfSpecsMin">Lower Positions</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["kaFridge"]. '</td>
                            </tr>
                          <!--ONE SPEC-->
                        <!--ONE CATEGORY OF SPECS-->
                        <!--ONE CATEGORY OF SPECS-->
                        <tr>
                          <th class="KEFALIDAmin">Water Cooling support</th>
                        </tr>
                        <!--ONE SPEC-->
                            <tr>
                              <td class="NameOfSpecsMin">Fridge Position</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["fridge"]. '</td>
                            </tr>
                          <!--ONE SPEC-->
                        <!--ONE CATEGORY OF SPECS-->
                        <!--ONE CATEGORY OF SPECS-->
                        <tr>
                          <th class="KEFALIDAmin">Features</th>
                        </tr>
                        <!--ONE SPEC-->
                            <tr>
                            ...
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["conn"]. '</td>
                            </tr>
                          <!--ONE SPEC-->
                          <!--ONE SPEC-->
                            <tr>
                              <td class="NameOfSpecsMin">Additives</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["plus"]. '</td>
                            </tr>
                          <!--ONE SPEC-->
                          <!--ONE SPEC-->
                            <tr>
                              <td class="NameOfSpecsMin">Gaming</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["gaming"]. '</td>
                            </tr>
                          <!--ONE SPEC-->
                        <!--ONE CATEGORY OF SPECS-->
                        <!--ONE CATEGORY OF SPECS-->
                        ...
                        <!--ONE SPEC-->
                            ...
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["color"]. '</td>
                            </tr>
                          <!--ONE SPEC-->
                        <!--ONE CATEGORY OF SPECS-->
                      </table>';
        ...
        //------------------SEARCH ENGINE-----------------END------------------
        if (isset($_POST["submitFilters"]) && isset($_POST["caseType"]) && $searcher == 0) {
          $caseType = $_POST["caseType"];
          if ($caseType == "midiTower") {
            $caseType = "Midi Tower";
            echo '<script>
              document.getElementById("midiTower").checked = true;
              document.getElementById("buttonsForFilters").style.display = "block";
            </script>';
          } elseif ($caseType == "fullTower") {
            $caseType = "Full Tower";
            echo '<script>
              document.getElementById("fullTower").checked = true;
              document.getElementById("buttonsForFilters").style.display = "block";
            </script>';
          } elseif ($caseType == "miniTower") {
            $caseType = "Mini Tower";
            echo '<script>
              document.getElementById("miniTower").checked = true;
              document.getElementById("buttonsForFilters").style.display = "block";
            </script>';
          } elseif ($caseType == "microTower") {
            $caseType = "Micro Tower";
            echo '<script>
              document.getElementById("microTower").checked = true;
              document.getElementById("buttonsForFilters").style.display = "block";
            </script>';
          } elseif ($caseType == "Cube") {
            $caseType = "Cube";
            echo '<script>
              document.getElementById("Cube").checked = true;
              document.getElementById("buttonsForFilters").style.display = "block";
            </script>';
          } elseif ($caseType == "homeTheater") {
            $caseType = "Home Theater";
            echo '<script>
              document.getElementById("homeTheater").checked = true;
              document.getElementById("buttonsForFilters").style.display = "block";
            </script>';
          } elseif ($caseType == "ultraTower") {
            $caseType = "Ultra Tower";
            echo '<script>
              document.getElementById("ultraTower").checked = true;
              document.getElementById("buttonsForFilters").style.display = "block";
            </script>';
          } elseif ($caseType == "tiny") {
            $caseType = "Tiny";
            echo '<script>
              document.getElementById("tiny").checked = true;
              document.getElementById("buttonsForFilters").style.display = "block";
            </script>';
          }

          $sql = "SELECT * FROM PCCase WHERE size ='". $caseType. "'";
          $result = $conn->query($sql);
          if ($result->num_rows > 0) {
            $onoma_for_title = 0;
            $brINbutton = 0;
        ...
        } elseif (isset($_POST["clearFilters"]) && $searcher == 0) {
          $onoma_for_title = 0;
          $sql = "SELECT * FROM PCCase";
          $result = $conn->query($sql);
          if ($result->num_rows > 0) {
            ...
            while($row=$result->fetch_assoc()) {
              ...
              echo '<b><font size="2px">Product Code: '. $row["ProductCode"]. '</font></b>';  
              echo '<input type="hidden" id="ProductCodeCASE" name="ProductCodeCASE" value="'. $row["ProductCode"]. '">';
              echo '<br><br><font color="#ccc"><b>'. $row["size"]. '</b></font><br><br>';
              echo '<button type="button" class="productCard-Button"></font></button>
                <div class="specs">';
                  if ($row["Picture5"] != NULL) {
                    echo '<style>
              ...
              echo '<div class="cardMin" id="cardMin'. $onoma_for_title. '">';
                ...
                echo '<input type="hidden" id="brandModelCASE" name="brandModelCASE" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                echo '<input type="hidden" id="ProductCodeCASE" name="ProductCodeCASE" value="'. $row["ProductCode"]. '">';
                echo '<input type="hidden" id="categoryCASE" name="categoryCASE" value="---"><font color="#ccc">'. $row["size"]. '</font><br>';
                if ($ekptwshPrice == $PriceMod) {
                echo '<p class="priceMin">'. $row["Price"]. '€</p>';
                echo '<input type="hidden" id="PriceCASE" name="PriceCASE" value="'. $row["Price"]. '">';
                echo '<input type="hidden" id="EkptwshCASE" name="EkptwshCASE" value="">';
        ...
        echo "<br><br><br>";
		    echo '<b><center><font color="#0071c5"><font size="7">You should choose CPU first!</font></font></center></b>';
        echo '<br><br><br>';
        //LIST OF HARDWARE
        echo '<script>
  ...
  <!--------------------------FOR FILTERS------------------------------------>
  <script src="../../../../JavaScripts/INTEL/FiltersPCCase.js"></script>
  <!--------------------------FOR FILTERS------------------------------------>
...
<?php
  ...
  echo '<script>
    ...
    //WHEN MODAL CLOSE By Press the -X- button
    echo 'for (const el of closeEls) {
      el.addEventListener("click", function() {
        ...
        if (document.getElementById("cardHow").innerHTML == "B") {';
          ...
          document.getElementById("br-before-search-engine").innerHTML = "<br>";
        } else {';
          //FOR PRODUCT CARDS
          for($onoma_for_title = 1; $onoma_for_title<= $temp; $onoma_for_title++){
    ...
    //WHEN MODAL CLOSE By Press out of the Modal Box
    ...
    //WHEN MODAL CLOSE By Press the ESC button from keyboard
...
function WindowResize() {
  ...
  if (document.getElementById("cardHow").innerHTML == "B" && document.getElementById("modal1").className == "modal") {';
    ...
    document.getElementById("br-before-search-engine").innerHTML = "";
    document.getElementById("openModalMin").style.display = "none";
  }
}
</script>';
