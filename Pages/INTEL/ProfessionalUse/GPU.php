...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-INTEL/Category: Heavy Professional Use/GPU select</TITLE>
    ...
    <link rel="stylesheet" href="../../../StyleSheets/PC-Builder-General/non-gpu.css">
    ...
    <link rel="stylesheet" href="../../../../StyleSheets/INTEL/buttonForCpuGpu.css">
    ...
    <div class="backToCategoriesButton"> 
          ...
          <?php
            if (isset($_POST["hiddenButton"])) {
              if ($_POST["hiddenInput"] == "CPU") {
                ...
                echo '<input type="hidden" id="ProductCodePSU" name="ProductCodePSU" value="'. $_POST["ProductCodePSU"]. '">';
                echo '<input type="hidden" id="categoryPSU" name="categoryPSU" value="'. $_POST["categoryPSU"]. '">';
                echo '<input type="hidden" id="PricePSU" name="PricePSU" value="'. $_POST["PriceCPU"]. '">';
                echo '<input type="hidden" id="EkptwshPSU" name="EkptwshPSU" value="'. $_POST["EkptwshPSU"]. '">';
                //DATA FROM PSU CHOOSE
      ...
      <div class="goToList" id="goToList">
          ...
          ?>
				  ...
				  <b><font color="#42a832"><a onclick="ramFun()" class="readyPiece"><i class="fas fa-check-circle"></i> Ram</a></font></b><font color="#0071c5"><i class="fas fa-long-arrow-alt-right"></i></font>
			  	  <b><u>GPU</u></b> <font color="#0071c5"><i class="fas fa-long-arrow-alt-right"></i></font>
      ...
      if ($_POST["brandModelCPU"] != "") {
        ...
        if ($notSearch == 0) {
          ...
          $sql = "SELECT * FROM GPU WHERE Description LIKE '%$search_expression%'";
          $result = $conn->query($sql);
          if ($result->num_rows <=0 ) {
            $sql = "SELECT * FROM GPU WHERE Description LIKE '%$search_post%'";
            $result = $conn->query($sql);
            if ($result->num_rows <=0 ) {
              $sql = "SELECT * FROM GPU WHERE $keywords";
              $result = $conn->query($sql);
              if ($result->num_rows <= 0) {
                $sql = "SELECT * FROM GPU";
                $result = $conn->query($sql);
		...
		<center><div class="no-one-character-message">
          ...
          if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
              if ($row["Category"] == "Heavy Professional Use") {
                ...
                $interX1630 = 0;
                $interX1640 = 0;
                if ($_POST["pciEx1620"] != "-" && $inter == "PCI Express 2.0") {
                  $interX1620 = 1;
                } 
                if ($_POST["pciEx1630"] != "-" && $inter == "PCI Express x16 3.0") {
                  $interX1630 = 1;
                }
                if ($_POST["pciEx1640"] != "-" && $inter == "PCI Express x16 4.0") {
                  $interX1640 = 1;
                }

              //if ($interX1620 == 1 && $inter = "PCI Express x16 2.0" || $interX1630 == 1 && $inter == "PCI Express x16 3.0" || $interX1640 == 1 && $inter == "PCI Express x16 4.0") {
              if ($interX1620 = 1 or $interX1630 = 1 or $interX1640 = 1) {
                $metra++;
                //MAKE CARDS-START
                ...
                //DATA FROM BLUETOOTH ADAPTERS
                echo '<input type="hidden" id="GPUPiece" name="GPUPiece" value="Graphics Card">';
                echo '<input type="hidden" id="psuGPU" name="psuGPU" VALUE="'. $row["psu"].  '">';
                //DATA FROM CPU CHOOSE
                echo '<input type="hidden" id="MicroCPU" name="MicroCPU" value="'. $_POST["MicroCPU"]. '">';
                echo '<input type="hidden" id="SocketCPU" name="SocketCPU" value="'. $_POST["SocketCPU"]. '">';
                ECHO '<input type="hidden" id="gpuCPU" name="gpuCPU" value="'. $_POST["gpuCPU"]. '">';
                ...
                echo '<input type="hidden" id="brandModelGPU" name="brandModelGPU" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                echo '<b><font size="2px">Product Code: '. $row["ProductCode"]. '</font></b>';  
                echo '<input type="hidden" id="ProductCodeGPU" name="ProductCodeGPU" value="'. $row["ProductCode"]. '">';
                echo '<br><br><br><br><br>';
                ...
                echo '<center><font color="black"><table class="tableSpecs">
                        ...
                        <tr class="rowsOnSpecsTR">
                          <td class="rowsOnSpecs">CPU Manufacturer</td>
                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                          <td class="rowsOnSpecs">' .$row["builder"]. '</td>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                          <td class="rowsOnSpecs">Chipset Model</td>
                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                          <td class="rowsOnSpecs">' .$row["chipset"]. '</td>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                          <td class="rowsOnSpecs">Interface</td>
                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                          <td class="rowsOnSpecs">' .$row["Interface"]. '</td>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                          <td class="rowsOnSpecs">Base Clock</td>
                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                          <td class="rowsOnSpecs">' .$row["BaseClock"]. '</td>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                        ...
                        <tr class="rowsOnSpecsTR">
                          ...
                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                          <td class="rowsOnSpecs">' .$row["paral"]. '</td>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                          <td class="rowsOnSpecs">Special Features</td>
                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                          <td class="rowsOnSpecs">' .$row["characterist"]. '</td>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                        ...
                        <tr class="rowsOnSpecsTR">
                          <td class="rowsOnSpecs">Memory Size</td>
                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        ...
                        <tr class="rowsOnSpecsTR">
                          ...
                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                          <td class="rowsOnSpecs">' .$row["typosMnhmhs"]. '</td>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                          <td class="rowsOnSpecs">Memory Speed</td>
                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                          <td class="rowsOnSpecs">' .$row["taxythta"]. '</td>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                          <td class="rowsOnSpecs">Memory bus</td>
                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                          <td class="rowsOnSpecs">' .$row["memory_bus"]. '</td>
                        </tr>
                        <tr class="tableSpecs">
                          <th class="rowsOnSpecs">Connection</th>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                          <td class="rowsOnSpecs">HDMI</td>
                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                          <td class="rowsOnSpecs">' .$row["hdmi"]. '</td>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                          <td class="rowsOnSpecs">Display Port</td>
                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                          <td class="rowsOnSpecs">' .$row["DisplayPort"]. '</td>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                          <td class="rowsOnSpecs">Other ports</td>
                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                          <td class="rowsOnSpecs">' .$row["Ports_alla"]. '</td>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                          <td class="rowsOnSpecs">Dual Link DVI</td>
                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                          <td class="rowsOnSpecs">' .$row["DVI"]. '</td>
                        </tr>
                        <tr class="tableSpecs">
                          <th class="rowsOnSpecs">System requirements</th>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                          <td class="rowsOnSpecs">PSU minimum power</td>
                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                          <td class="rowsOnSpecs">' .$row["psu"]. ' W</td>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                          <td class="rowsOnSpecs">Power Connectors</td>
                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        ...
                        <tr class="rowsOnSpecsTR">
                          ...
                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                          <td class="rowsOnSpecs">' .$row["mhkos"]. '</td>
                        </tr>
                      </table></font></center>';
                echo '</div>';
              echo '</div>';
                echo '<input type="hidden" id="categoryGPU" name="categoryGPU" value="Heavy Professional Use">';
                //INFO OF PRODUCTS-END
                //PRICE OF PRODUCTS
                echo '<div class="productCardpreview">';
                if ($ekptwshPrice == $PriceMod) {
                  echo '<h2 align="right">'. $row["Price"]. '€</h2>';
                  echo '<input type="hidden" id="PriceGPU" name="PriceGPU" value="'. $row["Price"]. '">';
                  echo '<input type="hidden" id="EkptwshGPU" name="EkptwshGPU" value="">';
                  ...
                  echo '<input type="hidden" id="PriceGPU" name="PriceGPU" value="'. $row["PriceEkptwsh"]. '">';
                  echo '<input type="hidden" id="EkptwshGPU" name="EkptwshGPU" value="'. $row["Price"]. '">';
                }
                if ($brINbutton = 0) {
                ...
                //DATA FROM BLUETOOTH ADAPTERS
                  echo '<input type="hidden" id="GPUPiece" name="GPUPiece" value="GPU">';
                  echo '<input type="hidden" id="psuGPU" name="psuGPU" VALUE="'. $row["psu"].  '">';
                  //DATA FROM CPU CHOOSE
                  echo '<input type="hidden" id="MicroCPU" name="MicroCPU" value="'. $_POST["MicroCPU"]. '">';
                  echo '<input type="hidden" id="SocketCPU" name="SocketCPU" value="'. $_POST["SocketCPU"]. '">';
                  ...
                  echo '<input type="hidden" id="pieceGPU" name="GPUPiece" value="Graphics Card">';
                  ...
                  echo '<div class="contentMin">
                          <table class="tableSpecsMin">
                            ...
                            <!--ONE SPEC-->
                            <tr>  
                              <td class="NameOfSpecsMin">CPU manufacturer</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["builder"]. '</td>
                            </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                            <tr>  
                            ...
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["chipset"]. '</td>
                            </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                            <tr>  
                            ...
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["Interface"]. '</td>
                            </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                            <tr>  
                              <td class="NameOfSpecsMin">Base Clock</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["BaseClock"]. '</td>
                            </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                            <tr>  
                            ...
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["paral"]. '</td>
                            </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                            <tr>  
                              <td class="NameOfSpecsMin">Special Characteristics</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["characterist"]. '</td>
                            </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                            <tr>  
                            ...
                            <!--ONE SPEC-->
                            <tr>  
                              <td class="NameOfSpecsMin">Memory Size</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["typosMnhmhs"]. '</td>
                            </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                            <tr>  
                            ...
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["taxythta"]. '</td>
                            </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                            <tr>  
                              <td class="NameOfSpecsMin">Memory bus</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["memory_bus"]. '</td>
                            </tr>
                            <!--ONE SPEC-->
                            <!--ONE CATEGORY OF SPECS-->
                            <!--ONE CATEGORY OF SPECS-->
                            <tr>
                              <th class="KEFALIDAmin">Connection</th>
                            </tr>
                            <!--ONE SPEC-->
                            <tr>  
                              <td class="NameOfSpecsMin">HDMI</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["hdmi"]. '</td>
                            </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                            <tr>  
                              <td class="NameOfSpecsMin">Display Port</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["DisplayPort"]. '</td>
                            </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                            <tr>  
                              <td class="NameOfSpecsMin">Other ports</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["Ports_alla"]. '</td>
                            </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                            <tr>  
                              <td class="NameOfSpecsMin">Dual Link DVI</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["DVI"]. '</td>
                            </tr>
                            <!--ONE SPEC-->
                            <!--ONE CATEGORY OF SPECS-->
                            <!--ONE CATEGORY OF SPECS-->
                            <tr>
                              <th class="KEFALIDAmin">System Requirements</th>
                            </tr>
                            <!--ONE SPEC-->
                            <tr>  
                              <td class="NameOfSpecsMin">PSU minimum power</td>
                            </tr>
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["psu"]. ' W</td>
                            </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                            <tr>  
                              <td class="NameOfSpecsMin">Power Connectors</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td class="FromDatabaseSpecsMin">'. $row["mhkos"]. '</td>
                            </tr>
                            <!--ONE SPEC-->
                            <!--ONE CATEGORY OF SPECS-->
                          </table>
            ...
            if ($metra == "0") {
              echo '<div class="non-gpu">
    	<img src="http://pc-build-webapp.000webhostapp.com/Pictures/pc-builder/non-gpu.png" alt="No results" class="non-gpu-img">
        <form action="../../../../Pages/INTEL/ProfessionalUse/PSU" method="post" name="NothingForm">
          <center><div class="non-gpu-message">
              We do not have any GPU for this PC Category!';
              if ($_POST["gpuCPU"] != "-") {
                echo 'You should go with CPU Graphics Card!
                <br><a onclick="noCPU()" class="noCPU">Go</a>
                <input type="hidden" id="hiddenInput" name="hiddenInput" value="PSU">';
                echo '<input type="hidden" id="psuGPU" name="psuGPU" VALUE="0">';
                echo '<input type="hidden" id="GPUPiece" name="GPUPiece" value="none">
                <input type="hidden" id="brandModelGPU" name="brandModelGPU"  value="'. $_POST["gpuCPU"]. '">
                <input type="hidden" id="ProductCodeGPU" name="ProductCodeGPU" value="---">
                <input type="hidden" id="categoryGPU" name="categoryGPU" value="Built-in processor">
                <input type="hidden" id="PriceGPU" name="PriceGPU" value="---"> 
                <input type="hidden" id="EkptwshGPU" name="EkptwshGPU" value="---">';
  			  }
          echo '</div></center>
        </form>
    </div>';
      ...
      $conn->close();
        if ($_POST["gpuCPU"] != "-") {
          echo '<br><br>';
          if ($_POST["hiddenInput"] == "CPU") {
            echo '<form action="../../../../Pages/INTEL/ProfessionalUse/CPU" method="post" id="formNoGPU" name="formNoGPU">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="CPU">';
          } elseif ($_POST["hiddenInput"] == "MOTHERBOARD") {
            echo '<form action="../../../../Pages/INTEL/ProfessionalUse/Motherboard" method="post" id="formNoGPU" name="formNoGPU">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="MOTHERBOARD">';
          } elseif ($_POST["hiddenInput"] == "RAM") {
            echo '<form action="../../../../Pages/INTEL/ProfessionalUse/GPU" method="post" id="formNoGPU" name="formNoGPU">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="GPU">';
          } elseif ($_POST["hiddenInput"] == "GPU") {
            echo '<form action="../../../../Pages/INTEL/ProfessionalUse/PSU" method="post" id="formNoGPU" name="formNoGPU">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="PSU">';
          } elseif ($_POST["hiddenInput"] == "PSU") {
            echo '<form action="../../../../Pages/INTEL/ProfessionalUse/PSU" method="post" id="formNoGPU" name="formNoGPU">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="PSU">';
          } elseif ($_POST["hiddenInput"] == "HARD") {
            echo '<form action="../../../../Pages/INTEL/ProfessionalUse/HardDrive" method="post" id="formNoGPU" name="formNoGPU">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="HARD">';
                  //DATA FROM PSU CHOOSE
                  echo '<input type="hidden" id="PSUPiece" name="PSUPiece" value="PSU">';
                  echo '<input type="hidden" id="brandModelPSU" name="brandModelPSU" value="'. $_POST["brandModelPSU"]. '">';
            ...
            echo '<form action="../../../../Pages/INTEL/ProfessionalUse/PCCase" method="post" id="formNoGPU" name="formNoGPU">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="CASE">';
                  //DATA FROM PSU CHOOSE
                  echo '<input type="hidden" id="PSUPiece" name="PSUPiece" value="PSU">';
                  echo '<input type="hidden" id="brandModelPSU" name="brandModelPSU" value="'. $_POST["brandModelPSU"]. '">';
            ...
            echo '<form action="../../../../Pages/PCBuilderPCBuild" method="post" id="formNoGPU" name="formNoGPU">';
            echo '<input type="hidden" id="hiddenInput" name="hiddenInput" value="OK">';
            //DATA FROM PSU CHOOSE
            echo '<input type="hidden" id="PSUPiece" name="PSUPiece" value="PSU">';
            echo '<input type="hidden" id="brandModelPSU" name="brandModelPSU" value="'. $_POST["brandModelPSU"]. '">';
          ...
          //DATA FOR GPU------------------------------------------------
          echo '</form>';
          echo '<button class="go-with-cpu-gpu" onclick="noGPU()">Go with Built-in processor GPU <i class="fas fa-arrow-right"></i></button>';
        }
      ?>
      ...
      <script>
        ...
        function noGPU() {
          var submitForm = document.getElementsByName('formNoGPU')
          submitForm[0].submit();
        }
      </script>
