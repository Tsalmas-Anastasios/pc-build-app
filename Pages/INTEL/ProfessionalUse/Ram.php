...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-INTEL/Category: Heavy Professional Use/Ram select</TITLE>
...
<SECTION>
    ...
    <div class="backToCategoriesButton"> 
      ...
      <div class="goToList" id="goToList">
          ...
          ?>
				  ...
				  <b><u>Ram</u></b> <font color="#0071c5"><i class="fas fa-long-arrow-alt-right"></i></font>
    ...
    if ($_POST["brandModelCPU"] != "") {
        ...
        if ($notSearch == 0) {
          ...
          $sql = "SELECT * FROM RAM WHERE Category='Heavy Professional Use' AND Description LIKE '%$search_expression%'";
          $result = $conn->query($sql);
          if ($result->num_rows <=0 ) {
            $sql = "SELECT * FROM RAM WHERE Category='Heavy Professional Use' AND Description LIKE '%$search_post%'";
            $result = $conn->query($sql);
            if ($result->num_rows <=0 ) {
              $sql = "SELECT * FROM RAM WHERE Category='Heavy Professional Use'$keywords";
              $result = $conn->query($sql);
              if ($result->num_rows <= 0) {
                $sql = "SELECT * FROM RAM WHERE Category='Heavy Professional Use'";
                $result = $conn->query($sql);
          ...
          if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                  ...
                  if ($ramSpMod == $row["speed"]) {
                    ...
                    //DATA FROM BLUETOOTH ADAPTERS
                      ...
                      echo '<button type="button" class="productCard-Button"></font></button>
                              ...
                              echo '</div>';
                      echo '</div>';
                      echo '<input type="hidden" id="categoryRAM" name="categoryRAM" value="Heavy Professional Use">';
              ...
              if ($metra == "0") {
                ...
                echo "<br><br><br>";
                echo '<form action="../../../../Pages/INTEL/ProfessionalUse/Motherboard" method="post" name="NothingForm">';
                echo '<b><center><font color="#0071c5"><font size="7">We do not have any Ram Memory which is compatible with your Motherboard!
                      <br>
