...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-INTEL/Category: Heavy Professional Use/Motherboard select</TITLE>
    ...
    <link rel="stylesheet" href="../../../StyleSheets/PC-Builder-General/non-compatible-motherboard.css">
...
<SECTION>
          ...
          <?php
            if (isset($_POST["hiddenButton"])) {
              if ($_POST["hiddenInput"] == "CPU") {
                ...
                echo '<form action="../../../../Pages/INTEL/ProfessionalUse/PCCase" method="post" id="formButtonChange" name="formButtonChange">
    ...
    <div class="goToList" id="goToList">
      <form method="post" id="goToListForm" name="goToListForm">
        <?php
            ...
            //DATA FROM BLUETOOTH ADAPTERS
        ?>
        <CENTER><a onclick="cpuFun()" class="readyPiece"><font color="#42a832"><B><i class="fas fa-check-circle"></i> CPU </font><font color="#0071c5"><i class="fas fa-long-arrow-alt-right"></i></font></B></a>
        <b><u>Motherboard</u></b> <font color="#0071c5"><i class="fas fa-long-arrow-alt-right"></i></font>
    ...
    if ($_POST["brandModelCPU"] != "") {
        ...
        if ($notSearch == 0) {
          ...
          $sql = "SELECT * FROM MOTHERBOARD WHERE Category='Heavy Professional Use' AND Description LIKE '%$search_expression%'";
          $result = $conn->query($sql);
          if ($result->num_rows <=0 ) {
            $sql = "SELECT * FROM MOTHERBOARD WHERE Category='Heavy Professional Use' AND Description LIKE '%$search_post%'";
            $result = $conn->query($sql);
            if ($result->num_rows <=0 ) {
              $sql = "SELECT * FROM MOTHERBOARD WHERE Category='Heavy Professional Use'$keywords";
              $result = $conn->query($sql);
            }
          }
          if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                  ...
                  //id for name in product card
                  $cpuMod = $row["CPUs"];
                  $microMod = explode(',', $row["CPUgenia"]);   //print_r($microMod);---I don't know how much
                
                  if ($cpuMod == "INTEL" && $row["Socket"] == $_POST["SocketCPU"]) {
                    foreach($microMod as $microMod) {     //echo $microMod. '<br>'; 
                      if ($micro == $microMod && $_POST["SocketCPU"] == $row["Socket"]) {
                      ...
                      if ($_POST["hiddenInput"] == "CPU") {
                        ...
                        echo '<form action="../../../../Pages/INTEL/ProfessionalUse/PCCase" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                              <input type="hidden" id="hiddenInput" name="hiddenInput" value="CASE">';
                              //DATA FROM RAM CHOOSE
                              echo '<input type="hidden" id="RamPiece" name="RamPiece" value="Ram">';
                              echo '<input type="hidden" id="brandModelRAM" name="brandModelRAM" value="'. $_POST["brandModelRAM"]. '">';
                    ...
                    //DATA FROM BLUETOOTH ADAPTERS
                          ...
                          echo '<input type="hidden" id="pciEx1620" name="pciEx1620" value="'. $row["PCIExpressX1620"]. '">';
                          echo '<input type="hidden" id="pciEx1630" name="pciEx1630" value="'. $row["PCIExpressX1630"]. '">';
                          echo '<input type="hidden" id="pciEx1640" name="pciEx1640" value="'. $row["PCIExpressX1640"]. '">';
                          echo '<input type="hidden" id="MOTHERsize" name="MOTHERsize" value="'. $row["Size"]. '">';
                          //DATA FROM CPU CHOOSE
                          echo '<input type="hidden" id="pieceCPU" name="CPUpiece" value="CPU">';
                          echo '<input type="hidden" id="brandModelCPU" name="brandModelCPU" value="'. $_POST["brandModelCPU"]. '">';
                          echo '<input type="hidden" id="ProductCodeCPU" name="ProductCodeCPU" value="'. $_POST["ProductCodeCPU"]. '">';
                        ...
                        echo '<input type="hidden" id="brandModelMOTHER" name="brandModelMOTHER" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                        echo '<b><font size="2px">Product Code: '. $row["ProductCode"]. '</font></b>';  
                        echo '<input type="hidden" id="ProductCodeMOTHER" name="ProductCodeMOTHER" value="'. $row["ProductCode"]. '">';
                        echo '<br><br><br><br><br>';
                        echo '<button type="button" class="productCard-Button"></font></button>
                                ...
                                echo '<center><font color="black"><table class="tableSpecs">
                                        <tr class="tableSpecs">
                                          <th class="rowsOnSpecs">General Chracteristics</th>
                                        </tr>
                                        ...
                                        <tr class="tableSpecs">
                                          <th class="rowsOnSpecs">CPU</th>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">Supported CPUs</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["CPUs"]. '</td>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">CPU Models</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["CPUmodel"]. '</td>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">Supported Generation</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["CPUgenia"]. '</td>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                        ...
                                        <tr class="tableSpecs">
                                          <th class="rowsOnSpecs">Chipset</th>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">Chipset Model</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["ChipsetModel"]. '</td>
                                        </tr>
                                        <tr class="tableSpecs">
                                          <th class="rowsOnSpecs">Memory</th>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">Memory Type</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["RamType"]. '</td>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">Memory modules</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["RamMuch"]. '</td>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">Memory Speed</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["RamSpeed"]. '</td>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">Memory mode</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["LeitourgiaRam"]. '</td>
                                        </tr>
                                        <tr class="tableSpecs">
                                          <th class="rowsOnSpecs">Connections In</th>
                                        </tr>';
                                          echo '<tr class="rowsOnSpecsTR">
                                            <td class="rowsOnSpecs">PCI Express x16 2.0</td>
                                            <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                            <td class="rowsOnSpecs">'. $row["PCIExpressX1620"]. '</td>
                                          </tr>';
                                          echo '<tr class="rowsOnSpecsTR">
                                            <td class="rowsOnSpecs">PCI Express x16 3.0</td>
                                            <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                            <td class="rowsOnSpecs">'. $row["PCIExpressX1630"]. '</td>
                                          </tr>';
                                          echo '<tr class="rowsOnSpecsTR">
                                            <td class="rowsOnSpecs">PCI Express x16 4.0</td>
                                            <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                            <td class="rowsOnSpecs">'. $row["PCIExpressX1640"]. '</td>
                                          </tr>';
                                          echo '<tr class="rowsOnSpecsTR">
                                            <td class="rowsOnSpecs">SATA II 3GB/s</td>
                                            <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                            <td class="rowsOnSpecs">'. $row["SATAII3GB"]. '</td>
                                          </tr>';
                                          echo '<tr class="rowsOnSpecsTR">
                                            <td class="rowsOnSpecs">SATA III 6GB/s</td>
                                            <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                            <td class="rowsOnSpecs">'. $row["SATAIII6GB"]. '</td>
                                          </tr>';
                                        echo '<tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">Other</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["alloIn"]. '</td>
                                        </tr>
                                        <tr class="tableSpecs">
                                          <th class="rowsOnSpecs">Connections Out</th>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">Back exits USB 2.0</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["BackUSB20"]. '</td>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">Back exits USB 3.0</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["BackUSB30"]. '</td>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">Back exits USB 3.1</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["BackUSB31"]. '</td>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">Back exits USB 3.2</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["BackUSB32"]. '</td>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">USB Type</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["USBtype"]. '</td>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">Ethernet (LAN)</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["ethernet"]. '</td>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">Other</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["alloOut"]. '</td>
                                        </tr>
                                        <tr class="tableSpecs">
                                          <th class="rowsOnSpecs">Features</th>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">Parallel Processing Technology</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["ParallelProcessingTechnology"]. '</td>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">Sound Card channels</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["SoundCards"]. '</td>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">Onboard Graphics Card</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["OnboardGPU"]. '</td>
                                        </tr>
                                        <tr class="rowsOnSpecsTR">
                                          <td class="rowsOnSpecs">Extra</td>
                                          <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                          <td class="rowsOnSpecs">'. $row["Extra"]. '</td>
                                        </tr>
                                      </table></font></center>
                                    </div>';
                        echo '</div>';
                        echo '<input type="hidden" id="categoryMOTHER" name="categoryMOTHER" value="Heavy Professional Use">';
                        //INFO OF PRODUCTS-END
                        //PRICE OF PRODUCTS
                        echo '<div class="productCardpreview">';
                        if ($ektpwshPrice == $PriceMod) {
                          echo '<h2 align="right">'. $row["Price"]. '€</h2>';
                          echo '<input type="hidden" id="PriceMOTHER" name="PriceMOTHER" value="'. $row["Price"]. '">';
                          echo '<input type="hidden" id="EkptwshMOTHER" name="EkptwshMOTHER" value="">';
                          ...
                          echo '<input type="hidden" id="PriceMOTHER" name="PriceMOTHER" value="'. $row["PriceEkptwsh"]. '">';
                          echo '<input type="hidden" id="EkptwshMOTHER" name="EkptwshMOTHER" value="'. $row["Price"]. '">';
                        }
                        if ($brINbutton = 0) {
                        ...
                        echo '</div>';
                        //PRICE OF PRODUCTS
                        //INPUTS FOR RAM CHOOSE
                        echo '<input type="hidden" id="RamType" name="RamType" value="'. $row["RamType"]. '">';
                        echo '<input type="hidden" id="RamPL" name="RamPL" value="'. $row["RamMuch"]. '">';
                        echo '<input type="hidden" id="RamSP" name="RamSP" value="'. $row["RamSpeed"]. '">';
                        //INPUTS FOR RAM CHOOSE
                        echo '</div>';
                        echo '</form>';
                        echo '</div>';
                        ...
                        if ($_POST["hiddenInput"] == "CPU") {
                          ...
                          echo '<form action="../../../../Pages/INTEL/ProfessionalUse/GPU" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                                ...
                                echo '<input type="hidden" id="categoryRAM" name="categoryRAM" value="'. $_POST["categoryRAM"]. '">';
                                echo '<input type="hidden" id="PriceRAM" name="PriceRAM" value="'. $_POST["PriceRAM"]. '">';
                                echo '<input type="hidden" id="EkptwshCPU" name="EkptwshCPU" value="'. $_POST["EkptwshRAM"]. '">';
                                //DATA FROM RAM CHOOSE
                        } elseif ($_POST["hiddenInput"] == "PSU") {
                          echo '<form action="../../../../Pages/INTEL/ProfessionalUse/PSU" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                                <input type="hidden" id="hiddenInput" name="hiddenInput" value="PSU">';
                    ...
                    //DATA FROM BLUETOOTH ADAPTERS
                          ...
                          echo '<div class="contentMin">
                                <table class="tableSpecsMin">
                                  ...
                                  <!--ONE CATEGORY OF SPECS-->
                                  <tr>
                                    <th class="KEFALIDAmin">CPU</th>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">Supported CPUs</td>
                                  </tr>
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["CPUs"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">CPU Models</td>
                                  </tr>
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["CPUmodel"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">Supported Generation</td>
                                  </tr>
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["CPUgenia"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>  
                                  ...
                                  <!--ONE CATEGORY OF SPECS-->
                                  <tr>
                                    <th class="KEFALIDAmin">Chipset</th>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">Chipset Model</td>
                                  </tr>
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["ChipsetModel"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE CATEGORY OF SPECS-->
                                  <!--ONE CATEGORY OF SPECS-->
                                  <tr>
                                    <th class="KEFALIDAmin">Memory</th>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">Memory Type</td>
                                  </tr>
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["RamType"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">Memory Modules</td>
                                  </tr>
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["RamMuch"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">Memory Speed</td>
                                  </tr>
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["RamSpeed"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">Memory Mode</td>
                                  </tr>
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["LeitourgiaRam"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE CATEGORY OF SPECS-->
                                  <!--ONE CATEGORY OF SPECS-->
                                  <tr>
                                    <th class="KEFALIDAmin">Connections In</th>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">PCI Express x16 2.0</td>
                                  </tr>
                                  <tr>';
                                    echo '<td class="FromDatabaseSpecsMin">'. $row["PCIExpressX1620"]. '</td>';
                                  echo '</tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">PCI Express x16 3.0</td>
                                  </tr>
                                  <tr>';
                                    echo '<td class="FromDatabaseSpecsMin">'. $row["PCIExpressX1630"]. '</td>';
                                  echo '</tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>
                                  <td class="NameOfSpecsMin">PCI Express x16 4.0</td>
                                  </tr>
                                  <tr>';
                                    echo '<td class="FromDatabaseSpecsMin">'. $row["PCIExpressX1640"]. '</td>';
                                  echo '</tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">SATA II 3GB/s</td>
                                  </tr>
                                  <tr>';
                                    echo '<td class="FromDatabaseSpecsMin">'. $row["SATAII3GB"]. '</td>';
                                  echo '</tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">SATA III 6GB/s</td>
                                  </tr>
                                  <tr>';
                                    echo '<td class="FromDatabaseSpecsMin">'. $row["SATAIII6GB"]. '</td>';
                                  echo '</tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">Other</td>
                                  </tr>
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["alloIn"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE CATEGORY OF SPECS-->
                                  <!--ONE CATEGORY OF SPECS-->
                                  <tr>
                                    <th class="KEFALIDAmin">Connection Out</th>
                                  </tr> 
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">Back exits USB 2.0</td>
                                  </tr>
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["BackUSB20"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">Back exits USB 3.0</td>
                                  </tr>
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["BackUSB30"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">Back exits USB 3.1</td>
                                  </tr>
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["BackUSB31"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">Back exits USB 3.2</td>
                                  </tr>
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["BackUSB32"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">USB Type</td>
                                  </tr>
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["USBtype"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">Ethernet (LAN)</td>
                                  </tr>
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["ethernet"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>  
                                  ...
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["alloOut"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE CATEGORY OF SPECS-->
                                  <!--ONE CATEGORY OF SPECS-->
                                  ...
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">Parallel Processing Technology</td>
                                  </tr>
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["ParallelProcessingTechnology"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">Sound card channels</td>
                                  </tr>
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["SoundCards"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>  
                                    <td class="NameOfSpecsMin">Onboard Graphics Card</td>
                                  </tr>
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["OnboardGPU"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE SPEC-->
                                  <tr>  
                                  ...
                                  <tr>
                                  <td class="FromDatabaseSpecsMin">'. $row["Extra"]. '</td>
                                  </tr>
                                  <!--ONE SPEC-->
                                  <!--ONE CATEGORY OF SPECS-->
                                </table>
                ...
                if ($metra == "0") {
                  echo '<div class="non-compatible-motherboard">
    	<img src="http://pc-build-webapp.000webhostapp.com/Pictures/pc-builder/non-compatible-motherboard.png" alt="No results" class="non-compatible-motherboard-img">
		<center><div class="non-compatible-motherboard-message">
        	<form action="CPU.php" method="post" name="NothingForm">
        		We do not have any Motherboard which is compatible with your CPU!<br>
                Please choose an other CPU from <a onclick="noCPU()" class="noCPU">here</a>
		...
		<center><div class="no-results-search-message">
            ...
            $sql = "SELECT * FROM MOTHERBOARD WHERE Category='Heavy Professional Use'";
            $result = $conn->query($sql);
            ...
            if ($result->num_rows > 0) {
              ...
              if ($metra == "0" and $non_compatible == 0) {
                echo '<div class="non-compatible-motherboard">
    	<img src="http://pc-build-webapp.000webhostapp.com/Pictures/pc-builder/non-compatible-motherboard.png" alt="No results" class="non-compatible-motherboard-img">
		<center><div class="non-compatible-motherboard-message">
        	<form action="CPU.php" method="post" name="NothingForm">
