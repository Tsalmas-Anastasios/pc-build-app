...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-INTEL/Category: Heavy Professional Use/PSU select</TITLE>
...
<SECTION>
	...
	<div class="backToCategoriesButton"> 
      ...
      <div class="goToList" id="goToList">
          ...
          ?>
				  ...
				  <b><u>PSU</u></b> <font color="#0071c5"><i class="fas fa-long-arrow-alt-right"></i></font>
	...
	if ($_POST["brandModelCPU"] != "") {
		...
		if ($notSearch == 0) {
			...
			$sql = "SELECT * FROM PSU WHERE Category='Heavy Professional Use' AND Description LIKE '%$search_expression%'";
			$result = $conn->query($sql);
			if ($result->num_rows <=0 ) {
				$sql = "SELECT * FROM PSU WHERE Category='Heavy Professional Use' AND Description LIKE '%$search_post%'";
				$result = $conn->query($sql);
				if ($result->num_rows <=0 ) {
					$sql = "SELECT * FROM PSU WHERE Category='Heavy Professional Use'$keywords";
					$result = $conn->query($sql);
					if ($result->num_rows <= 0) {
						$sql = "SELECT * FROM PSU WHERE Category='Heavy Professional Use'";
						$result = $conn->query($sql);
		...
		if ($result->num_rows > 0) {
			...
			$intvalPsuGpu = intval($_POST["psuGPU"]);
			$metra = 0;
			
			while($row = $result->fetch_assoc()) {
				$onoma_for_title++;

				if ($row["watt"] >= $intvalPsuGpu) {
					...
					echo '<input type="hidden" id="brandModelPSU" name="brandModelPSU" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
					echo '<b><font size="2px">Product Code: '. $row["ProductCode"]. '</font></b>';  
					echo '<input type="hidden" id="ProductCodePSU" name="ProductCodePSU" value="'. $row["ProductCode"]. '">';
					echo '<br><br><br><br><br>';
					...
					<div class="specs">';
						...
						echo '<center><font color="black"><table class="tableSpecs">
								...
								<tr class="rowsOnSpecsTR">
									<td class="rowsOnSpecs">Power (Watt)</td>
									<td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td class="rowsOnSpecs">' .$row["watt"]. ' W</td>
								</tr>
								<tr class="rowsOnSpecsTR">
									<td class="rowsOnSpecs">PFC type</td>
									<td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td class="rowsOnSpecs">' .$row["PFC"]. '</td>
								</tr>
								<tr class="rowsOnSpecsTR">
								...
								<tr class="rowsOnSpecsTR">
									<td class="rowsOnSpecs">Modular</td>
									<td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td class="rowsOnSpecs">' .$row["modular"]. '</td>
								</tr>
								<tr class="rowsOnSpecsTR">
									<td class="rowsOnSpecs">Certification</td>
									<td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td class="rowsOnSpecs">' .$row["certification"]. '</td>
								</tr>
								<tr class="rowsOnSpecsTR">
									<td class="rowsOnSpecs">Fan dimension</td>
									<td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td class="rowsOnSpecs">' .$row["cooler"]. '</td>
								</tr>
								<tr class="rowsOnSpecsTR">
									<td class="rowsOnSpecs">Power protect</td>
									<td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td class="rowsOnSpecs">' .$row["watt_protect"]. '</td>
								</tr>
								<tr class="rowsOnSpecsTR">
					...
					echo '</div>';
				  echo '</div>';
					echo '<input type="hidden" id="categoryPSU" name="categoryPSU" value="Heavy Professional Use">';
					//INFO OF PRODUCTS-END
					//PRICE OF PRODUCTS
					echo '<div class="productCardpreview">';
					if ($ekptwshPrice == $PriceMod) {
					  echo '<h2 align="right">'. $row["Price"]. '€</h2>';
					  echo '<input type="hidden" id="PricePSU" name="PricePSU" value="'. $row["Price"]. '">';
					  echo '<input type="hidden" id="EkptwshPSU" name="EkptwshPSU" value="">';
					  ...
					  echo '<input type="hidden" id="PricePSU" name="PricePSU" value="'. $row["PriceEkptwsh"]. '">';
					  echo '<input type="hidden" id="EkptwshPSU" name="EkptwshPSU" value="'. $row["Price"]. '">';
					}
					if ($brINbutton = 0) {
					...
					if ($_POST["hiddenInput"] == "CPU") {
					  ...
					  echo '<input type="hidden" id="piecePSU" name="PSUPiece" value="PSU">';
					  ...
					  echo '<div class="contentMin">
								<table class="tableSpecsMin">
									...
									<!--ONE SPEC-->
									<tr>  
										<td class="NameOfSpecsMin">Power (Watt)</td>
									</tr>
									<tr>
										<td class="FromDatabaseSpecsMin">'. $row["watt"]. ' W</td>
									</tr>
									<!--ONE SPEC-->
									<!--ONE SPEC-->
									<tr>  
										<td class="NameOfSpecsMin">PFC type</td>
									</tr>
									<tr>
										<td class="FromDatabaseSpecsMin">'. $row["PFC"]. '</td>
									</tr>
									<!--ONE SPEC-->
									<!--ONE SPEC-->
									<tr>  
									...
									<!--ONE SPEC-->
									<tr>  
										<td class="NameOfSpecsMin">Modular</td>
									</tr>
									<tr>
										<td class="FromDatabaseSpecsMin">'. $row["modular"]. '</td>
									</tr>
									<!--ONE SPEC-->
									<!--ONE SPEC-->
									<tr>  
										<td class="NameOfSpecsMin">Certification</td>
									</tr>
									<tr>
										<td class="FromDatabaseSpecsMin">'. $row["certification"]. '</td>
									</tr>
									<!--ONE SPEC-->
									<!--ONE SPEC-->
									<tr>  
										<td class="NameOfSpecsMin">Fan dimension</td>
									</tr>
									<tr>
									...
									<!--ONE SPEC-->
									<tr>  
										<td class="NameOfSpecsMin">Power protect</td>
									</tr>
									<tr>
										<td class="FromDatabaseSpecsMin">'. $row["watt_protect"]. '</td>
									</tr>
									<!--ONE SPEC-->
									<!--ONE SPEC-->
									<tr>  
				...
				if ($metra == "0") {
					echo '<div class="no-results-search">
    	<img src="http://pc-build-webapp.000webhostapp.com/Pictures/pc-builder/no-results-search.png" alt="No results" class="no-results-search-img">
        <form action="../../../../Pages/INTEL/ProfessionalUse/GPU" method="post" name="NothingForm">
          <center><div class="no-results-search-message">
              We do not have any PSU for this PC Category!<br>
              Select an other <a onclick="noCPU()" class="noCPU">GPU</a>
              <input type="hidden" id="hiddenInput" name="hiddenInput" value="GPU">';
							//DATA FROM CPU CHOOSE
							echo '<input type="hidden" id="MicroCPU" name="MicroCPU" value="'. $_POST["MicroCPU"]. '">';
							echo '<input type="hidden" id="SocketCPU" name="SocketCPU" value="'. $_POST["SocketCPU"]. '">';
