...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-Ready PC Build-Category:<?php echo $_POST["categoryCPU"]; ?>/Keyboard select</TITLE>
...
if ($_POST["brandModelCPU"] != "") {
    ...
    if ($conn->connect_error) {
        ...
        echo '<form method="post" name="formFiltersModal"><div class="modal" id="modal1">
          <div class="modal-dialog" style="width: 700px;">
            ...
            <section class="modal-content">';
                ...
                $keywords = "";
                if (isset($_POST["connSubmit"]) or isset($_POST["kindSubmit"]) or isset($_POST["connectionTypeSubmit"]) or isset($_POST["useSubmit"])) {
                  //connSubmit ---> For connection, field name: wireless_keyboard
                  //kindSubmit ---> For kind, field name: Category only where explode(' ', $row["Category"])      foreach................
                  //connTypeSubmit ---> For connection type, field name: connection_keyboard
                  //useSubmit ---> For use, field name: kind_keyboard
                  $keywords = "";
                  $key = "";
                  $issetStep = 0;
                  ...
                  if (isset($_POST["connectionTypeSubmit"])) {
                    $issetStep++;
                  }
                  if (isset($_POST["useSubmit"])) {
                    $issetStep++;
                  }
                  ...
                  if ($issetStep == 1) {
                    if (isset($_POST["connSubmit"])) {
                      ...
                      $keywords = " wireless_keyboard='$key'";
                    }
                    if (isset($_POST["kindSubmit"])) {
                    ...
                    if (isset($_POST["connectionTypeSubmit"])) {
                      $key = $_POST["connectionTypeSubmit"];
                      $keywords = " connection_keyboard='$key'";
                    }
                    if (isset($_POST["useSubmit"])) {
                      $key = $_POST["useSubmit"];
                      $keywords = " kind_keyboard LIKE '%$key%'";
                    }
                  } else {
                    if (isset($_POST["connSubmit"])) {
                      $key = $_POST["connSubmit"];
                    ...
                    if (isset($_POST["connectionTypeSubmit"])) {
                      ...
                      if ($keywords == "") {
                        ...
                        $keywords .= " AND connection_keyboard='$key'";
                      }
                    }
                    if (isset($_POST["useSubmit"])) {
                      $key = $_POST["useSubmit"];
                      if ($keywords == "") {
                        ...
                        $keywords .= " AND kind_keyboard LIKE '%$key%'";
                      }
                    }
                  }
                  $sql = "SELECT * FROM Keyboard_Mouse WHERE$keywords AND Category LIKE '%Keyboard%'";
                } else {
                ...
                if ($result->num_rows > 0) {
                  ...
                  while($row = $result->fetch_assoc()) {
                    //KIND---------------------START
                    if ($row["Category"] == "Keyboard & Mouse Set") {
                      $set++;
                    } elseif ($row["Category"] == "Keyboard") {
                      $keyboard_only++;
                    } elseif ($row["Category"] == "Keyboard with touchpad") {
                      $keyboard_touchpad++;
                    }
                    //KIND---------------------END
                    //CONNECTION TYPE---------------------START
                    if ($row["connection_keyboard"] == "USB") {
                      $usb++;
                    } elseif ($row["connection_keyboard"] == "Bluetooth") {
                      $bluetooth++;
                    }
                    //CONNECTION TYPE---------------------END
                    //USE---------------------START
                    if ($row["kind_keyboard"] == "Office") {
                      $for_desk++;
                    } elseif ($row["kind_keyboard"] == "Tablet") {
                      $for_tablet++;
                    } elseif ($row["kind_keyboard"] == "Universal Devices") {
                      $universal++;
                    } elseif ($row["kind_keyboard"] == "Arithmetic Keyboard") {
                      $numbers_keyboard++;
                    }
                    //USE---------------------START
                    //CONNECTIVITY---------------------START
                    if ($row["wireless_keyboard"] == "Yes") { //IF KEYBOARD IS WIRELESS
                      $cable_without++;
                    } elseif ($row["wireless_keyboard"] == "No") {  //IF KEYBOARD IS WIRED
                      $cable_with++;
                    }
                    //CONNECTIVITY---------------------END
                  }
                }
                //IF ONLY ONE CATEGORY IS CHECK
                //connSubmit
                  if (isset($_POST["connSubmit"]) and !isset($_POST["kindSubmit"]) and !isset($_POST["connectionTypeSubmit"]) and !isset($_POST["useSubmit"])) {
                    //CONNECTION---START
                    $cable_with = 0;
                    $cable_without = 0;
                    //CONNECTION--START
                ...
                if (isset($_POST["connSubmit"]) and (isset($_POST["kindSubmit"]) or isset($_POST["connectionTypeSubmit"]) or isset($_POST["useSubmit"])) and $issetCategory == 2) {
                  $issetCategory++;
                  $key = $_POST["connSubmit"];
                  $sql = "SELECT * FROM Keyboard_Mouse WHERE wireless_keyboard='$key' AND Category LIKE '%Keyboard%'";
                  $result = $conn->query($sql);
                  if ($result->num_rows > 0) {
                    $issetStep = 0;
                    ...
                    if (isset($_POST["connectionTypeSubmit"]) and $issetStep == 0) {
                      $isset = 2;
                      $issetStep++;
                      //CONNECTION TYPE---START
                      $usb = 0;
                    ...
                    if (isset($_POST["useSubmit"]) and $issetStep == 0) {
                      $isset = 3;
                      $issetStep++;
                      //USE---START
                      $for_desk = 0;
                ...
                if (isset($_POST["kindSubmit"]) and (isset($_POST["connSubmit"]) or isset($_POST["connectionTypeSubmit"]) or isset($_POST["useSubmit"])) and $issetStep == 2) {
                  $issetCategory++;
                  $key = $_POST["kindSubmit"];
                  $sql = "SELECT * FROM Keyboard_Mouse WHERE Category='$key'";
                  $result = $conn->query($sql);
                  if ($result->num_rows > 0) {
                    $issetStep = 0;
                ...
                //FOR $_POST["connectionTypeSubmit"]
                if (isset($_POST["connectionTypeSubmit"]) and (isset($_POST["connSubmit"]) or isset($_POST["kindSubmit"]) or isset($_POST["useSubmit"]))and $issetCategory == 2) {
                  $issetCategory++;
                  $key = $_POST["connectionTypeSubmit"];
                  $sql = "SELECT * FROM Keyboard_Mouse WHERE connection_keyboard='$key' AND Category LIKE '%Keyboard%'";
                  $result = $conn->query($sql);
                  if ($result->num_rows > 0) {
                    $issetStep = 0;
                    if (isset($_POST["connSubmit"]) and $issetStep == 0) {
                ...
                //FOR $_POST["useSubmit"]
                if (isset($_POST["useSubmit"]) and (isset($_POST["connSubmit"]) or isset($_POST["connectionTypeSubmit"]) or isset($_POST["kindSubmit"])) and $issetCategory == 2) {
                  $issetCategory++;
                  $key = $_POST["useSubmit"];
                  $sql = "SELECT * FROM Keyboard_Mouse WHERE kind_keyboard='$key' AND Category LIKE '%Keyboard%'";
                  $result = $conn->query($sql);
                  if ($result->num_rows > 0) {
                    $issetStep = 0;
                    if (isset($_POST["connSubmit"]) and $issetStep == 0) {
                ...
                if (isset($_POST["connectionTypeSubit"])) {
                  $issetCategory++;
                }
                if (isset($_POST["useSubmit"])) {
                  $issetCategory++;
                ...
                //FOR $_POST["connSubmit"]
                if (isset($_POST["connSubmit"]) and (isset($_POST["kindSubmit"]) or isset($_POST["connectionTypeSubmit"]) or isset($_POST["useSubmit"])) and $issetCategory == 3) {
                  $issetCategory++;
                  $issetKey = 0;
                  ...
                  if (isset($_POST["connectionTypeSubmit"]) and $issetKey == 0) {
                    $issetKey++;
                    $key = $_POST["connectionTypeSubmit"];
                    $keywords = " connection_keyboard='$key'";
                  }
                  if (isset($_POST["useSubmit"])) {
                    $issetKey++;
                    $key = $_POST["useSubmit"];
                    $keywords = " kind_keyboard='$key'";
                  }
                  $key = $_POST["connSubmit"];
                  $sql = "SELECT * FROM Keyboard_Mouse WHERE wireless_keyboard='$key' AND$keywords AND Category LIKE '%Keyboard%'";
                  $result = $conn->query($sql);
                  if ($result->num_rows > 0) {
                    $issetStep = 0;
                    $issetSec = 0;
                    ...
                    if (isset($_POST["connectionTypeSubmit"]) and $issetStep <= 1) {
                      $isset = 2;
                      $issetSec++;
                      $issetStep++;
                      //CONNECTION TYPE---START
                    ...
                    if (isset($_POST["useSubmit"]) and $issetStep <= 1) {
                      $isset = 3;
                      $issetSec++;
                      $issetStep++;
                      //USE---START
                    ...
                    while($row = $result->fetch_assoc()) {
                      ...
                      if (isset($_POST["connectionTypeSubmit"]) and $issetSec == 2) {
                        if ($row["connection_keyboard"] == "USB") {
                          $usb++;
                        } elseif ($row["connection_keyboard"] == "Bluetooth") {
                          $bluetooth++;
                      ...
                      if (isset($_POST["useSubmit"]) and $issetSec == 2) {
                        if ($row["kind_keyboard"] == "Office") {
                          $for_desk++;
                        } elseif ($row["kind_keyboard"] == "Tablet") {
                          $for_tablet++;
                ...
                //FOR $_POST["kindSubmit"]
                if (isset($_POST["kindSubmit"]) and (isset($_POST["connSubmit"]) or isset($_POST["connectionTypeSubmit"]) or isset($_POST["useSubmit"])) and $issetCategory == 3) {
                  $issetCategory++;
                  $issetKey = 0;
                  ...
                  if (isset($_POST["useSubmit"]) and $issetKey == 0) {
                    $issetKey++;
                    $key = $_POST["useSubmit"];
                    $keywords = " kind_keyboard='$key'";
                  }
                  $key = $_POST["kindSubmit"];
                  $sql = "SELECT * FROM Monitor WHERE Category='$key' AND$keywords";
                  $result = $conn->query($sql);
                  if ($result->num_rows > 0) {
                    $issetStep = 0;
                    $issetSec = 0;
                ...
                //FOR $_POST["connectionTypeSubmit"]
                if (isset($_POST["connectionTypeSubmit"]) and (isset($_POST["connSubmit"]) or isset($_POST["kindSubmit"]) or isset($_POST["useSubmit"])) and $issetCategory == 3) {
                  $issetCategory++;
                  $issetKey = 0;
                  if (isset($_POST["connSubmit"]) and $issetKey == 0) {
                    $issetKey++;
                  ...
                  if (isset($_POST["usseSubmit"]) and $issetKey == 0) {
                    $issetKey++;
                    $key = $_POST["useSubmit"];
                    $keywords = " kind_keyboard='$key'";
                  }
                  $key = $_POST["connectionTypeSubmit"];
                  $sql = "SELECT * FROM Keyboard_Mouse WHERE connection_keyboard='$key' AND$keywords AND Category LIKE '%Keyboard%'";
                  $result = $conn->query($sql);
                  if ($result->num_rows > 0) {
                    $issetStep = 0;
                    $issetSec = 0;
                ...
                //FOR $_POST["useSubmit"]
                if (isset($_POST["useSubmit"]) and (isset($_POST["connSubmit"]) or isset($_POST["kindSubmit"]) or isset($_POST["connectionTypeSubmit"])) and $issetCategory == 3) {
                  $issetCategory++;
                  $issetKey = 0;
                  if (isset($_POST["connSubmit"]) and $issetKey == 0) {
                    $issetKey++;
                  ...
                  $key = $_POST["useSubmit"];
                  $sql = "SELECT * FROM Keyboard_Mouse WHERE kind_keyboard='$key' AND$keywords AND Category LIKE '%Keyboard%'";
                  $result = $conn->query($sql);
                  if ($result->num_rows > 0) {
                    $issetStep = 0;
                    $issetSec = 0;
                ...
                /////////////////////////////FOR ONLY 3 ISSET($_POST["somethingIsset"])//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                //CONNECTIVITY-------------OPTION BOXES------------START
                if ($cable_without > 0 or $cable_with > 0) {
                  ...
                  echo '</center>';
                  if ($set > 0 or $keyboard_only > 0 or $keyboard_touchpad > 0 or $usb > 0 or $bluetooth > 0 or $for_desk > 0 or $for_tablet > 0 or $universal > 0 or $numbers_keyboard > 0) {
                    echo '<br><hr class="hrModalBox"><br>';
                  }
                }
                //CONNECTIVITY-------------OPTION BOXES------------END
                //KIND-------------OPTION BOXES------------START
                if ($set > 0 or $keyboard_only > 0 or $keyboard_touchpad > 0) {
                  echo '<p class="typesOfDisksInCategorySSD">
                    <b>Connectivity</b>
                  </p><br>';
                    if ($set > 0) {
                      echo '<label class="containerRadioButton">Keyboard & Mouse Set ('. $set. ')
                        <input type="radio" name="kindSubmit" id="KeyboardSet" value="Keyboard & Mouse Set" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>&nbsp;&nbsp;&nbsp;';
                    } else {
                      echo '<label class="containerRadioButton"><font color="#b3b3b3">Keyboard & Mouse Set (0)</font>
                        <input type="radio" name="kindSubmit" id="KeyboardSet" value="Keyboard & Mouse Set" disabled> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>&nbsp;&nbsp;&nbsp;';
                    }

                    if ($keyboard_only > 0) {
                      echo '<label class="containerRadioButton">Keyboard ('. $keyboard_only. ')
                        <input type="radio" name="kindSubmit" id="Keyboard" value="Keyboard" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>&nbsp;&nbsp;&nbsp;';
                    } else {
                      echo '<label class="containerRadioButton"><font color="#b3b3b3">Keyboard (0)</font>
                        <input type="radio" name="kindSubmit" id="Keyboard" value="Keyboard" disabled> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>&nbsp;&nbsp;&nbsp;';
                    }

                    if ($keyboard_touchpad > 0) {
                      echo '<label class="containerRadioButton">Keyboard with touchpad ('. $keyboard_touchpad. ')
                        <input type="radio" name="kindSubmit" id="KeyboardWithTouchpad" value="Keyboard with touchpad" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>&nbsp;&nbsp;&nbsp;';
                    } else {
                      echo '<label class="containerRadioButton"><font color="#b3b3b3">Keyboard with touchpad (0)</font>
                        <input type="radio" name="kindSubmit" id="KeyboardWithTouchpad" value="Keyboard with touchpad" disabled> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>&nbsp;&nbsp;&nbsp;';
                    }
                  if ($usb > 0 or $bluetooth > 0 or $for_desk > 0 or $for_tablet > 0 or $universal > 0 or $numbers_keyboard > 0) {
                    echo '<br><hr class="hrModalBox"><br>';
                  }
                }
                //KIND-------------OPTION BOXES------------END

                //CONNECTION TYPE-------------OPTION BOXES------------START
                if ($usb > 0 or $bluetooth > 0) {
                  echo '<p class="typesOfDisksInCategorySSD">
                    <b>Connection type</b>
                  </p><br>
                  <center>';
                    if ($usb > 0) {
                      echo '<label class="containerRadioButtonOnRow">USB ('. $usb. ')
                        <input type="radio" name="connectionTypeSubmit" id="USB" value="USB" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>&nbsp;&nbsp;&nbsp;';
                    } else {
                      echo '<label class="containerRadioButtonOnRow"><font color="#b3b3b3">USB (0)</font>
                        <input type="radio" name="connectionTypeSubmit" id="USB" value="USB" disabled> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>&nbsp;&nbsp;&nbsp;';
                    }

                    if ($bluetooth > 0) {
                      echo '<label class="containerRadioButtonOnRow">Bluetooth ('. $bluetooth. ')
                        <input type="radio" name="connectionTypeSubmit" id="Bluetooth" value="Bluetooth" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>&nbsp;&nbsp;&nbsp;';
                    } else {
                      echo '<label class="containerRadioButtonOnRow"><font color="#b3b3b3">Bluetooth (0)</font>
                        <input type="radio" name="connectionTypeSubmit" id="Bluetooth" value="Bluetooth" disabled> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>&nbsp;&nbsp;&nbsp;';
                    }
                  echo '</center>';
                  if ($for_desk > 0 or $for_tablet > 0 or $universal > 0 or $numbers_keyboard > 0) {
                    echo '<br><hr class="hrModalBox"><br>';
                  }
                }
                //CONNECTION TYPE-------------OPTION BOXES------------END

                //USE-------------OPTION BOXES------------START
                if ($for_desk > 0 or $for_tablet > 0 or $universal > 0 or $numbers_keyboard > 0) {
                  echo '<p class="typesOfDisksInCategorySSD">
                    <b>Use</b>
                  </p><br>';
                  if ($for_desk > 0) {
                    echo '<label class="containerRadioButton">Office ('. $for_desk. ')
                        <input type="radio" name="useSubmit" id="Office" value="Office" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>&nbsp;&nbsp;&nbsp;';
                  } else {
                    echo '<label class="containerRadioButton"><font color="#b3b3b3">Office (0)</font>
                        <input type="radio" name="useSubmit" id="Office" value="Office" disabled> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>&nbsp;&nbsp;&nbsp;';
                  }

                  if ($for_tablet > 0) {
                    echo '<label class="containerRadioButton">Tablet ('. $for_tablet. ')
                        <input type="radio" name="useSubmit" id="Tablet" value="Tablet" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>&nbsp;&nbsp;&nbsp;';
                  } else {
                    echo '<label class="containerRadioButton"><font color="#b3b3b3">Tablet (0)</font>
                        <input type="radio" name="useSubmit" id="Tablet" value="Tablet" disabled> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>&nbsp;&nbsp;&nbsp;';
                  }

                  if ($universal > 0) {
                    echo '<label class="containerRadioButton">Universal Devices ('. $universal. ')
                        <input type="radio" name="useSubmit" id="UniversalDevices" value="Universal Devices" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>&nbsp;&nbsp;&nbsp;';
                  } else {
                    echo '<label class="containerRadioButton"><font color="#b3b3b3">Universal Devices (0)</font>
                        <input type="radio" name="useSubmit" id="UniversalDevices" value="Universal Devices" disabled> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>&nbsp;&nbsp;&nbsp;';
                  }

                  if ($numbers_keyboard > 0) {
                    echo '<label class="containerRadioButton">Arithmetic Keyboard ('. $numbers_keyboard. ')
                        <input type="radio" name="useSubmit" id="ArithmeticKeyboard" value="Arithmetic Keyboard" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>&nbsp;&nbsp;&nbsp;';
                  } else {
                    echo '<label class="containerRadioButton"><font color="#b3b3b3">Arithmetic Keyboard (0)</font>
                        <input type="radio" name="useSubmit" id="ArithmeticKeyboard" value="Arithmetic Keyboard" disabled> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                      </label>&nbsp;&nbsp;&nbsp;';
                  }
                }
                //USE-------------OPTION BOXES------------END
                //CONNECT WITH DATABASE FOR FILTERS-------------------------------------------------------------------------
              ...
              <footer class="modal-footer" id="buttonsForFilters" style="display:none;">
                ...
                <script>
                  function clearFiltersFunction() {';
                    $conn_submit = "";
                    $kind_submit = "";
                    $connectionType_submit = "";
                    $use_submit = "";
                    $something_explode = "";
                    $conn_submit_explode = "";
                    $kind_submit_explode = "";
                    $connectionType_submit_explode = "";
                    $use_submit_explode = "";
                    ...
                    if (isset($_POST["kindSubmit"])) {
                      ...
                      if ($_POST["kindSubmit"] == "Keyboard & Mouse Set") {
                        $kind_submit_explode = "Set";
                      } elseif ($_POST["kindSubmit"] == "Keyboard with touchpad") {
                        $kind_submit_explode = "KeyboardWithTouchpad";
                      } else {
                    ...
                    //CONNECTION TYPE-----------------------------------------------------------------------------
                    if (isset($_POST["connTypeSubmit"])) {
                      $connectionType_submit = $_POST["connTypeSubmit"];
                      $connectionType_submit_explode = $_POST["connTypeSubmit"];
                      echo 'document.getElementById("'. $connectionType_submit_explode. '").checked = false;';
                    }
                    //CONNECTION TYPE-----------------------------------------------------------------------------

                    //USE-----------------------------------------------------------------------------
                    if (isset($_POST["useSubmit"])) {
                      $use_submit = $_POST["useSubmit"];
                      if ($_POST["useSubmit"] == "Office" or $_POST["useSubmit"] == "Tablet") {
                        $use_submit_explode = $_POST["useSubmit"];
                      } else {
                        $something_explode = explode(' ', $_POST["useSubmit"]);
                        foreach($something_explode as $something_explode) {
                          $use_submit_explode .= $something_explode;
                        }
                      }
                      echo 'document.getElementById("'. $use_submit_explode. '").checked = false;';
                    }
                    //USE-----------------------------------------------------------------------------
                  echo '}
                </script>
        ...
        if(isset($_POST["searchBar"])) {
          ...
          if ($searcher == 1) {
            if ($notSearch == 0) {
              ...
              $sql = "SELECT * FROM Keyboard_Mouse WHERE Category LIKE '%Keyboard%' AND Description LIKE '%$search_expression%'";
              $result = $conn->query($sql);
              if ($result->num_rows <= 0) {
                $sql = "SELECT * FROM Keyboard_Mouse WHERE Category LIKE '%Keyboard%' AND  Description LIKE '%$search_post%'";
                $result = $conn->query($sql);
                if ($result->num_rows <=0 ) {
                  $sql = "SELECT * FROM Keyboard_Mouse WHERE Category LIKE '%Keyboard%' AND $keywords";
                  $result = $conn->query($sql);
                  if ($result->num_rows <= 0) {
                    $sql = "SELECT * FROM Keyboard_Mouse WHERE Category LIKE '%Keyboard%'";
                    $result = $conn->query($sql);
            ...
            if ($result->num_rows > 0) {
              ...
              while($row=$result->fetch_assoc()) {
                ...
                echo '<form action="../../../Pages/PCBuilderPCBuild" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">';
                    ...
                    echo '<input type="hidden" id="KEYBPiece" name="KEYBPiece" value="Keyboard">';
                ...
                echo '<input type="hidden" id="brandModelKEYB" name="brandModelKEYB" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                echo '<b><font size="2px">Product Code: '. $row["ProductCode"]. '</font></b>';  
                echo '<input type="hidden" id="ProductCodeKEYB" name="ProductCodeKEYB" value="'. $row["ProductCode"]. '">';
                echo '<br><br><br><br><br>';
                //FOR KEYBOARD & MOUSE SET--------INPUTS FOR MOUSE
                if ($row["Category"] == "Keyboard & Mouse Set") {
                  echo '<input type="hidden" id="MOUSEPiece" name="MOUSEPiece" value="Mouse">
                  <input type="hidden" id="brandModelMOUSE" name="brandModelMOUSE" value="'. $row["Brand"]. ' '. $row["Model"]. '">
                  <input type="hidden" id="ProductCodeMOUSE" name="ProductCodeMOUSE" value="'. $row["ProductCode"]. '">
                  <input type="hidden" id="categoryMOUSE" name="categoryMOUSE" value="'. $row["Category"]. '">';
                  ...
                  if (isset($_POST["categoryMOUSE"])) {
                    if ($_POST["categoryMOUSE"] == "Keyboard & Mouse Set") {
                      echo '<input type="hidden" id="MOUSEPiece" name="MOUSEPiece" value="">';
                    }
                  }
                }
                //FOR KEYBOARD & MOUSE SET--------INPUTS FOR MOUSE
                  ...
                  <div class="specs">';
                    ...
                    echo '<center><font color="black"><table class="tableSpecs">
                        ...
                        <tr class="rowsOnSpecsTR">
                            <td class="rowsOnSpecs">Kind</td>
                            <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            <td class="rowsOnSpecs">'. $row["kind_keyboard"]. '</td>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                            <td class="rowsOnSpecs">Keyboard & Mouse Set</td>
                            <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            <td class="rowsOnSpecs">'. $row["Category"]. '</td>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                            <td class="rowsOnSpecs">Extra</td>
                            <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            <td class="rowsOnSpecs">'. $row["extra_keyboard"]. '</td>
                        </tr>
                        <tr class="tableSpecs">
                        ...
                        <tr class="rowsOnSpecsTR">
                            ...
                            <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            <td class="rowsOnSpecs">'. $row["wireless_keyboard"]. '</td>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                            <td class="rowsOnSpecs">Connection</td>
                            <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            <td class="rowsOnSpecs">'. $row["connection_keyboard"]. '</td>
                        </tr>
                    </table></font></center>';
                  echo '</div>';
                echo '</div>';
                echo '<input type="hidden" id="categoryKEYB" name="categoryKEYB" value="'. $row["Category"]. '">';
                //INFO OF PRODUCTS-END
                //PRICE OF PRODUCTS
                echo '<div class="productCardpreview">';
                if ($ekptwshPrice == $PriceMod) {
                  echo '<h2 align="right">'. $row["Price"]. '€</h2>';
                  echo '<input type="hidden" id="PriceKEYB" name="PriceKEYB" value="'. $row["Price"]. '">';
                  echo '<input type="hidden" id="EkptwshKEYB" name="EkptwshKEYB" value="">';
                } elseif ($ekptwshPrice == "0") {
                  echo '<h2 align="right">'. $row["Price"]. '€</h2>';
                  echo '<input type="hidden" id="PriceKEYB" name="PriceKEYB" value="'. $row["Price"]. '">';
                  echo '<input type="hidden" id="EkptwshKEYB" name="EkptwshKEYB" value="">';
                  ...
                  echo '<input type="hidden" id="PriceKEYB" name="PriceKEYB" value="'. $row["PriceEkptwsh"]. '">';
                  echo '<input type="hidden" id="EkptwshKEYB" name="EkptwshKEYB" value="'. $row["Price"]. '">';
                }
                if ($brINbutton = 0) {
                ...
                echo '<form action="../../../Pages/PCBuilderPCBuild" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">';
                  ...
                  echo '<input type="hidden" id="pieceKEYB" name="KEYBPiece" value="Keyboard">';
                  ...
                  echo '<input type="hidden" id="brandModelKEYB" name="brandModelKEYB" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                  echo '<input type="hidden" id="ProductCodeKEYB" name="ProductCodeKEYB" value="'. $row["ProductCode"]. '">';
                  echo '<input type="hidden" id="categoryKEYB" name="categoryKEYB" value="'. $row["Category"]. '"><br><br>';
                  //FOR KEYBOARD & MOUSE SET--------INPUTS FOR MOUSE
                if ($row["Category"] == "Keyboard & Mouse Set") {
                  echo '<input type="hidden" id="MOUSEPiece" name="MOUSEPiece" value="Mouse">
                  <input type="hidden" id="brandModelMOUSE" name="brandModelMOUSE" value="'. $row["Brand"]. ' '. $row["Model"]. '">
                  ...
                  echo '<br><center><button type="button" class="collapsibleMin">Specs</button>';
                    echo '<div class="contentMin">';
                        echo '<table class="tableSpecsMin">
                            ...
                            <!--ONE SPEC-->
                                <tr>
                                <td class="NameOfSpecsMin">Kind</td>
                                </tr>
                                <tr>
                                <td class="FromDatabaseSpecsMin">'. $row["kind_keyboard"]. '</td>
                                </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                                <tr>
                                <td class="NameOfSpecsMin">Keyboard & Mouse Set</td>
                                </tr>
                                <tr>
                                <td class="FromDatabaseSpecsMin">'. $row["Category"]. '</td>
                                </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                                <tr>
                                <td class="NameOfSpecsMin">Extra</td>
                                </tr>
                                <tr>
                                <td class="FromDatabaseSpecsMin">'. $row["extra_keyboard"]. '</td>
                                </tr>
                            <!--ONE SPEC-->
                            <!--ONE CATEGORY OF SPECS-->
                            <!--ONE CATEGORY OF SPECS-->
                            <tr>
                              <th class="KEFALIDAmin">Connectivity</the
                            </tr>
                            <!--ONE SPEC-->
                                <tr>
                                ...
                                <tr>
                                <td class="FromDatabaseSpecsMin">'. $row["wireless_keyboard"]. '</td>
                                </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                                <tr>
                                ...
                                <tr>
                                <td class="FromDatabaseSpecsMin">'. $row["connection_keyboard"]. '</td>
                                </tr>
                            <!--ONE SPEC-->
                            <!--ONE CATEGORY OF SPECS-->
                        </table>';
        ...
        if ($clearStep == 0 and (isset($_POST["connSubmit"]) or isset($_POST["kindSubmit"]) or isset($_POST["connectionTypeSubmit"]) or isset($_POST["useSubmit"])) and $searcher == 0) {
          //connSubmit            For connection type (Wireless-->Yes, Wired-->No)
          //kindSubmit            For keyboard type (Simple keyboard, Keyboard & Mouse Set, Keyboard with touchpad)
          //connectionTypeSubmit  For connectivity (USB, Bluetooth)
          //useSubmit             For usage (Office, Tablet, Universal Devices, Numeric Keyboard)
          $keywords = "";
          $conn_submit = "";
          $kind_submit = "";
          $connectionType_submit = "";
          ...
          if (isset($_POST["connSubmit"])) {
            ...
            if ($keywords == "") {
              $keywords = " wireless_keyboard='$conn_submit'";
            } else {
              $keywords .= " AND wireless_keyboard='$conn_submit'";
            }
          }

          if (isset($_POST["kindSubmit"])) {
            $kind_submit = $_POST["kindSubmit"];
            if ($kind_submit == "Keyboard with touchpad") {
              $kind_submit_explode = "KeyboardWithTouchpad";
            } elseif ($kind_submit == "Keyboard & Mouse Set") {
              $kind_submit_explode = "KeyboardSet";
            } else {
              $something_explode = explode(' ', $_POST["kindSubmit"]);
              foreach($something_explode as $something_explode) {
                $kind_submit_explode .= $something_explode;
            ...
            if ($keywords == "") {
              $keywords = " Category='$kind_submit'";
            } else {
              $keywords .= " AND Category='$kind_submit'";
            }
          }

          if (isset($_POST["connectionTypeSubmit"])) {
            $connectionType_submit = $_POST["connectionTypeSubmit"];
            $connectionType_submit_explode = $_POST["connectionTypeSubmit"];
            echo '<script>
              document.getElementById("'. $connectionType_submit_explode. '").checked = true;
              document.getElementById("buttonsForFilters").style.display = "block";
            </script>';
            if ($keywords == "") {
              $keywords = " connection_keyboard='$connectionType_submit'";
            } else {
              $keywords .= " AND connection_keyboard='$connectionType_submit'";
            }
          }
          ...
          if (isset($_POST["useSubmit"])) {
            ...
            echo '<script>
              document.getElementById("'. $use_submit_explode. '").checked = true;
              document.getElementById("buttonsForFilters").style.display = "block"
            </script>';
            if ($keywords == "") {
              $keywords = " kind_keyboard LIKE '%$use_submit%'";
            } else {
              $keywords .= " AND kind_keyboard LIKE '%$use_submit%'";
            }
          }
          $sql = "SELECT * FROM Keyboard_Mouse WHERE$keywords AND Category LIKE '%Keyboard%'";
          $result = $conn->query($sql);
		...
		<center><div class="no-results-search-message">
        	We do not have SOMETHING right now. Please search for an other product!
                  ...
                  if (isset($_POST["connSubmit"])) {
                    $conn_submit = $_POST["connSubmit"];
                    if ($_POST["connSubmit"] == "Wireless") {
                      $conn_submit_explode = "Yes";
                    } else {
                      $conn_submit_explode = "No";
                    }
                    echo '<script>
                      document.getElementById("'. $conn_submit_explode. '").checked = false;
                    </script>';
                  }
                  //CONNECTIVITY-----------------------------------------------------------------------------
                  ...
                  if (isset($_POST["kindSubmit"])) {
                    ...
                    echo '<script>
                      document.getElementById("'. $kind_submit_explode. '").checked = false;
                    </script>';
                  }
                  //KIND-----------------------------------------------------------------------------
                  ...
                  if (isset($_POST["connTypeSubmit"])) {
                    ...
                    $connectionType_submit_explode = $_POST["connTypeSubmit"];
                    echo '<script>
                      document.getElementById("'. $connectionType_submit_explode. '").checked = false;
                    </script>';
                  }
                  //CONNECTION TYPE-----------------------------------------------------------------------------
                  ...
                  if (isset($_POST["useSubmit"])) {
                    ...
                    echo '<script>
                      document.getElementById("'. $use_submit_explode. '").checked = false;
                    </script>';
                  }
                  //USE-----------------------------------------------------------------------------
