...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-Ready PC Build-Category:<?php echo $_POST["categoryCPU"]; ?>/CPU Cooler select</TITLE>
...
if ($_POST["brandModelCPU"] != "") {
    ...
    if ($conn->connect_error) {
        ...
        echo '<form method="post"><div class="modal" id="modal1">
          <div class="modal-dialog" style="width: 700px;">
            ...
            <section class="modal-content">
                ...
                $sql = "SELECT * FROM CPU_COOLER WHERE Category LIKE '%Energetic%' AND socket LIKE '%$socket%'";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        $energetic++;
                ...
                $sql = "SELECT * FROM CPU_COOLER WHERE Category LIKE '%Low Profile%' AND socket LIKE '%$socket%'";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        $low_profile++;
                ...
                $sql = "SELECT * FROM CPU_COOLER WHERE Category LIKE '%Passive%' AND socket LIKE '%$socket%'";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        $passive++;
                ...
                $sql = "SELECT * FROM CPU_COOLER WHERE Category LIKE '%Water Cooler%' AND socket LIKE '%$socket%'";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        $water_cooling++;
                ...
                if ($cooler > 0) {
                    if ($energetic > 0 or $low_profile > 0 or $passive > 0 or $water_cooling > 0) {
                    ...
                    if ($energetic > 0) {
                    echo '<label class="containerRadioButton">Energetic ('. $energetic. ')
                        <input type="radio" name="coolerType" id="energetic" value="energetic" onclick="enabledButtons()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                    </label>';
                    }
                    if ($low_profile > 0) {
                    echo '<label class="containerRadioButton">Low Profile ('. $low_profile. ')
                        <input type="radio" name="coolerType" id="lowProfile" value="lowProfile" onclick="enabledButtons()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                    </label>';
                    }
                    if ($passive > 0) {
                    echo '<label class="containerRadioButton">Passive ('. $passive. ')
                        <input type="radio" name="coolerType" id="passive" value="passive" onclick="enabledButtons()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                    </label>';
                    }
                    if ($water_cooling > 0) {
                    echo '<label class="containerRadioButton">Water Cooler ('. $water_cooling. ')
                        <input type="radio" name="coolerType" id="waterCooling" value="waterCooling" onclick="enabledButtons()"> <!--checked="checked"-->
                        <span class="checkmarkRadioButton"></span>
                    </label>';
                    }
                } else {
        ...
        if(isset($_POST["searchBar"])) {
          ...
          if ($searcher == 1) {
            if ($notSearch == 0) {
              ...
              $sql = "SELECT * FROM CPU_COOLER WHERE Description LIKE '%$search_expression%' AND socket LIKE '%$socket%'";
              $result = $conn->query($sql);
              if ($result->num_rows <= 0) {
                $sql = "SELECT * FROM CPU_COOLER WHERE Description LIKE '%$search_post%' AND socket LIKE '%$socket%'";
                $result = $conn->query($sql);
                if ($result->num_rows <=0 ) {
                  $sql = "SELECT * FROM CPU_COOLER WHERE $keywords AND socket LIKE '%$socket%'";
                  $result = $conn->query($sql);
                  if ($result->num_rows <= 0) {
            ...
            if ($result->num_rows > 0) {
              ...
              while($row=$result->fetch_assoc()) {
                ...
                echo '<form action="../../../Pages/PCBuilderPCBuild" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">';
                    ...
                    echo '<input type="hidden" id="COOLERPiece" name="COOLERPiece" value="Cooler For CPU">';
                ...
                echo '<input type="hidden" id="brandModelCOOLER" name="brandModelCOOLER" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                echo '<b><font size="2px">Product Code: '. $row["ProductCode"]. '</font></b>';  
                echo '<input type="hidden" id="ProductCodeCOOLER" name="ProductCodeCOOLER" value="'. $row["ProductCode"]. '">';
                ...
                echo '<button type="button" class="productCard-Button"></font></button>
                  <div class="specs">';
                    ...
                    if ($row["Category"] == "Water Cooler") {
                        echo '<center><font color="black"><table class="tableSpecs">
                            ...
                            <tr class="rowsOnSpecsTR">
                                <td class="rowsOnSpecs">Fridge Size</td>
                                <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td class="rowsOnSpecs">'. $row["fridgeDimension_water"]. '</td>
                            </tr>
                            <tr class="rowsOnSpecsTR">
                                <td class="rowsOnSpecs">Fan Size</td>
                                <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td class="rowsOnSpecs">'. $row["coolerDimension_water"]. '</td>
                            </tr>
                            <tr class="tableSpecs">
                                <th class="rowsOnSpecs">Specifications</th>
                            </tr>
                            <tr class="rowsOnSpecsTR">
                                <td class="rowsOnSpecs">Full Rounds</td>
                                <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td class="rowsOnSpecs">'. $row["rounds"]. '</td>
                            </tr>
                            <tr class="rowsOnSpecsTR">
                                <td class="rowsOnSpecs">Noise Levels (Full Load)</td>
                                <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            ...
                            <tr class="rowsOnSpecsTR">
                                ...
                                <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td class="rowsOnSpecs">'. $row["airFlow_water"]. '</td>
                            </tr>
                        </table></font></center>';
                    } else {
                        echo '<center><font color="black"><table class="tableSpecs">
                            ...
                            <tr class="rowsOnSpecsTR">
                                <td class="rowsOnSpecs">Cooler Type</td>
                                <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            ...
                            <tr class="rowsOnSpecsTR">
                                <td class="rowsOnSpecs">Noise Levels</td>
                                <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td class="rowsOnSpecs">'. $row["sound"]. '</td>
                            </tr>
                        </table></font></center>';
                  ...
                  echo '</div>';
                echo '</div>';
                echo '<input type="hidden" id="categoryCOOLER" name="categoryCOOLER" value="---">';
                //INFO OF PRODUCTS-END
                //PRICE OF PRODUCTS
                echo '<div class="productCardpreview">';
                if ($ekptwshPrice == $PriceMod) {
                  echo '<h2 align="right">'. $row["Price"]. '€</h2>';
                  echo '<input type="hidden" id="PriceCOOLER" name="PriceCOOLER" value="'. $row["Price"]. '">';
                  echo '<input type="hidden" id="EkptwshCOOLER" name="EkptwshCOOLER" value="">';
                  ...
                  echo '<input type="hidden" id="PriceCOOLER" name="PriceCOOLER" value="'. $row["PriceEkptwsh"]. '">';
                  echo '<input type="hidden" id="EkptwshCOOLER" name="EkptwshCOOLER" value="'. $row["Price"]. '">';
                }
                if ($brINbutton = 0) {
                ...
                echo '<form action="../../../Pages/PCBuilderPCBuild" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">';
                  ...
                  echo '<input type="hidden" id="pieceCOOLER" name="COOLERPiece" value="Cooler For CPU">';
                  ...
                  echo '<input type="hidden" id="brandModelCOOLER" name="brandModelCOOLER" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                  echo '<input type="hidden" id="ProductCodeCOOLER" name="ProductCodeCOOLER" value="'. $row["ProductCode"]. '">';
                  echo '<input type="hidden" id="categoryCOOLER" name="categoryCOOLER" value="---"><font color="#ccc">'. $caseType. '</font><br>';
                  if ($ekptwshPrice == $PriceMod) {
                  ...
                  echo '<br><center><button type="button" class="collapsibleMin">Specs</button>';
                    ...
                    if ($row["Category"] == "Water Cooler") {
                        echo '<table class="tableSpecsMin">
                            ...
                            <!--ONE SPEC-->
                                <tr>
                                <td class="NameOfSpecsMin">Fridge Size</td>
                                </tr>
                                <tr>
                                <td class="FromDatabaseSpecsMin">'. $row["fridgeDimension_water"]. '</td>
                                </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                                <tr>
                                <td class="NameOfSpecsMin">Fan Size</td>
                                </tr>
                                <tr>
                                <td class="FromDatabaseSpecsMin">'. $row["coolerDimension_water"]. '</td>
                                </tr>
                            <!--ONE SPEC-->
                            <!--ONE CATEGORY OF SPECS-->
                            <!--ONE CATEGORY OF SPECS-->
                            ...
                            <!--ONE SPEC-->
                                <tr>
                                <td class="NameOfSpecsMin">Full Rounds</td>
                                </tr>
                                <tr>
                            ...
                            <!--ONE SPEC-->
                                <tr>
                                <td class="NameOfSpecsMin">Noise Levels (Full Load)</td>
                                </tr>
                                <tr>
                            ...
                            <!--ONE SPEC-->
                                ...
                                <tr>
                                <td class="FromDatabaseSpecsMin">'. $row["airFlow_water"]. '</td>
                                </tr>
                            <!--ONE SPEC-->
                            <!--ONE CATEGORY OF SPECS-->
                        </table>';
                        ...
                        echo '<table class="tableSpecsMin">
                            ...
                            <!--ONE SPEC-->
                                <tr>
                                <td class="NameOfSpecsMin">Cooler Type</td>
                                </tr>
                                <tr>
        ...
        //------------------SEARCH ENGINE-----------------END------------------
        if (isset($_POST["submitFilters"]) && isset($_POST["coolerType"]) && $searcher == 0) {
            $socket = $_POST["SocketCPU"];
            $coolerType = $_POST["coolerType"];
            if ($coolerType == "energetic") {
                $coolerType = "Energetic";
                echo '<script>
                document.getElementById("energetic").checked = true;
                document.getElementById("buttonsForFilters").style.display = "block";
                </script>';
            } elseif ($coolerType == "lowProfile") {
                $coolerType = "Low Profile";
                echo '<script>
                document.getElementById("lowProfile").checked = true;
                document.getElementById("buttonsForFilters").style.display = "block";
                </script>';
            } elseif ($coolerType == "passive") {
                $coolerType = "Passive";
                echo '<script>
                document.getElementById("passive").checked = true;
                document.getElementById("buttonsForFilters").style.display = "block";
                </script>';
            } elseif ($coolerType == "waterCooling") {
                $coolerType = "Water Cooler";
                echo '<script>
                document.getElementById("waterCooling").checked = true;
                document.getElementById("buttonsForFilters").style.display = "block";
                </script>';
            }

          $sql = "SELECT * FROM CPU_COOLER WHERE Category LIKE '%$coolerType%' AND socket LIKE '%$socket%'";
          $result = $conn->query($sql);
          if ($result->num_rows > 0) {
            $onoma_for_title = 0;
            $brINbutton = 0;
          ...
          if ($result->num_rows > 0) {
            ...
            while($row=$result->fetch_assoc()) {
              ...
              echo '<form action="../../../Pages/PCBuilderPCBuild" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">';
                ...
                echo '<input type="hidden" id="brandModelCOOLER" name="brandModelCOOLER" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                echo '<input type="hidden" id="ProductCodeCOOLER" name="ProductCodeCOOLER" value="'. $row["ProductCode"]. '">';
                echo '<input type="hidden" id="categoryCOOLER" name="categoryCOOLER" value="---"><font color="#ccc">'. $row["Category"]. '</font><br>';
                if ($ekptwshPrice == $PriceMod) {
                echo '<p class="priceMin">'. $row["Price"]. '€</p>';
                echo '<input type="hidden" id="PriceCOOLER" name="PriceCOOLER" value="'. $row["Price"]. '">';
                echo '<input type="hidden" id="EkptwshCOOLER" name="EkptwshCOOLER" value="">';
