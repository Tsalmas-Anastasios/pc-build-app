...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-Ready PC Build-Category:<?php echo $_POST["categoryCPU"]; ?>/Sound Card select</TITLE>
...
if ($_POST["brandModelCPU"] != "") {
    ...
    if ($conn->connect_error) {
        ...
        echo '<form method="post" name="formFiltersModal"><div class="modal" id="modal1">
          <div class="modal-dialog" style="width: 700px;">
            ...
            <section class="modal-content">
                ...
                if (isset($_POST["connSubmit"]) or isset($_POST["channelSubmit"])) {
                  $keywords = "";
                  $key = "";
                  if (isset($_POST["connSubmit"])) {
                    $key = $_POST["connSubmit"];
                    $keywords = " interface='$key'";
                  }
                  if (isset($_POST["channelSubmit"])) {
                    ...
                    if ($keywords == "") {
                      ...
                      $keywords .= " AND channels='$key'";
                    }
                  }
                  $sql = "SELECT * FROM Sound_Cards WHERE in_device='Yes' AND$keywords";
                } else {
                ...
                if ($result->num_rows > 0) {
                  ...
                  //Variables for sound channels---START
                  $c20 = 0;
                  $c40 = 0;
                  $c51 = 0;
                  $c71 = 0;
                  //Variables for sound channels---END
                  while($row = $result->fetch_assoc()) {
                    //Connectivity---START
                    if ($row["interface"] == "PCI Express") {
                      $pci_express++;
                    } elseif ($row["interface"] == "PCI") {
                      $pci++;
                    }
                    //Connectivity---END
                    //Sound channels---START
                    if ($row["channels"] == "2.0") {
                      $c20++;
                    } elseif ($row["channels"] == "4.0") {
                      $c40++;
                    } elseif ($row["channels"] == "5.1") {
                      $c51++;
                    } elseif ($row["channels"] == "7.1") {
                      $c71++;
                    }
                    //Sound channels---END
                  }
                ...
                //FOR ONLY ONE SUBMIT EXITSTS---START
                  //FOR $_POST["connSubmit"] --- START
                  if (isset($_POST["connSubmit"]) and !isset($_POST["channelSubmit"])) {
                    $sql = "SELECT * FROM Sound_Cards WHERE in_device='Yes'";
                    $result = $conn->query($sql);
                    if ($result->num_rows > 0) {
                      //Variables for connectivity---START
                  ...
                  if (isset($_POST["channelSubmit"]) and !isset($_POST["connSubmit"])) {
                    $sql = "SELECT * FROM Sound_Cards WHERE in_device='Yes'";
                    $result = $conn->query($sql);
                    if ($result->num_rows > 0) {
                      //Variables for sound channels---START
                ...
                //FOR ONLY ONE SUBMIT EXITSTS---END
                //IF BOTH EXISTS---START
                  if (isset($_POST["connSubmit"]) and isset($_POST["channelSubmit"])) {
                    $key = $_POST["channelSubmit"];
                    $sql = "SELECT * FROM Sound_Cards WHERE in_device='Yes' AND channels='$key'";
                    $result = $conn->query($sql);
                    if ($result->num_rows > 0) {
                      //Variables for connectivity---START
                      $pci_express = 0;
                ...
                //CREATE OPTION BOXES --- START
                  if ($pci_express > 0 or $pci > 0) {
                    echo '<p class="typesOfDisksInCategorySSD">
                      <b>Connectivity</b>
                    </p><br>';
                      if ($pci_express > 0) {
                        echo '<label class="containerRadioButton">PCI Express ('. $pci_express. ')
                          <input type="radio" name="connSubmit" id="PCIExpress" value="PCI Express" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      } else {
                        echo '<label class="containerRadioButton"><font color="#b3b3b3">PCI Express (0)</font>
                          <input type="radio" name="connSubmit" id="PCIExpress" value="PCI Express" disabled> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      }
                      if ($pci > 0) {
                        echo '<label class="containerRadioButton">PCI ('. $pci. ')
                          <input type="radio" name="connSubmit" id="PCI" value="PCI" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      } else {
                        echo '<label class="containerRadioButton"><font color="#b3b3b3">PCI (0)</font>
                          <input type="radio" name="connSubmit" id="PCI" value="PCI" disabled> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      }
                    if ($c20 > 0 or $c40 > 0 or $c51 > 0 or $c71 > 0) {
                  ...
                  if ($c20 > 0 or $c40 > 0 or $c51 > 0 or $c71 > 0) {
                    echo '<p class="typesOfDisksInCategorySSD">
                      ...
                      if ($c20 > 0) {
                        echo '<label class="containerRadioButton">2.0 ('. $c20. ')
                          <input type="radio" name="channelSubmit" id="c20" value="2.0" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      } else {
                        echo '<label class="containerRadioButton"><font color="#b3b3b3">2.0 (0)</font>
                          <input type="radio" name="channelSubmit" id="c20" value="2.0" disabled> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      }
                      if ($c40 > 0) {
                        echo '<label class="containerRadioButton">4.0 ('. $c40. ')
                          <input type="radio" name="channelSubmit" id="c40" value="4.0" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      } else {
                        echo '<label class="containerRadioButton"><font color="#b3b3b3">4.0 (0)</font>
                          <input type="radio" name="channelSubmit" id="c40" value="4.0" disabled> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      }
                      if ($c51 > 0) {
                        echo '<label class="containerRadioButton">5.1 ('. $c51. ')
                          <input type="radio" name="channelSubmit" id="c51" value="5.1" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      } else {
                        echo '<label class="containerRadioButton"><font color="#b3b3b3">5.1 (0)</font>
                          <input type="radio" name="channelSubmit" id="c51" value="5.1" disabled> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      }
                      if ($c71 > 0) {
                        echo '<label class="containerRadioButton">7.1 ('. $c71. ')
                          <input type="radio" name="channelSubmit" id="c71" value="7.1" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      }
                  }
        ...
        if(isset($_POST["searchBar"])) {
          ...
          if ($searcher == 1) {
            if ($notSearch == 0) {
              ...
              $sql = "SELECT * FROM Sound_Cards WHERE Description LIKE '%$search_expression%' AND in_device='Yes'";
              $result = $conn->query($sql);
              if ($result->num_rows <= 0) {
                $sql = "SELECT * FROM Sound_Cards WHERE Description LIKE '%$search_post%' AND in_device='Yes'";
                $result = $conn->query($sql);
                if ($result->num_rows <=0 ) {
                  $sql = "SELECT * FROM Sound_Cards WHERE $keywords AND in_device='Yes'";
                  $result = $conn->query($sql);
                  if ($result->num_rows <= 0) {
                    $sql = "SELECT * FROM Sound_Cards WHERE in_device='Yes'";
                    $result = $conn->query($sql);
            ...
            if ($result->num_rows > 0) {
              ...
              while($row=$result->fetch_assoc()) {
                ...
                echo '<form action="../../../Pages/PCBuilderPCBuild" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">';
                    ...
                    echo '<input type="hidden" id="SOUNDPiece" name="SOUNDPiece" value="Sound Card">';
                ...
                echo '<input type="hidden" id="brandModelSOUND" name="brandModelSOUND" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                echo '<b><font size="2px">Product Code: '. $row["ProductCode"]. '</font></b>';  
                echo '<input type="hidden" id="ProductCodeSOUND" name="ProductCodeSOUND" value="'. $row["ProductCode"]. '">';
                echo '<br><br><br><br><br>';
                echo '<button type="button" class="productCard-Button"></font></button>
                  <div class="specs">';
                    ...
                    echo '<center><font color="black"><table class="tableSpecs">
                      <tr class="tableSpecs">
                        <th class="rowsOnSpecs">Sound</th>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Sound Channels</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["channels"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Internal device</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["in_device"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Sound quality</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["quality"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Sound levels</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["sound_level"]. '</td>
                      </tr>
                      <tr class="tableSpecs">
                      ...
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">S/PDIF Ports</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["SPDIF"]. '</td>
                      </tr>
                    </table></font></center>';
                  echo '</div>';
                echo '</div>';
                echo '<input type="hidden" id="categorySOUND" name="categorySOUND" value="'. $row["interface"].  '">';
                //INFO OF PRODUCTS-END
                //PRICE OF PRODUCTS
                echo '<div class="productCardpreview">';
                if ($ekptwshPrice == $PriceMod) {
                  echo '<h2 align="right">'. $row["Price"]. '€</h2>';
                  echo '<input type="hidden" id="PriceSOUND" name="PriceSOUND" value="'. $row["Price"]. '">';
                  echo '<input type="hidden" id="EkptwshSOUND" name="EkptwshSOUND" value="">';
                  ...
                  echo '<input type="hidden" id="PriceSOUND" name="PriceSOUND" value="'. $row["PriceEkptwsh"]. '">';
                  echo '<input type="hidden" id="EkptwshSOUND" name="EkptwshSOUND" value="'. $row["Price"]. '">';
                }
                if ($brINbutton = 0) {
                ...
                echo '<form action="../../../Pages/PCBuilderPCBuild" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">';
                  ...
                  echo '<input type="hidden" id="pieceSOUND" name="SOUNDPiece" value="Sound Card">';
                  ...
                  echo '<input type="hidden" id="brandModelSOUND" name="brandModelSOUND" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                  echo '<input type="hidden" id="ProductCodeSOUND" name="ProductCodeSOUND" value="'. $row["ProductCode"]. '">';
                  echo '<input type="hidden" id="categorySOUND" name="categorySOUND" value="'. $row["interface"].  '"><br><br>';
                  if ($ekptwshPrice == $PriceMod) {
                  ...
                  echo '<br><center><button type="button" class="collapsibleMin">Specs</button>';
                    echo '<div class="contentMin">';
                      echo '<table class="tableSpecsMin">
                        ...
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Sound channels</td>
                          </tr>
                          <tr>
                        ...
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Internal device</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["in_device"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Sound quality</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["quality"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Sound levels</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["sound_level"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE CATEGORY OF SPECS-->
                        <!--ONE CATEGORY OF SPECS-->
                        ...
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">S/PDIF Ports</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["SPDIF"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE CATEGORY OF SPECS-->
                      </table>';
        ...
        if ($clearStep == 0 and (isset($_POST["connSubmit"]) or isset($_POST["channelSubmit"])) and $searcher == 0) {
          $keywords = "";
          $key = "";
          $key_javascript = "";
          $key_j = "";
		...
		<center><div class="no-results-search-message">
            ...
            echo '<script>';
              ...
              if (isset($_POST["channelSubmit"])) {
                ...
                $key_javascript = "c$key_javascript";
                echo 'document.getElementById("'. $key_javascript. '").checked = false;';
              }
              //Sound channels---END
            echo '</script>';
