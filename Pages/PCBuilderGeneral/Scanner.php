...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-Ready PC Build-Category:<?php echo $_POST["categoryCPU"]; ?>/Scanner select</TITLE>
...
if ($_POST["brandModelCPU"] != "") {
    ...
    if ($conn->connect_error) {
        ...
        echo '<form method="post" name="formFiltersModal"><div class="modal" id="modal1">
          <div class="modal-dialog" style="width: 700px;">
            ...
            <section class="modal-content">
                ...
                //FILTERS----------------------------------------------------------------------------------------------
                //TAKE DATA FROM DATABASE TABLE AND COUNT VARIABLES --- START
                if (isset($_POST["typeSubmit"]) or isset($_POST["sizeSubmit"]) or isset($_POST["usbConn"]) or isset($_POST["wifiConn"]) or isset($_POST["lanConn"]) or isset($_POST["colourSubmit"])) {
                  $keywords = "";
                  $key = "";
                  ...
                  if (isset($_POST["sizeSubmit"])) {
                    ...
                    if ($keywords == "") {
                      if ($key == "A5") {
                        $keywords = " size='A5' OR size='A6'";
                      } else {
                        $keywords = " size='$key'";
                      }
                    } else {
                      if ($key == "A5") {
                        $keywords = " AND size='A5' OR size='A6'";
                      } else {
                        $keywords .= " AND size='$key'";
                      }  
                    }
                  }
                  if (isset($_POST["usbConn"])) {
                      $key = $_POST["usbConn"];
                      if ($keywords == "") {
                  ...
                  if (isset($_POST["colourSubmit"])) {
                    ...
                    if ($keywords == "") {
                      $keywords = " colour_depth='$key'";
                    } else {
                      $keywords .= " AND colour_depth='$key'";
                    }
                  }
                  $sql = "SELECT * FROM Scanners WHERE$keywords";
                } else {
                ...
                if ($result->num_rows > 0) {
                    ...
                    //Variables for colour depth --- START
                    $bit48 = 0;
                    $bit24 = 0;
                    $bit16 = 0;
                    //Variables for colour depth --- END
                    while($row = $result->fetch_assoc()) {
                        //TYPE---START
                        if ($row["type"] == "Film") {
                            $film++;
                        } elseif ($row["type"] == "Sheetfed") {
                            $sheetfed++;
                        } elseif ($row["type"] == "Flatbed") {
                            $flatbed++;
                        } elseif ($row["type"] == "Hand") {
                            $hand++;
                        }
                        //TYPE---END
                        //SIZE---START
                        if ($row["size"] == "A3") {
                            ...
                            $a4++;
                        } elseif ($row["size"] == "A5" or $row["size"] == "A6") {
                            $a5++;
                        }
                        //SIZE---END
                        //CONNECTIVITY---START
                        ...
                        foreach($explode as $explode) {
                            if ($explode == "USB") {
                                ...
                                $wifi++;
                            } elseif ($explode == "Ethernet") {
                                $ethernet++;
                            }
                        }
                        //CONNECTIVITY---END
                        //COLOUR DEPTH---START
                        if ($row["colour_depth"] == "48 bit") {
                            $bit48++;
                        } elseif ($row["colour_depth"] == "24 bit") {
                            $bit24++;
                        } elseif ($row["colour_depth"] == "16 bit") {
                            $bit16++;
                        }
                        //COLOUR DEPTH---END
                    }
                ...
                //IF ONLY ONE INPUT EXISTS ($_POST["typeSubmit"] or $_POST["sizeSubmit"] or $_POST["colourSubmit"]) take data from checkboxes if exist --- START
                    //FOR $_POST["typeSubmit"] --- START
                    if (isset($_POST["typeSubmit"]) and !isset($_POST["sizeSubmit"]) and !isset($_POST["usbConn"]) and !isset($_POST["wifiConn"]) and !isset($_POST["lanConn"]) and !isset($_POST["colourSubmit"])) {
                        //Variables for type --- START
                        $film = 0;
                        $sheetfed = 0;
                        $flatbed = 0;
                    ...
                    if (isset($_POST["sizeSubmit"]) and !isset($_POST["typeSubmit"]) and !isset($_POST["usbConn"]) and !isset($_POST["wifiConn"]) and !isset($_POST["lanConn"]) and !isset($_POST["colourSubmit"])) {
                        //Variables for size --- START
                        $a3 = 0;
                        $a4 = 0;
                        $a5 = 0;
                    ...
                    if (isset($_POST["colourSubmit"]) and !isset($_POST["typeSubmit"]) and !isset($_POST["sizeSubmit"]) and !isset($_POST["usbConn"]) and !isset($_POST["wifiConn"]) and !isset($_POST["lanConn"])) {
                        //Variables for colour depth --- START
                        $bit48 = 0;
                        $bit24 = 0;
                        $bit16 = 0;
                ...
                //IF ONLY ONE INPUT EXISTS ($_POST["typeSubmit"] or $_POST["sizeSubmit"] or $_POST["colourSubmit"]) take data from checkboxes if exist --- END
                //IF 2 OPTION BOXES EXIST ($_POST["typeSubmit"] or $_POST["sizeSubmit"] or $_POST["colourSubmit"]) take data from checkboxes if exist --- START
                    $issetCategory = 0;
                    if (isset($_POST["typeSubmit"])) {
                        $issetCategory++;
                    }
                    ...
                    //FOR $_POST["typeSubmit"] --- START
                    if (isset($_POST["typeSubmit"]) and (isset($_POST["sizeSubmit"]) or isset($_POST["colourSubmit"])) and $issetCategory == 2) {
                        $issetCategory++;
                        $key = $_POST["typeSubmit"];
                        if ($keywords == "") {
                            $sql = "SELECT * FROM Scanners WHERE type='$key'";
                        } else {
                            $sql = "SELECT * FROM Scanners WHERE type='$key' AND$keywords";
                        }
                        $result = $conn->query($sql);
                        if ($result->num_rows > 0) {
                            $issetStep = 0;
                    ...
                    //FOR $_POST["typeSubmit"] --- END
                    //FOR $_POST["sizeSubmit"] --- START
                    if (isset($_POST["sizeSubmit"]) and (isset($_POST["typeSubmit"]) or isset($_POST["colourSubmit"])) and $issetCategory == 2) {
                        $issetCategory++;
                        $key = $_POST["sizeSubmit"];
                        if ($keywords == "") {
                          if ($key == "A5") {
                            $sql = "SELECT * FROM Scanners WHERE size='A5' OR size='A6'";
                          } else {
                            $sql = "SELECT * FROM Scanners WHERE size='$key'";
                          }
                        } else {
                          if ($key == "A5") {
                            $sql = "SELECT * FROM Scanners WHERE size='A5' OR size='A6' AND$keywords";
                          } else {
                            $sql = "SELECT * FROM Scanners WHERE size='$key' AND$keywords";
                          }
                        }
                        $result = $conn->query($sql);
                        if ($result->num_rows > 0) {
                    ...
                    //FOR $_POST["sizeSubmit"] --- END
                    //FOR $_POST["colourSubmit"] --- START
                    if (isset($_POST["colourSubmit"]) and (isset($_POST["typeSubmit"]) or isset($_POST["sizeSubmit"])) and $issetCategory == 2) {
                        $issetCategory++;
                        $key = $_POST["colourSubmit"];
                        if ($keywords == "") {
                            $sql = "SELECT * FROM Scanners WHERE colour_depth='$key'";
                        } else {
                            $sql = "SELECT * FROM Scanners WHERE colour_depth='$key' AND$keywords";
                        }
                        $result = $conn->query($sql);
                        if ($result->num_rows > 0) {
                            $issetStep = 0;
                    ...
                    //FOR $_POST["colourSubmit"] --- END
                //IF 2 OPTION BOXES EXIST ($_POST["typeSubmit"] or $_POST["sizeSubmit"] or $_POST["colourSubmit"]) take data from checkboxes if exist --- END
                //IF ALL OPTION BOXES (3) EXIST ($_POST["typeSubmit"] or $_POST["sizeSubmit"] or $_POST["colourSubmit"]) take data from checkboxes if exist --- START
                    //FOR ALL INPUTS --- START
                    if (isset($_POST["typeSubmit"]) and isset($_POST["sizeSubmit"]) and isset($_POST["colourSubmit"])) {
                        $key = $_POST["sizeSubmit"];
                        if ($keywords == "") {
                          if ($key == "A5") {
                            $keywords = " size='A5' OR size='A6'";
                    ...
                    //FOR ALL INPUTS --- END
                //IF ALL OPTION BOXES (3) EXIST ($_POST["typeSubmit"] or $_POST["sizeSubmit"] or $_POST["colourSubmit"]) take data from checkboxes if exist --- END
                //TAKE DATA FROM DATABASE TABLE AND COUNT VARIABLES --- END
                //CREATE OPTION AND CHECK BOXES --- START
                    //TYPE --- START
                    if ($film > 0 or $sheetfed > 0 or $flatbed > 0 or $hand > 0) {
                        echo '<p class="typesOfDisksInCategorySSD">
                            <b>Type</b>
                        </p><br>';
                            if ($film > 0) {
                                echo '<label class="containerRadioButton">Film ('. $film. ')
                                    <input type="radio" name="typeSubmit" id="Film" value="Film" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                                    <span class="checkmarkRadioButton"></span>
                                </label>&nbsp;&nbsp;&nbsp;';
                            } else {
                                echo '<label class="containerRadioButton"><font color="#b3b3b3">Film (0)</font>
                                    <input type="radio" name="typeSubmit" id="Film" value="Film" disabled> <!--checked="checked"-->
                                    <span class="checkmarkRadioButton"></span>
                                </label>&nbsp;&nbsp;&nbsp;';
                            }
                            if ($sheetfed > 0) {
                                echo '<label class="containerRadioButton">Sheetfed ('. $sheetfed. ')
                                    <input type="radio" name="typeSubmit" id="Sheetfed" value="Sheetfed" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                                    <span class="checkmarkRadioButton"></span>
                                </label>&nbsp;&nbsp;&nbsp;';
                            } else {
                                echo '<label class="containerRadioButton"><font color="#b3b3b3">Sheetfed (0)</font>
                                    <input type="radio" name="typeSubmit" id="Sheetfed" value="Sheetfed" disabled> <!--checked="checked"-->
                                    <span class="checkmarkRadioButton"></span>
                                </label>&nbsp;&nbsp;&nbsp;';
                            }
                            if ($flatbed > 0) {
                                echo '<label class="containerRadioButton">Flatbed ('. $flatbed. ')
                                    <input type="radio" name="typeSubmit" id="Flatbed" value="Flatbed" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                                    <span class="checkmarkRadioButton"></span>
                                </label>&nbsp;&nbsp;&nbsp;';
                            } else {
                                echo '<label class="containerRadioButton"><font color="#b3b3b3">Flatbed (0)</font>
                                    <input type="radio" name="typeSubmit" id="Flatbed" value="Flatbed" disabled> <!--checked="checked"-->
                                    <span class="checkmarkRadioButton"></span>
                                </label>&nbsp;&nbsp;&nbsp;';
                            }
                            if ($hand > 0) {
                                echo '<label class="containerRadioButton">Hand ('. $hand. ')
                                    <input type="radio" name="typeSubmit" id="Hand" value="Hand" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                                    <span class="checkmarkRadioButton"></span>
                                </label>&nbsp;&nbsp;&nbsp;';
                            } else {
                              echo '<label class="containerRadioButton"><font color="#b3b3b3">Hand (0)</font>
                                    <input type="radio" name="typeSubmit" id="Hand" value="Hand" disabled> <!--checked="checked"-->
                                    <span class="checkmarkRadioButton"></span>
                              </label>&nbsp;&nbsp;&nbsp;';
                            } 
                        if ($a3 > 0 or $a4 > 0 or $a5 > 0 or $usb > 0 or $wifi > 0 or $ethernet > 0 or $bit16 > 0 or $bit24 > 0 or $bit48) {
                          echo '<br><hr class="hrModalBox"><br>';
                        }
                    }
                    //TYPE --- END
                    //SIZE --- START
                    if ($a3 > 0 or $a4 > 0 or $a5 > 0) {
                      echo '<p class="typesOfDisksInCategorySSD">
                        <b>Size</b>
                      </p><br>';
                        if ($a3 < 0) {
                          echo '<label class="containerRadioButton">A3 ('. $a3. ')
                            <input type="radio" name="sizeSubmit" id="A3" value="A3" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                          </label>&nbsp;&nbsp;&nbsp;';
                        } else {
                          echo '<label class="containerRadioButton"><font color="#b3b3b3">A3 (0)</font>
                            <input type="radio" name="sizeSubmit" id="A3" value="A3" disabled> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                          </label>&nbsp;&nbsp;&nbsp;';
                        }
                        if ($a4 > 0) {
                          echo '<label class="containerRadioButton">A4 ('. $a4. ')
                            <input type="radio" name="sizeSubmit" id="A4" value="A4" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                          </label>&nbsp;&nbsp;&nbsp;';
                        } else {
                          echo '<label class="containerRadioButton"><font color="#b3b3b3">A4 (0)</font>
                            <input type="radio" name="sizeSubmit" id="A4" value="A4" disabled> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                          </label>&nbsp;&nbsp;&nbsp;';
                        }
                        if ($a5 > 0) {
                          echo '<label class="containerRadioButton">A5,A6 ('. $a5. ')
                            <input type="radio" name="sizeSubmit" id="A5" value="A5" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                          </label>&nbsp;&nbsp;&nbsp;';
                        } else {
                          echo '<label class="containerRadioButton"><font color="#b3b3b3">A5,A6 (0)</font>
                            <input type="radio" name="sizeSubmit" id="A5" value="A5" disabled> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                          </label>&nbsp;&nbsp;&nbsp;';
                        }
                      if ($usb > 0 or $wifi > 0 or $ethernet > 0 or $bit16 > 0 or $bit24 > 0 or $bit48) {
                        echo '<br><hr class="hrModalBox"><br>';
                      }
                    }
                    //SIZE --- END
                    //CONNECTIVITY --- START
                    if ($usb > 0 or $wifi > 0 or $ethernet > 0) {
                      echo '<p class="typesOfDisksInCategorySSD">
                        <b>Connectivity</b>
                      </p><br>';
                        if ($usb > 0) {
                          echo '<label class="containerCheckBox">USB ('. $usb.')
                            <input type="checkbox" class="CheckBox" id="USB" name="usbConn" value="USB" onclick="footerModal();submitForFilters()">
                            <span class="checkmarkCheckBox"></span>
                          </label>';
                        } else {
                          echo '<label class="containerCheckBox"><font color="#b3b3b3">USB (0)</font>
                            <input type="checkbox" class="CheckBox" id="USB" name="usbConn" value="USB" disabled>
                            <span class="checkmarkCheckBox"></span>
                          </label>';
                        }
                        if ($wifi > 0) {
                          echo '<label class="containerCheckBox">WiFi ('. $wifi.')
                            <input type="checkbox" class="CheckBox" id="WiFi" name="wifiConn" value="WiFi" onclick="footerModal();submitForFilters()">
                            <span class="checkmarkCheckBox"></span>
                          </label>';
                        } else {
                          echo '<label class="containerCheckBox"><font color="#b3b3b3">WiFi (0)</font>
                            <input type="checkbox" class="CheckBox" id="WiFi" name="wifiConn" value="WiFi" disabled>
                            <span class="checkmarkCheckBox"></span>
                          </label>';
                        }
                        if ($ethernet > 0) {
                          echo '<label class="containerCheckBox">Ethernet ('. $ethernet.')
                            <input type="checkbox" class="CheckBox" id="Ethernet" name="lanConn" value="Ethernet" onclick="footerModal();submitForFilters()">
                            <span class="checkmarkCheckBox"></span>
                          </label>';
                        } else {
                          echo '<label class="containerCheckBox"><font color="#b3b3b3">Ethernet (0)</font>
                            <input type="checkbox" class="CheckBox" id="Ethernet" name="lanConn" value="Ethernet" disabled>
                            <span class="checkmarkCheckBox"></span>
                          </label>';
                        }
                      if ($bit16 > 0 or $bit24 > 0 or $bit48) {
                        echo '<br><hr class="hrModalBox"><br>';
                      }
                    }
                    //CONNECTIVITY --- END
                    //COLOUR DEPTH --- START
                    if ($bit16 > 0 or $bit24 > 0 or $bit48 > 0) {
                      echo '<p class="typesOfDisksInCategorySSD">
                        <b>Colour depth</b>
                      </p><br>';
                        if ($bit48 > 0) {
                          echo '<label class="containerRadioButton">48 bit ('. $bit48. ')
                            <input type="radio" name="colourSubmit" id="bit48" value="48 bit" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                          </label>&nbsp;&nbsp;&nbsp;';
                        } else {
                          echo '<label class="containerRadioButton"><font color="#b3b3b3">48 bit (0)</font>
                            <input type="radio" name="colourSubmit" id="bit48" value="48 bit" disabled> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                          </label>&nbsp;&nbsp;&nbsp;';
                        }
                        if ($bit24 > 0) {
                          echo '<label class="containerRadioButton">24 bit ('. $bit24. ')
                            <input type="radio" name="colourSubmit" id="bit24" value="24 bit" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                          </label>&nbsp;&nbsp;&nbsp;';
                        } else {
                          echo '<label class="containerRadioButton"><font color="#b3b3b3">24 bit (0)</font>
                            <input type="radio" name="colourSubmit" id="bit24" value="24 bit" disabled> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                          </label>&nbsp;&nbsp;&nbsp;';
                        }
                        if ($bit16 > 0) {
                          echo '<label class="containerRadioButton">16 bit ('. $bit16. ')
                            <input type="radio" name="colourSubmit" id="bit16" value="16 bit" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                          </label>&nbsp;&nbsp;&nbsp;';
                        } else {
                          echo '<label class="containerRadioButton"><font color="#b3b3b3">16 bit (0)</font>
                            <input type="radio" name="colourSubmit" id="bit16" value="16 bit" disabled> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                          </label>&nbsp;&nbsp;&nbsp;';
                        }
                    }
              ...
              <!--SCRIPT FOR CLEAR FILTERS-->
                <script>
                  function clearFiltersFunction() {';
                    ...
                    //CONNECTIVITY --- START
                    if (isset($_POST["usbConn"])) {
                      $key_javascript = $_POST["usbConn"];
                      echo 'document.getElementById("'. $key_javascript. '").checked = false;';
                    }
                    if (isset($_POST["wifiConn"])) {
                      $key_javascript = $_POST["wifiConn"];
                      echo 'document.getElementById("'. $key_javascript. '").checked = false;';
                    }
                    if (isset($_POST["lanConn"])) {
                      $key_javascript = $_POST["lanConn"];
                      echo 'document.getElementById("'. $key_javascript. '").checked = false;';
                    }
                    //CONNECTIVITY --- END
                    //COLOUR DEPTH --- START
                    if (isset($_POST["colourSubmit"])) {
                      ...
                      foreach($something_explode as $something_explode) {
                        if ($key_j == "") {
                          $key_j = $something_explode;
                        }
                      }
                      $key_javascript = "bit$key_j";
                      echo 'document.getElementById("'. $key_javascript. '").checked = false;';
                    }
                    //COLOUR DEPTH --- END
                  echo '}
        ...
        if(isset($_POST["searchBar"])) {
          ...
          if ($searcher == 1) {
            if ($notSearch == 0) {
              ...
              $sql = "SELECT * FROM Scanners WHERE Description LIKE '%$search_expression%'";
              $result = $conn->query($sql);
              if ($result->num_rows <= 0) {
                $sql = "SELECT * FROM Scanners WHERE Description LIKE '%$search_post%'";
                $result = $conn->query($sql);
                if ($result->num_rows <=0 ) {
                  $sql = "SELECT * FROM Scanners WHERE $keywords";
                  $result = $conn->query($sql);
            ...
            if ($result->num_rows > 0) {
              ...
              while($row=$result->fetch_assoc()) {
                ...
                echo '<form action="../../../Pages/PCBuilderPCBuild" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">';
                    ...
                    echo '<input type="hidden" id="SCANPiece" name="SCANPiece" value="Scanner">';
                ...
                echo '<input type="hidden" id="brandModelSCAN" name="brandModelSCAN" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                echo '<b><font size="2px">Product Code: '. $row["ProductCode"]. '</font></b>';  
                echo '<input type="hidden" id="ProductCodeSCAN" name="ProductCodeSCAN" value="'. $row["ProductCode"]. '">';
                echo '<br><br><br><br><br>';
                echo '<button type="button" class="productCard-Button"></font></button>
                  <div class="specs">';
                    ...
                    echo '<center><font color="black"><table class="tableSpecs">
                      <tr class="tableSpecs">
                        <th class="rowsOnSpecs">General</th>
                      </tr>
                      ...
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Interface</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                      ...
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Optical resolution</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["see_resolution"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Maximum resolution</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["max_resolution"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                      ...
                      <tr class="rowsOnSpecsTR">
                        ...
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["duplex_scan"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                  ...
                  echo '</div>';
                echo '</div>';
                echo '<input type="hidden" id="categorySCAN" name="categorySCAN" value="'. $row["type"].  '">';
                //INFO OF PRODUCTS-END
                //PRICE OF PRODUCTS
                echo '<div class="productCardpreview">';
                if ($ekptwshPrice == $PriceMod) {
                  echo '<h2 align="right">'. $row["Price"]. '€</h2>';
                  echo '<input type="hidden" id="PriceSCAN" name="PriceSCAN" value="'. $row["Price"]. '">';
                  echo '<input type="hidden" id="EkptwshSCAN" name="EkptwshSCAN" value="">';
                  ...
                  echo '<input type="hidden" id="PriceSCAN" name="PriceSCAN" value="'. $row["PriceEkptwsh"]. '">';
                  echo '<input type="hidden" id="EkptwshSCAN" name="EkptwshSCAN" value="'. $row["Price"]. '">';
                }
                if ($brINbutton = 0) {
                ...
                echo '<form action="../../../Pages/PCBuilderPCBuild" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">';
                  ...
                  echo '<input type="hidden" id="pieceSCAN" name="SCANPiece" value="Scanner">';
                  ...
                  echo '<input type="hidden" id="brandModelSCAN" name="brandModelSCAN" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                  echo '<input type="hidden" id="ProductCodeSCAN" name="ProductCodeSCAN" value="'. $row["ProductCode"]. '">';
                  echo '<input type="hidden" id="categorySCAN" name="categorySCAN" value="'. $row["type"].  '"><br><br>';
                  if ($ekptwshPrice == $PriceMod) {
                  ...
                  echo '<br><center><button type="button" class="collapsibleMin">Specs</button>';
                    echo '<div class="contentMin">';
                      echo '<table class="tableSpecsMin">
                        ...
                        <tr>
                          <th class="KEFALIDAmin">General</th>
                        </tr>
                        <!--ONE SPEC-->
                          <tr>
                        ...
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Interface</td>
                          </tr>
                          <tr>
                        ...
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Optical resolution</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["see_resolution"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Maximum resolution</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["max_resolution"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                        ...
                        <!--ONE SPEC-->
                          ...
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["duplex_scan"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
        ...
        if ($clearStep == 0 and (isset($_POST["typeSubmit"]) or isset($_POST["sizeSubmit"]) or isset($_POST["usbConn"]) or isset($_POST["wifiConn"]) or isset($_POST["lanConn"]) or isset($_POST["colourSubmit"])) and $searcher == 0) {          
          $keywords = "";
          $key = "";
          $key_javascript = "";
          $key_j = "";
