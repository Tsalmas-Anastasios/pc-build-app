...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-Ready PC Build-Category:<?php echo $_POST["categoryCPU"]; ?>/Fan select</TITLE>
...
if ($_POST["brandModelCPU"] != "") {
    ...
    if ($conn->connect_error) {
        ...
        echo '<form method="post"><div class="modal" id="modal1">
          <div class="modal-dialog" style="width: 700px;">
            ...
            <section class="modal-content">
                ...
                $sql = "SELECT * FROM Fans_PCCase WHERE Category='70mm'";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        $d70++;
                ...
                $sql = "SELECT * FROM Fans_PCCase WHERE Category='80mm'";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        $d80++;
                ...
                $sql = "SELECT * FROM Fans_PCCase WHERE Category='92mm'";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        $d92++;
                ...
                $sql = "SELECT * FROM Fans_PCCase WHERE Category='120mm'";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        $d120++;
                ...
                $sql = "SELECT * FROM Fans_PCCase WHERE Category='140mm'";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        $d140++;
                ...
                $sql = "SELECT * FROM Fans_PCCase WHERE Category='180mm'";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        $d180++;
                ...
                $sql = "SELECT * FROM Fans_PCCase WHERE Category='200mm'";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        $d200++;
                ...
                $sql = "SELECT * FROM Fans_PCCase WHERE Category='230mm'";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        $d230++;
                ...
                if ($fan > 0) {
                    if ($d70 > 0 or $d80 > 0 or $d92 > 0 or $d120 > 0 or $d140 > 0 or $d180 > 0 or $d200 > 0 or $d230 > 0) {
                    ...
                    if ($d70 > 0) {
                        echo '<label class="containerRadioButton">70mm ('. $d70. ')
                            <input type="radio" name="fanDimension" id="mm70" value="70" onclick="enabledButtons()"> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                        </label>';
                    }
                    if ($d80 > 0) {
                        echo '<label class="containerRadioButton">80mm ('. $d80. ')
                            <input type="radio" name="fanDimension" id="mm80" value="80" onclick="enabledButtons()"> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                        </label>';
                    }
                    if ($d92 > 0) {
                        echo '<label class="containerRadioButton">92mm ('. $d92. ')
                            <input type="radio" name="fanDimension" id="mm92" value="92" onclick="enabledButtons()"> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                        </label>';
                    }
                    if ($d120 > 0) {
                        echo '<label class="containerRadioButton">120mm ('. $d120. ')
                            <input type="radio" name="fanDimension" id="mm120" value="120" onclick="enabledButtons()"> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                        </label>';
                    }
                    if ($d140 > 0) {
                        echo '<label class="containerRadioButton">140mm ('. $d140. ')
                            <input type="radio" name="fanDimension" id="mm140" value="140" onclick="enabledButtons()"> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                        </label>';
                    }
                    if ($d180 > 0) {
                        echo '<label class="containerRadioButton">180mm ('. $d180. ')
                            <input type="radio" name="fanDimension" id="mm180" value="180" onclick="enabledButtons()"> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                        </label>';
                    }
                    if ($d200 > 0) {
                        echo '<label class="containerRadioButton">200mm ('. $d200. ')
                            <input type="radio" name="fanDimension" id="mm200" value="200" onclick="enabledButtons()"> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                        </label>';
                    }
                    if ($d230 > 0) {
                        echo '<label class="containerRadioButton">230mm ('. $d230. ')
                            <input type="radio" name="fanDimension" id="mm230" value="230" onclick="enabledButtons()"> <!--checked="checked"-->
                            <span class="checkmarkRadioButton"></span>
                        </label>';
                    }
                } else {
                    echo '<font color="#b32400"><font size="5">We do not have CPU Coolers right now, Please visit us after more hours!</font></font>';
                }
        ...
        if(isset($_POST["searchBar"])) {
          ...
          if ($searcher == 1) {
            if ($notSearch == 0) {
              ...
              $sql = "SELECT * FROM Fans_PCCase WHERE Description LIKE '%$search_expression%'";
              $result = $conn->query($sql);
              if ($result->num_rows <= 0) {
                $sql = "SELECT * FROM Fans_PCCase WHERE Description LIKE '%$search_post%'";
                $result = $conn->query($sql);
                if ($result->num_rows <=0 ) {
                  $sql = "SELECT * FROM Fans_PCCase WHERE $keywords";
                  $result = $conn->query($sql);
                  if ($result->num_rows <= 0) {
            ...
            if ($result->num_rows > 0) {
              ...
              while($row=$result->fetch_assoc()) {
                ...
                echo '<form action="../../../Pages/PCBuilderPCBuild" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">';
                    ...
                    echo '<input type="hidden" id="FANPiece" name="FANPiece" value="Fans for case">';
                ...
                echo '<input type="hidden" id="brandModelFAN" name="brandModelFAN" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                echo '<b><font size="2px">Product Code: '. $row["ProductCode"]. '</font></b>';  
                echo '<input type="hidden" id="ProductCodeFAN" name="ProductCodeFAN" value="'. $row["ProductCode"]. '">';
                  ...
                  <div class="specs">';
                    if ($row["Picture"] != NULL) {
                                echo '<div class="columnPictureSpecs">
                                    <img src="'. $row["Picture"]. '" alt="Software-Picture" style="width: 100%"></div>';
                            }
                    echo '<center><font color="black"><table class="tableSpecs">
                        ...
                        <tr class="rowsOnSpecsTR">
                            <td class="rowsOnSpecs">Dimension</td>
                            <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            <td class="rowsOnSpecs">'. $row["dimension"]. '</td>
                        </tr>
                        <tr class="tableSpecs">
                            <th class="rowsOnSpecs">Specifications</th>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                            <td class="rowsOnSpecs">Fun turns (Max)</td>
                            <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            <td class="rowsOnSpecs">'. $row["rounds"]. '</td>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                            <td class="rowsOnSpecs">Noise Levels (Max)</td>
                            <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            <td class="rowsOnSpecs">'. $row["sound"]. '</td>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                            <td class="rowsOnSpecs">Air Flow</td>
                            <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            <td class="rowsOnSpecs">'. $row["airFlow"]. '</td>
                        </tr>
                        <tr class="rowsOnSpecsTR">
                        ...
                        <tr class="rowsOnSpecsTR">
                            <td class="rowsOnSpecs">Led Color</td>
                            <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            <td class="rowsOnSpecs">'. $row["ledColor"]. '</td>
                        </tr>
                    </table></font></center>';
                  echo '</div>';
                echo '</div>';
                echo '<input type="hidden" id="categoryFAN" name="categoryFAN" value="---">';
                //INFO OF PRODUCTS-END
                //PRICE OF PRODUCTS
                echo '<div class="productCardpreview">';
                if ($ekptwshPrice == $PriceMod) {
                  echo '<h2 align="right">'. $row["Price"]. '€</h2>';
                  echo '<input type="hidden" id="PriceFAN" name="PriceFAN" value="'. $row["Price"]. '">';
                  echo '<input type="hidden" id="EkptwshFAN" name="EkptwshFAN" value="">';
                  ...
                  echo '<input type="hidden" id="PriceFAN" name="PriceFAN" value="'. $row["PriceEkptwsh"]. '">';
                  echo '<input type="hidden" id="EkptwshFAN" name="EkptwshFAN" value="'. $row["Price"]. '">';
                }
                if ($brINbutton = 0) {
                ...
                echo '<form action="../../../Pages/PCBuilderPCBuild" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">';
                  ...
                  echo '<input type="hidden" id="pieceFAN" name="FANPiece" value="Fans for case">';
                  echo '<img src="'. $row["Picture"]. '" alt="CPU Picture" class="cardImgMin"><br><br>';
                  echo '<div class="brandNameCard">'. $row["Brand"]. ' '. $row["Model"]. '</div>';
                  echo '<div class="productCodeCard">Product Code: '. $row["ProductCode"]. '</div>';
                  echo '<input type="hidden" id="brandModelFAN" name="brandModelFAN" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                  echo '<input type="hidden" id="ProductCodeFAN" name="ProductCodeFAN" value="'. $row["ProductCode"]. '">';
                  echo '<input type="hidden" id="categoryFAN" name="categoryFAN" value="---"><font color="#ccc">'. $caseType. '</font><br>';
                  if ($ekptwshPrice == $PriceMod) {
                  ...
                  echo '<br><center><button type="button" class="collapsibleMin">Specs</button>';
                    echo '<div class="contentMin">';
                        echo '<table class="tableSpecsMin">
                            ...
                            <!--ONE SPEC-->
                                <tr>
                                <td class="NameOfSpecsMin">Dimension</td>
                                </tr>
                                <tr>
                                <td class="FromDatabaseSpecsMin">'. $row["dimension"]. '</td>
                                </tr>
                            <!--ONE SPEC-->
                            <!--ONE CATEGORY OF SPECS-->
                            <!--ONE CATEGORY OF SPECS-->
                            <tr>
                                <th class="KEFALIDAmin">Specifications</th>
                            </tr>
                            <!--ONE SPEC-->
                                <tr>
                                <td class="NameOfSpecsMin">Fan turns</td>
                                </tr>
                                <tr>
                                <td class="FromDatabaseSpecsMin">'. $row["rounds"]. '</td>
                                </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                                <tr>
                                <td class="NameOfSpecsMin">Noise Levels</td>
                                </tr>
                                <tr>
                                <td class="FromDatabaseSpecsMin">'. $row["sound"]. '</td>
                                </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                                <tr>
                                <td class="NameOfSpecsMin">Air Flow</td>
                                </tr>
                                <tr>
                                <td class="FromDatabaseSpecsMin">'. $row["airFlow"]. '</td>
                                </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                                <tr>
                            ...
                            <!--ONE SPEC-->
                                <tr>
                                <td class="NameOfSpecsMin">Led Color</td>
                                </tr>
                                <tr>
                                <td class="FromDatabaseSpecsMin">'. $row["ledColor"]. '</td>
                                </tr>
                            <!--ONE SPEC-->
                            <!--ONE CATEGORY OF SPECS-->
                        </table>';
        ...
        //------------------SEARCH ENGINE-----------------END------------------
        if (isset($_POST["submitFilters"]) && isset($_POST["fanDimension"]) && $searcher == 0) {
            $fanDimension = $_POST["fanDimension"];
            if ($fanDimension == "70") {
                $fanDimension = "70mm";
                echo '<script>
                document.getElementById("mm70").checked = true;
                document.getElementById("buttonsForFilters").style.display = "block";
                </script>';
            } elseif ($fanDimension == "80") {
                $fanDimension = "80mm";
                echo '<script>
                document.getElementById("mm80").checked = true;
                document.getElementById("buttonsForFilters").style.display = "block";
                </script>';
            } elseif ($fanDimension == "92") {
                $fanDimension = "92mm";
                echo '<script>
                document.getElementById("mm92").checked = true;
                document.getElementById("buttonsForFilters").style.display = "block";
                </script>';
            } elseif ($fanDimension == "120") {
                $fanDimension = "120mm";
                echo '<script>
                document.getElementById("mm120").checked = true;
                document.getElementById("buttonsForFilters").style.display = "block";
                </script>';
            } elseif ($fanDimension == "140") {
                $fanDimension = "140mm";
                echo '<script>
                document.getElementById("mm140").checked = true;
                document.getElementById("buttonsForFilters").style.display = "block";
                </script>';
            } elseif ($fanDimension == "180") {
                $fanDimension = "180mm";
                echo '<script>
                document.getElementById("mm180").checked = true;
                document.getElementById("buttonsForFilters").style.display = "block";
                </script>';
            } elseif ($fanDimension == "200") {
                $fanDimension = "200mm";
                echo '<script>
                document.getElementById("mm200").checked = true;
                document.getElementById("buttonsForFilters").style.display = "block";
                </script>';
            } elseif ($fanDimension == "230") {
                $fanDimension = "230mm";
                echo '<script>
                document.getElementById("mm230").checked = true;
                document.getElementById("buttonsForFilters").style.display = "block";
                </script>';
            }

          $sql = "SELECT * FROM Fans_PCCase WHERE Category LIKE '%$fanDimension%'";
          $result = $conn->query($sql);
          if ($result->num_rows > 0) {
            $onoma_for_title = 0;
            $brINbutton = 0;
		...
		<center><div class="no-results-search-message">
          ...
          if ($result->num_rows > 0) {
            ...
            while($row=$result->fetch_assoc()) {
              ...
              echo '<b><font size="2px">Product Code: '. $row["ProductCode"]. '</font></b>';  
              echo '<input type="hidden" id="ProductCodeFAN" name="ProductCodeFAN" value="'. $row["ProductCode"]. '">';
              echo '<br><br><font color="#ccc"><b>'. $row["Category"]. '</b></font><br><br>';
              echo '<button type="button" class="productCard-Button"></font></button>
                <div class="specs">';
                  if ($row["Picture"] != NULL) {
                                echo '<div class="columnPictureSpecs">
              ...
              echo '<form action="../../../Pages/PCBuilderPCBuild" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">';
                ...
                echo '<input type="hidden" id="brandModelFAN" name="brandModelFAN" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                echo '<input type="hidden" id="ProductCodeFAN" name="ProductCodeFAN" value="'. $row["ProductCode"]. '">';
                echo '<input type="hidden" id="categoryFAN" name="categoryFAN" value="---"><font color="#ccc">'. $row["Category"]. '</font><br>';
                if ($ekptwshPrice == $PriceMod) {
                echo '<p class="priceMin">'. $row["Price"]. '€</p>';
                echo '<input type="hidden" id="PriceFAN" name="PriceFAN" value="'. $row["Price"]. '">';
                echo '<input type="hidden" id="EkptwshFAN" name="EkptwshFAN" value="">';
