...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-Ready PC Build-Category:<?php echo $_POST["categoryCPU"]; ?>/Bluetooth Adapter select</TITLE>
...
if ($_POST["brandModelCPU"] != "") {
    ...
    if ($conn->connect_error) {
        ...
        echo '<form method="post" name="formFiltersModal"><div class="modal" id="modal1">
          <div class="modal-dialog" style="width: 700px;">
            ...
            <section class="modal-content">
                ...
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                  //Variables for version --- START
                  $b40 = 0;
                  $b42 = 0;
                  $b50 = 0;
                  //Variables for version --- END
                  while($row = $result->fetch_assoc()) {
                    //VERSION --- START
                    if ($row["bluetooth"] == "Bluetooth 4.0") {
                      $b40++;
                    } elseif ($row["bluetooth"] == "Bluetooth 4.2") {
                      $b42++;
                    } elseif ($row["bluetooth"] == "Bluetooth 5.0") {
                      $b50++;
                    }
                    //VERSION --- END
                  }
                ...
                //CREATE OPTION BOXES --- START
                  ...
                  if ($b40 > 0 or $b42 > 0 or $b50 > 0) {
                    echo '<p class="typesOfDisksInCategorySSD">
                      <b>Bluetooth Version</b>
                    </p><br>';
                      if ($b40 > 0) {
                        echo '<label class="containerRadioButton">Bluetooth 4.0 ('. $b40. ')
                          <input type="radio" name="verSubmit" id="b40" value="Bluetooth 4.0" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      } else {
                        echo '<label class="containerRadioButton"><font color="#b3b3b3">Bluetooth 4.0 (0)</font>
                          <input type="radio" name="verSubmit" id="b40" value="Bluetooth 4.0" disabled> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      }
                      if ($b42 > 0) {
                        echo '<label class="containerRadioButton">Bluetooth 4.2 ('. $b50. ')
                          <input type="radio" name="verSubmit" id="b42" value="Bluetooth 4.2" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      } else {
                        echo '<label class="containerRadioButton"><font color="#b3b3b3">Bluetooth 4.2 (0)</font>
                          <input type="radio" name="verSubmit" id="b42" value="Bluetooth 4.2" disabled> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      }
                      if ($b50 > 0) {
                        echo '<label class="containerRadioButton">Bluetooth 5.0 ('. $b50. ')
                          <input type="radio" name="verSubmit" id="b50" value="Bluetooth 5.0" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      } else {
                        echo '<label class="containerRadioButton"><font color="#b3b3b3">Bluetooth 5.0 (0)</font>
                          <input type="radio" name="verSubmit" id="b50" value="Bluetooth 5.0" disabled> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      }
                  }
                  //BLUETOOTH VERSION -- END
              ...
              <!--SCRIPT FOR CLEAR FILTERS-->
                <script>
                  function clearFiltersFunction() {';
                    $key_javascript = "";
                    if ($_POST["verSubmit"] == "Bluetooth 4.0") {
                      $key_javascript = "b40";
                    } elseif ($_POST["verSubmit"] == "Bluetooth 4.2") {
                      $key_javascript = "b42";
                    } elseif ($_POST["verSubmit"] == "Bluetooth 5.0") {
                      $key_javascript = "b50";
                    }
        ...
        if(isset($_POST["searchBar"])) {
          ...
          if ($searcher == 1) {
            if ($notSearch == 0) {
              ...
              $sql = "SELECT * FROM Bluetooth_Adapters WHERE Description LIKE '%$search_expression%'";
              $result = $conn->query($sql);
              if ($result->num_rows <= 0) {
                $sql = "SELECT * FROM Bluetooth_Adapters WHERE Description LIKE '%$search_post%'";
                $result = $conn->query($sql);
                if ($result->num_rows <=0 ) {
                  $sql = "SELECT * FROM Bluetooth_Adapters WHERE $keywords";
                  $result = $conn->query($sql);
                  if ($result->num_rows <= 0) {
                    $sql = "SELECT * FROM Bluetooth_Adapters";
                    $result = $conn->query($sql);
            ...
            if ($result->num_rows > 0) {
              ...
              while($row=$result->fetch_assoc()) {
                ...
                echo '<form action="../../../Pages/PCBuilderPCBuild" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">';
                    ...
                    echo '<input type="hidden" id="BLUEPiece" name="BLUEPiece" value="Bluetooth Adapter">';
                ...
                echo '<input type="hidden" id="brandModelBLUE" name="brandModelBLUE" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                echo '<b><font size="2px">Product Code: '. $row["ProductCode"]. '</font></b>';  
                echo '<input type="hidden" id="ProductCodeBLUE" name="ProductCodeBLUE" value="'. $row["ProductCode"]. '">';
                echo '<br><br><br><br><br>';
                  ...
                  <div class="specs">';
                    ...
                    echo '<center><font color="black"><table class="tableSpecs">
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Bluetooth version</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["bluetooth"]. '</td>
                      </tr>
                    </table></font></center>';
                  echo '</div>';
                echo '</div>';
                echo '<input type="hidden" id="categoryBLUE" name="categoryBLUE" value="'. $row["bluetooth"].  '">';
                //INFO OF PRODUCTS-END
                //PRICE OF PRODUCTS
                echo '<div class="productCardpreview">';
                if ($ekptwshPrice == $PriceMod) {
                  echo '<h2 align="right">'. $row["Price"]. '€</h2>';
                  echo '<input type="hidden" id="PriceBLUE" name="PriceBLUE" value="'. $row["Price"]. '">';
                  echo '<input type="hidden" id="EkptwshBLUE" name="EkptwshBLUE" value="">';
                  ...
                  echo '<input type="hidden" id="PriceBLUE" name="PriceBLUE" value="'. $row["PriceEkptwsh"]. '">';
                  echo '<input type="hidden" id="EkptwshBLUE" name="EkptwshBLUE" value="'. $row["Price"]. '">';
                }
                if ($brINbutton = 0) {
                ...
                echo '<form action="../../../Pages/PCBuilderPCBuild" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">';
                  ...
                  echo '<input type="hidden" id="pieceBLUE" name="BLUEPiece" value="Bluetooth Adapter">';
                  ...
                  echo '<input type="hidden" id="brandModelBLUE" name="brandModelBLUE" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                  echo '<input type="hidden" id="ProductCodeBLUE" name="ProductCodeBLUE" value="'. $row["ProductCode"]. '">';
                  echo '<input type="hidden" id="categoryBLUE" name="categoryBLUE" value="'. $row["bluetooth"].  '"><br><br>';
                  if ($ekptwshPrice == $PriceMod) {
                  ...
                  echo '<br><center><button type="button" class="collapsibleMin">Specs</button>';
                    echo '<div class="contentMin">';
                      echo '<table class="tableSpecsMin">
                        ...
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Bluetooth version</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["bluetooth"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE CATEGORY OF SPECS-->
                      </table>';
        ...
        if ($clearStep == 0 and isset($_POST["verSubmit"]) and $searcher == 0) {          
          $keywords = "";
          $key = "";
          $key_javascript = "";
          ...
          echo '<script>
            ...
            $sql = "SELECT * FROM Bluetooth_Adapters WHERE bluetooth='$key'";
            $result = $conn->query($sql);
            if ($result->num_rows > 0) {
              $onoma_for_title = 0;
              $brINbutton = 0;
