...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-Ready PC Build-Category:<?php echo $_POST["categoryCPU"]; ?>/Printer select</TITLE>
...
if ($_POST["brandModelCPU"] != "") {
    ...
    if ($conn->connect_error) {
          ...
          <div class="modal-dialog" style="width: 700px;">
            ...
            <section class="modal-content">
                ...
                //DATA FROM DATABASE TABLE AND COUNT VARIABLES --- START
                  $issetStep = 0;
                  if (isset($_POST["multiFeature"])) {
                    $issetStep++;
                  }
                  if (isset($_POST["wifiFeature"])) {
                    $issetStep++;
                  }
                  if (isset($_POST["duplexFeature"])) {
                    $issetStep++;
                  }
                  if (isset($_POST["modileFeature"])) {
                    $issetStep++;
                  }
                  if (isset($_POST["inkFeature"])) {
                    $issetStep++;
                  }
                  if (isset($_POST["lanFeature"])) {
                    $issetStep++;
                  }
                  if (isset($_POST["photoFeature"])) {
                    $issetStep++;
                  }
                  if (isset($_POST["faxFeature"])) {
                    $issetStep++;
                  }
                  if (isset($_POST["cdFeature"])) {
                    $issetStep++;
                  }
                  if (isset($_POST["cardFeature"])) {
                    $issetStep++;
                  }
                  ...
                  if (isset($_POST["autoScan"])) {
                    $issetStep++;
                  }
                  if (isset($_POST["duplexScan"])) {
                    $issetStep++;
                  }
                  ...
                  if ($issetStep > 0) {
                    $keywords = "";
                    if (isset($_POST["multiFeature"])) {
                      $key = $_POST["multiFeature"];
                      $keywords = " features LIKE '%$key%'";
                    }
                    if (isset($_POST["wifiFeature"])) {
                      $key = $_POST["wifiFeature"];
                      if ($keywords == "") {
                        $keywords = " connectivity LIKE '%$key%'";
                      } else {
                        $keywords .= " AND connectivity LIKE '%$key%'";
                      }
                    }
                    if (isset($_POST["duplexFeature"])) {
                      $key = $_POST["duplexFeature"];
                      if ($keywords == "") {
                        $keywords = " features LIKE '%$key%'";
                      } else {
                        $keywords .= " AND features LIKE '%$key%'";
                      }
                    }
                    if (isset($_POST["modile"])) {
                      $key = $_POST["mobile"];
                      if ($keywords == "") {
                        $keywords = " features LIKE '%$key%'";
                      } else {
                    ...
                    if (isset($_POST["photoFeature"])) {
                      $key = $_POST["photoFeature"];
                      if ($keywords == "") {
                        $keywords = " only_photo='$key'";
                      } else {
                        $keywords .= " AND only_photo='$key'";
                      }
                    }
                    if (isset($_POST["faxFeature"])) {
                      $key = $_POST["faxFeature"];
                      if ($keywords == "") {
                        $keywords = " features LIKE '%$key%'";
                      } else {
                        $keywords .= " AND features LIKE '%$key%'";
                    ...
                    if (isset($_POST["typeSubmit"])) {
                      ...
                      if ($keywords == "") {
                        ...
                        $keywords .= " AND type='$key'";
                      }
                    }
                    if (isset($_POST["colourSubmit"])) {
                      $key = $_POST["colourSubmit"];
                      if ($keywords == "") {
                        $keywords = " print_colour='$key'";
                      } else {
                        $keywords .= " AND print_colour='$key'";
                      }
                    }
                    if (isset($_POST["autoScan"])) {
                      $key = $_POST["autoScan"];
                      if ($keywords == "") {
                        ...
                        $keywords .= " AND ADF='$key'";
                      }
                    }
                    if (isset($_POST["duplexScan"])) {
                      $key = $_POST["duplexScan"];
                      if ($keywords == "") {
                        $keywords = " both_scan='$key'";
                      } else {
                        $keywords .= " AND both_scan='$key'";
                      }
                    }
                    $sql = "SELECT * FROM Printers WHERE$keywords";
                  } else {
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    $multi = 0;               //Multifunction machine
                    $wifi = 0;                //Wi-Fi
                    $duplex_print = 0;        //Duplex printing
                    $mobile = 0;              //Mobile printing compatibility
                    $ink = 0;                 //Seperate coloured inks
                    $lan = 0;                 //Ethernet/LAN
                    $photo = 0;               //Only for photos
                    $fax = 0;                 //Fax
                    $cd = 0;                  //CD/DVD Printing
                    $card = 0;                //Card slot
                    ...
                    //Variables for print colour --- START
                    $multi_color = 0;         //Multi-colour
                    $black_white = 0;         //Black and white
                    //Variables for print colour --- END
                    //Variables for scanner characteristics --- START
                    $adf = 0;                //Automatic feeder (ADF)
                    $duplex_scan = 0;         //Duplex scanning
                    //Variables for scanner characteristics --- END
                    while ($row = $result->fetch_assoc()) {
                      //FEATURES --- START
                      $explode = explode(',', $row["features"]);
                      foreach($explode as $explode) {
                        if ($explode == "Multifunction machine") {
                          $multi++;
                        } elseif ($explode == "Duplex print") {
                          $duplex_print++;
                        } elseif ($explode == "Mobile printing compatibility") {
                          $mobile++;
                        } elseif ($explode == "Separate coloured inks") {
                          $ink++;
                        } elseif ($explode == "Ethernet/LAN") {
                          $lan++;
                        } elseif ($explode == "Only for photos") {
                          $photo++;
                        } elseif ($explode == "Fax") {
                          $fax++;
                        } elseif ($explode == "CD/DVD Printing") {
                          $cd++;
                        } elseif ($explode == "Card Slot") {
                          $card++;
                        }
                      }
                      $explode = explode(',', $row["connectivity"]);
                      foreach($explode as $explode) {
                        if ($explode == "Wi-Fi") {
                          $wifi++;
                        }
                      ...
                      if ($row["type"] == "Laser") {
                        $laser++;
                      } elseif ($row["type"] == "Inkjet") {
                        $inkjet++;
                      } elseif ($row["type"] == "Thermal") {
                        $thermal++;
                      } elseif ($row["type"] == "LED") {
                        $led++;
                      } elseif ($row["type"] == "Zink") {
                        $zink++;
                      }
                      //TYPE --- END
                      //PRINT COLOUR --- START
                      if ($row["print_colour"] == "Multi-colour") {
                        $multi_color++;
                      } elseif ($row["print_colour"] == "Black and White") {
                        $black_white++;
                      }
                      //PRINT COLOUR --- END
                      //SCANNER CHARACTERISTICS --- START
                      if ($row["ADF"] == "Yes") {
                        $adf++;
                      }
                      if ($row["both_scan"] == "Duplex Scanning") {
                        $duplex_scan++;
                      }
                      //SCANNER CHARACTERISTICS --- END
                    }
                  }

                  //IF ONLY ONE INPUT (option box) EXISTS --- START
                    $not_isset = 0;
                    //ALL INPUTS ARE 12
                    if (!isset($_POST["multiFeature"])) {
                      $not_isset++;
                    ...
                    if (isset($_POST["typeSubmit"]) and !isset($_POST["colourSubmit"]) and $not_isset == 12) {
                      //Variables for type --- START
                      $laser = 0;               //Laser
                      $inkjet = 0;              //Inkjet
                      $thermal = 0;             //Thermal
                    ...
                    if (isset($_POST["colourSubmit"]) and !isset($_POST["typeSubmit"]) and $not_isset == 12) {
                      //Variables for print colour --- START
                      $multi_color = 0;         //Multi-colour
                      $black_white = 0;         //Black and white
                      //Variables for print colour --- END
                  ...
                  //IF ONLY ONE INPUT (option box) EXISTS --- END
                  //IF BOTH OF OPTION BOXES EXIST AND CHECKBOXES EXIST --- START
                    $keywords = "";
                    if (isset($_POST["multiFeature"])) {
                      $key = $_POST["multiFeature"];
                      $keywords = " features LIKE '%$key%'";
                    ...
                    if (isset($_POST["typeSubmit"]) and isset($_POST["colourSubmit"])) {
                      //Variables for type --- START
                      $laser = 0;               //Laser
                      $inkjet = 0;              //Inkjet
                      $thermal = 0;             //Thermal
                      ...
                      $key = $_POST["colourSubmit"];
                      if ($keywords == "") {
                        $sql = "SELECT * FROM Printers WHERE print_colour='$key'";
                      } else {
                        $sql = "SELECT * FROM Printers WHERE print_colour='$key' AND$keywords";
                      }
                      $result = $conn->query($sql);
                      if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                  ...
                  //IF BOTH OF OPTION BOXES EXIST AND CHECKBOXES EXIST --- END
                //DATA FROM DATABASE TABLE AND COUNT VARIABLES --- END

                //OPTION AND CHECK BOXES CREATE --- START
                  //FEATURES---START
                  if ($multi > 0 or $wifi > 0 or $duplex_print > 0 or $mobile > 0 or $ink > 0 or $lan > 0 or $photo > 0 or $fax > 0 or $cd > 0 or $card > 0) {
                    echo '<p class="typesOfDisksInCategorySSD">
                      <b>Features</b>
                    </p><br>';
                      if ($multi > 0) {
                        echo '<label class="containerCheckBox">Multifunction machine ('. $multi.')
                          <input type="checkbox" class="CheckBox" id="Multifunctionmachine" name="multiFeature" value="Multifunction machine" onclick="footerModal();submitForFilters()">
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      } else {
                        echo '<label class="containerCheckBox"><font color="#b3b3b3">Multifunction machine (0)</font>
                          <input type="checkbox" class="CheckBox" id="Yes" name="multiFeature" value="Yes" disabled>
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      }
                      if ($wifi > 0) {
                        echo '<label class="containerCheckBox">Wi-Fi ('. $wifi.')
                          <input type="checkbox" class="CheckBox" id="WiFi" name="wifiFeature" value="Wi-Fi" onclick="footerModal();submitForFilters()">
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      } else {
                        echo '<label class="containerCheckBox"><font color="#b3b3b3">Wi-Fi (0)</font>
                          <input type="checkbox" class="CheckBox" id="WiFi" name="wifiFeature" value="Wi-Fi" disabled>
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      }
                      if ($duplex_print > 0) {
                        echo '<label class="containerCheckBox">Duplex print ('. $duplex_print.')
                          <input type="checkbox" class="CheckBox" id="Duplexprint" name="duplexFeature" value="Duplex print" onclick="footerModal();submitForFilters()">
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      } else {
                        echo '<label class="containerCheckBox"><font color="#b3b3b3">Duplex print (0)</font>
                          <input type="checkbox" class="CheckBox" id="Duplexprint" name="duplexFeature" value="Duplex print" disabled>
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      }
                      if ($mobile > 0) {
                        echo '<label class="containerCheckBox">Mobile printing compatibility ('. $mobile.')
                          <input type="checkbox" class="CheckBox" id="Mobileprintingcompatibility" name="mobileFeature" value="Mobile printing compatibility" onclick="footerModal();submitForFilters()">
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      } else {
                        echo '<label class="containerCheckBox"><font color="#b3b3b3">Mobile printing compatibility (0)</font>
                          <input type="checkbox" class="CheckBox" id="Mobileprintingcompatibility" name="mobileFeature" value="Mobile printing compatibility" disabled>
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      }
                      if ($ink > 0) {
                        echo '<label class="containerCheckBox">Separate coloured inks ('. $ink.')
                          <input type="checkbox" class="CheckBox" id="Separatecolouredinks" name="inkFeature" value="Separate coloured inks" onclick="footerModal();submitForFilters()">
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      } else {
                        echo '<label class="containerCheckBox"><font color="#b3b3b3">Separate coloured inks (0)</font>
                          <input type="checkbox" class="CheckBox" id="Separatecolouredinks" name="inkFeature" value="Separate coloured inks" disabled>
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      }
                      if ($lan > 0) {
                        echo '<label class="containerCheckBox">Ethernet/LAN ('. $ink.')
                          <input type="checkbox" class="CheckBox" id="EthernetLAN" name="lanFeature" value="Ethernet/LAN" onclick="footerModal();submitForFilters()">
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      } else {
                        echo '<label class="containerCheckBox"><font color="#b3b3b3">Ethernet/LAN (0)</font>
                          <input type="checkbox" class="CheckBox" id="EthernetLAN" name="lanFeature" value="Ethernet/LAN" disabled>
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      }
                      if ($photo > 0) {
                        echo '<label class="containerCheckBox">Only for photos ('. $photo.')
                          <input type="checkbox" class="CheckBox" id="Yesphoto" name="photoFeature" value="Yes" onclick="footerModal();submitForFilters()">
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      } else {
                        echo '<label class="containerCheckBox"><font color="#b3b3b3">Only for photos (0)</font>
                          <input type="checkbox" class="CheckBox" id="Yesphoto" name="photoFeature" value="Yes" disabled>
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      }
                      if ($fax > 0) {
                        echo '<label class="containerCheckBox">Fax ('. $fax.')
                          <input type="checkbox" class="CheckBox" id="Fax" name="faxFeature" value="Fax" onclick="footerModal();submitForFilters()">
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      } else {
                        echo '<label class="containerCheckBox"><font color="#b3b3b3">Fax (0)</font>
                          <input type="checkbox" class="CheckBox" id="Fax" name="faxFeature" value="Fax" disabled>
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      }
                      if ($cd > 0) {
                        echo '<label class="containerCheckBox">CD/DVD Printing ('. $cd.')
                          <input type="checkbox" class="CheckBox" id="CD" name="cdFeature" value="CD/DVD Printing" onclick="footerModal();submitForFilters()">
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      } else {
                        echo '<label class="containerCheckBox"><font color="#b3b3b3">CD/DVD Printing (0)</font>
                          <input type="checkbox" class="CheckBox" id="CD" name="cdFeature" value="CD/DVD Printing" disabled>
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      }
                      if ($card > 0) {
                        echo '<label class="containerCheckBox">Card Slot ('. $card.')
                          <input type="checkbox" class="CheckBox" id="CardSlot" name="cardFeature" value="Card Slot" onclick="footerModal();submitForFilters()">
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      } else {
                        echo '<label class="containerCheckBox"><font color="#b3b3b3">Card Slot (0)</font>
                          <input type="checkbox" class="CheckBox" id="CardSlot" name="cardFeature" value="Card Slot" disabled>
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      }
                    if ($laser > 0 or $inkjet > 0 or $thermal > 0 or $led > 0 or $zink > 0 or $multi_color > 0 or $black_white > 0 or $adf > 0 or $duplex_scan > 0) {
                      echo '<br><hr class="hrModalBox"><br>';
                    }
                  }
                  //FEATURES---END
                  //TYPE---START
                  if ($laser > 0 or $inkjet > 0 or $thermal > 0 or $led > 0 or $zink > 0) {
                    echo '<p class="typesOfDisksInCategorySSD">
                      <b>Type</b>
                    </p><br>';
                      if ($laser > 0) {
                      ...
                      if ($inkjet > 0) {
                        echo '<label class="containerRadioButton">Inkjet ('. $inkjet. ')
                          <input type="radio" name="typeSubmit" id="Inkjet" value="Inkjet" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      } else {
                        echo '<label class="containerRadioButton"><font color="#b3b3b3">Inkjet (0)</font>
                          <input type="radio" name="typeSubmit" id="Inkjet" value="Inkjet" disabled> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      }
                      if ($thermal > 0) {
                        echo '<label class="containerRadioButton">Thermal ('. $thermal. ')
                          <input type="radio" name="typeSubmit" id="Thermal" value="Thermal" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      } else {
                        echo '<label class="containerRadioButton"><font color="#b3b3b3">Thermal (0)</font>
                          <input type="radio" name="typeSubmit" id="Thermal" value="Thermal" disabled> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      }
                      if ($led > 0) {
                        echo '<label class="containerRadioButton">LED ('. $led. ')
                          <input type="radio" name="typeSubmit" id="LED" value="LED" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      } else {
                        echo '<label class="containerRadioButton"><font color="#b3b3b3">LED (0)</font>
                          <input type="radio" name="typeSubmit" id="LED" value="LED" disabled> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      }
                      if ($zink > 0) {
                        echo '<label class="containerRadioButton">Zink ('. $zink. ')
                          <input type="radio" name="typeSubmit" id="Zink" value="Zink" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      } else {
                        echo '<label class="containerRadioButton"><font color="#b3b3b3">Zink (0)</font>
                          <input type="radio" name="typeSubmit" id="Zink" value="Zink" disabled> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      }
                    if ($multi_color > 0 or $black_white > 0 or $adf > 0 or $duplex_scan > 0) {
                      echo '<br><hr class="hrModalBox"><br>';
                    }
                  }
                  //TYPE---END
                  //PRINT COLOUR---START
                  if ($multi_color > 0 or $black_white > 0) {
                    echo '<p class="typesOfDisksInCategorySSD">
                      <b>Print Colour</b>
                    </p><br>';
                      if ($multi_color > 0) {
                        echo '<label class="containerRadioButton">Multi-colour ('. $multi_color. ')
                          <input type="radio" name="colourSubmit" id="Multicolour" value="Multi-colour" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      } else {
                        echo '<label class="containerRadioButton"><font color="#b3b3b3">Multi-colour (0)</font>
                          <input type="radio" name="colourSubmit" id="Multicolour" value="Multi-colour" disabled> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      }
                      if ($black_white > 0) {
                        echo '<label class="containerRadioButton">Black and White ('. $zink. ')
                          <input type="radio" name="colourSubmit" id="BlackandWhite" value="Black and White" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      } else {
                        echo '<label class="containerRadioButton"><font color="#b3b3b3">Black and White (0)</font>
                          <input type="radio" name="colourSubmit" id="BlackandWhite" value="Black and White" disabled> <!--checked="checked"-->
                          <span class="checkmarkRadioButton"></span>
                        </label>&nbsp;&nbsp;&nbsp;';
                      }
                    if ($adf > 0 or $duplex_scan > 0) {
                      echo '<br><hr class="hrModalBox"><br>';
                    }
                  }
                  //PRINT COLOUR---END
                  ...
                  if ($adf > 0 or $duplex_scan > 0) {
                    echo '<p class="typesOfDisksInCategorySSD">
                      ...
                      if ($adf > 0) {
                        echo '<label class="containerCheckBox">Automatic feeder ('. $adf.')
                          <input type="checkbox" class="CheckBox" id="Automaticfeeder" name="autoScan" value="Automatic feeder" onclick="footerModal();submitForFilters()">
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      } else {
                        echo '<label class="containerCheckBox"><font color="#b3b3b3">Automatic feeder (0)</font>
                          <input type="checkbox" class="CheckBox" id="Automaticfeeder" name="autoScan" value="Automatic feeder" disabled>
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      }
                      if ($duplex_scan > 0) {
                        echo '<label class="containerCheckBox">Duplex scanning ('. $duplex_scan.')
                          <input type="checkbox" class="CheckBox" id="Duplexscanning" name="duplexScan" value="Duplex scanning" onclick="footerModal();submitForFilters()">
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      } else {
                        echo '<label class="containerCheckBox"><font color="#b3b3b3">Duplex scanning (0)</font>
                          <input type="checkbox" class="CheckBox" id="Duplexscanning" name="duplexScan" value="Duplex scanning" disabled>
                          <span class="checkmarkCheckBox"></span>
                        </label>';
                      }
                  }
                  //SCANNER CHARACTERISTICS---END
                //OPTION AND CHECK BOXES CREATE --- END
                //FILTERS----------------------------------------------------------------------------------------------
              ...
              <!--SCRIPT FOR CLEAR FILTERS-->
                <script>
                  function clearFiltersFunction() {';
                    ...
                    //FEATURES---START
                    if (isset($_POST["multiFeature"])) {
                      $something_explode = explode(' ', $_POST["multiFeature"]);
                    ...
                    $key_javascript = "";
                    if (isset($_POST["wifiFeature"])) {
                      $something_explode = explode('-', $_POST["wifiFeature"]);
                      foreach($something_explode as $something_explode) {
                        $key_javascript .= $something_explode;
                      }
                      echo 'document.getElementById("'. $key_javascript. '").checked = false;';
                    ...
                    $key_javascript = "";
                    if (isset($_POST["duplexPrint"])) {
                      $something_explode = explode(' ', $_POST["duplexPrint"]);
                      foreach ($something_explode as $something_explode) {
                        $key_javascript .= $something_explode;
                      }
                      echo 'document.getElementById("'. $key_javascript. '").checked = false;';
                    ...
                    $key_javascript = "";
                    if (isset($_POST["mobileFeature"])) {
                      $something_explode = explode(' ', $_POST["mobileFeature"]);
                      foreach($something_explode as $something_explode) {
                        $key_javascript .= $something_explode;
                      }
                      echo 'document.getElementById("'. $key_javascript. '").checked = false;';
                    ...
                    $key_javascript = "";
                    if (isset($_POST["inkFeature"])) {
                      $something_explode = explode(' ', $_POST["inkFeature"]);
                      foreach($something_explode as $something_explode) {
                        $key_javascript .= $something_explode;
                      }
                      echo 'document.getElementById("'. $key_javascript. '").checked = false;';
                    ...
                    $key_javascript = "";
                    if (isset($_POST["lanFeature"])) {
                      $something_explode = explode('/', $_POST["lanFeature"]);
                      foreach($something_explode as $something_explode) {
                        $key_javascript .= $something_explode;
                      }
                      echo 'document.getElementById("'. $key_javascript. '").checked = false;';
                    ...
                    $key_javascript = "";
                    if (isset($_POST["photoFeature"])) {
                      $something_explode = explode(' ', $_POST["photoFeature"]);
                      foreach($something_explode as $something_explode) {
                        $key_javascript .= $something_explode;
                      }
                      echo 'document.getElementById("'. $key_javascript. '").checked = false;';
                    ...
                    $key_javascript = "";
                    if (isset($_POST["faxFeature"])) {
                      $something_explode = explode(' ', $_POST["faxFeature"]);
                      foreach($something_explode as $something_explode) {
                        $key_javascript .= $something_explode;
                      }
                      echo 'document.getElementById("'. $key_javascript. '").checked = false;';
                    ...
                    $key_javascript = "";
                    if (isset($_POST["cdFeature"])) {
                      $something_explode = explode(' ', $_POST["cdFeature"]);
                      foreach($something_explode as $something_explode) {
                        $key_javascript .= $something_explode;
                      }
                      echo 'document.getElementById("'. $key_javascript. '").checked = false;';
                    ...
                    $key_javascript = "";
                    if (isset($_POST["cardFeature"])) {
                      $something_explode = explode(' ', $_POST["cardFeature"]);
                      foreach($something_explode as $something_explode) {
                        $key_javascript .= $something_explode;
                      }
                      echo 'document.getElementById("'. $key_javascript. '").checked = false;';
                    ...
                    $key_javascript = "";
                    if (isset($_POST["colourSubmit"])) {
                      if ($_POST["colourSubmit"] == "Multi-colour") {
                        $key_javascript = "Multicolour";
                      } elseif ($_POST["colourSubmit"] == "Black and White") {
                        $key_javascript = "BlackandWhite";
                      }
                      echo 'document.getElementById("'. $key_javascript. '").checked = false;';
                    }
                    //PRINT COLOUR---END
                    ...
                    $key_javascript = "";
                    if (isset($_POST["autoScan"])) {
                      $something_explode = explode(' ', $_POST["autoScan"]);
                      foreach($something_explode as $something_explode) {
                        $key_javascript .= $something_explode;
                      }
                      echo 'document.getElementById("'. $key_javascript. '").checked = false;';
                    ...
                    $key_javascript = "";
                    if (isset($_POST["duplexScan"])) {
                      $something_explode = explode(' ', $_POST["duplexScan"]);
                      foreach($something_explode as $something_explode) {
                        $key_javascript .= $something_explode;
                      }
                      echo 'document.getElementById("'. $key_javascript. '").checked = false;';
        ...
        if(isset($_POST["searchBar"])) {
          ...
          if ($searcher == 1) {
            if ($notSearch == 0) {
              ...
              $sql = "SELECT * FROM Printers WHERE Description LIKE '%$search_expression%'";
              $result = $conn->query($sql);
              if ($result->num_rows <= 0) {
                $sql = "SELECT * FROM Printers WHERE Description LIKE '%$search_post%'";
                $result = $conn->query($sql);
                if ($result->num_rows <=0 ) {
                  $sql = "SELECT * FROM Printers WHERE $keywords";
                  $result = $conn->query($sql);
            ...
            if ($result->num_rows > 0) {
              ...
              while($row=$result->fetch_assoc()) {
                ...
                echo '<form action="../../../Pages/PCBuilderPCBuild" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">';
                    ...
                    echo '<input type="hidden" id="PRINTPiece" name="PRINTPiece" value="Printer">';
                ...
                echo '<input type="hidden" id="brandModelPRINT" name="brandModelPRINT" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                echo '<b><font size="2px">Product Code: '. $row["ProductCode"]. '</font></b>';  
                echo '<input type="hidden" id="ProductCodePRINT" name="ProductCodePRINT" value="'. $row["ProductCode"]. '">';
                echo '<br><br><br><br><br>';
                echo '<button type="button" class="productCard-Button"></font></button>
                  <div class="specs">';
                    ...
                    echo '<center><font color="black"><table class="tableSpecs">
                      <tr class="tableSpecs">
                        <th class="rowsOnSpecs">Technical characteristics</th>
                      </tr>
                      ...
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Print colour</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["print_colour"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Only for phots</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["only_photo"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Multifunction machine</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["multi_machine"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Consumable</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["analwsimo"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Consumable number</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["analwsimo_number"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Printer memory</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["printer_memory"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Paper size</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["paper_size"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Compatibility</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["compatibility"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                      ...
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Connectivity</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["connectivity"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                      ...
                      <tr class="tableSpecs">
                        <th class="rowsOnSpecs">Printer</th>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Monochrome print speed</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["speed_white_print"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Colourful print speed</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["speed_colour_print"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Duplex print</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["duplex_print"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Maximum print resolution</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["max_dpi_print"]. '</td>
                      </tr>
                      <tr class="tableSpecs">
                        <th class="rowsOnSpecs">Scanner</th>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Monochrome scanning speed</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["speed_white_scan"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Colourful scanning speed</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["speed_colour_scan"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Maximum scanning resolution</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["max_dpi_scan"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Colour depth</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["colour_depth"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">ADF</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["ADF"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Duplex scanning</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["both_scan"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">ADF Paper quantity</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["quantity_adf"]. '</td>
                      </tr>
                      <tr class="tableSpecs">
                        <th class="rowsOnSpecs">Dimensions</th>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Height</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["height"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Width</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["width"]. '</td>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Depth</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["depth"]. '</td>
                      </tr>
                      <tr class="tableSpecs">
                        <th class="rowsOnSpecs">Smart properties</th>
                      </tr>
                      <tr class="rowsOnSpecsTR">
                        <td class="rowsOnSpecs">Smart ecosystem</td>
                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class="rowsOnSpecs">'. $row["smart"]. '</td>
                      </tr>
                    </table></font></center>';
                  echo '</div>';
                echo '</div>';
                echo '<input type="hidden" id="categoryPRINT" name="categoryPRINT" value="'. $row["type"].  '">';
                //INFO OF PRODUCTS-END
                //PRICE OF PRODUCTS
                echo '<div class="productCardpreview">';
                if ($ekptwshPrice == $PriceMod) {
                  echo '<h2 align="right">'. $row["Price"]. '€</h2>';
                  echo '<input type="hidden" id="PricePRINT" name="PricePRINT" value="'. $row["Price"]. '">';
                  echo '<input type="hidden" id="EkptwshPRINT" name="EkptwshPRINT" value="">';
                  ...
                  echo '<input type="hidden" id="PricePRINT" name="PricePRINT" value="'. $row["PriceEkptwsh"]. '">';
                  echo '<input type="hidden" id="EkptwshPRINT" name="EkptwshPRINT" value="'. $row["Price"]. '">';
                }
                if ($brINbutton = 0) {
                ...
                echo '<form action="../../../Pages/PCBuilderPCBuild" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">';
                  ...
                  echo '<input type="hidden" id="piecePRINT" name="PRINTPiece" value="Printer">';
                  ...
                  echo '<input type="hidden" id="brandModelPRINT" name="brandModelPRINT" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                  echo '<input type="hidden" id="ProductCodePRINT" name="ProductCodePRINT" value="'. $row["ProductCode"]. '">';
                  echo '<input type="hidden" id="categoryPRINT" name="categoryPRINT" value="'. $row["type"].  '"><br><br>';
                  if ($ekptwshPrice == $PriceMod) {
                  ...
                  echo '<br><center><button type="button" class="collapsibleMin">Specs</button>';
                    echo '<div class="contentMin">';
                      echo '<table class="tableSpecsMin">
                        ...
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Print colour</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["print_colour"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Only for photos</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["only_photo"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Multifunction machine</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["multi_machine"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Consumable</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["analwsimo"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Consumable number</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["analwsimo_number"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Printer memory</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["printer_memory"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Paper size</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["paper_size"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Compatibility</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["compatibility"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                        ...
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Connectivity</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["connectivity"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                        ...
                        <!--ONE CATEGORY OF SPECS-->
                        <tr>
                          <th class="KEFALIDAmin">Printer</th>
                        </tr>
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Monochrome print speed</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["speed_white_print"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Colourful print speed</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["speed_colour_print"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Duplex print</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["duplex_print"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Maximum print resolution</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["max_dpi_print"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE CATEGORY OF SPECS-->
                        <!--ONE CATEGORY OF SPECS-->
                        <tr>
                          <th class="KEFALIDAmin">Scanner</th>
                        </tr>
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Monochrome scanning speed</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["speed_white_scan"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Colourful scanning speed</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["speed_colour_scan"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Maximum scanning resolution</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["max_dpi_scan"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Colour depth</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["colour_depth"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">ADF</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["ADF"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Duplex scanning</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["both_scan"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">ADF Paper quantity</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["quantity_adf"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE CATEGORY OF SPECS-->
                        <!--ONE CATEGORY OF SPECS-->
                        <tr>
                          <th class="KEFALIDAmin">Dimensions</th>
                        </tr>
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Height</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["height"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Width</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["width"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Depth</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["depth"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE CATEGORY OF SPECS-->
                        <!--ONE CATEGORY OF SPECS-->
                        <tr>
                          <th class="KEFALIDAmin">Smart properties</th>
                        </tr>
                        <!--ONE SPEC-->
                          <tr>
                            <td class="NameOfSpecsMin">Smart ecosystem</td>
                          </tr>
                          <tr>
                            <td class="FromDatabaseSpecsMin">'. $row["smart"]. '</td>
                          </tr>
                        <!--ONE SPEC-->
                        <!--ONE CATEGORY OF SPECS-->
                      </table>';
        ...
        if ($clearStep == 0 and $isset > 0 and $searcher == 0) {
          $keywords = "";
          $key = "";
          $key_javascript = "";
          $something_explode = "";
