...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-Ready PC Build-Category:<?php echo $_POST["categoryCPU"]; ?>/Microphone select</TITLE>
...
<?php
    ...
    if ($conn->connect_error) {
        ...
        echo '<form method="post" name="formFiltersModal"><div class="modal" id="modal1">
          <div class="modal-dialog" style="width: 700px;">
            ...
            <section class="modal-content">
                ...
                $issetStep = 0;
                if (isset($_POST["connSubmit"]) or isset($_POST["typeSubmit"]) or isset($_POST["colourSubmit"])) {
                    //connSubmit --- Connectivity
                    //typeSubmit --- Type
                    //volourSubmit --- Colour
                    $keywords = "";
                    $key = "";
                    ...
                    $sql = "SELECT * FROM Microphone_PC WHERE$keywords";
                } else {
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        if ($row["type"] == "Desktop") {
                            $desktop++;
                        } elseif ($row["type"] == "Lapel") {
                            $lapel++;
                        } elseif ($row["type"] == "Portable devices") {
                            $go_device++;
                        }
                        //Type --- END
                        //Colour --- START
                ...
                if (isset($_POST["connSubmit"]) and !isset($_POST["typeSubmit"]) and !isset($_POST["colourSubmit"])) {
                    //Variables for connectivity --- START
                    $usb = 0;
                    $jack = 0;
                    //Variables for connectivity --- END
                ...
                /////////////FOR 2 Submits --- START
                    ...
                    if (isset($_POST["connSubmit"]) and (isset($_POST["typeSubmit"]) or isset($_POST["colourSubmit"])) and $issetCategory == 2) {
                        $issetCategory++;
                        $key = $_POST["connSubmit"];
                        $sql = "SELECT * FROM Microphone_PC WHERE connection='$key'";
                        $result = $conn->query($sql);
                        if ($result->num_rows > 0) {
                            $issetStep = 0;
                    ...
                    if (isset($_POST["typeSubmit"]) and (isset($_POST["connSubmit"]) or isset($_POST["colourSubmit"])) and $issetCategory == 2) {
                        $issetCategory++;
                        $key = $_POST["typeSubmit"];
                        $sql = "SELECT * FROM Microphone_PC WHERE type='$key'";
                        $result = $conn->query($sql);
                        if ($result->num_rows > 0) {
                            $issetStep = 0;
                    ...
                    if (isset($_POST["colourSubmit"]) and (isset($_POST["connSubmit"]) or isset($_POST["typeSubmit"])) and $issetCategory == 2) {
                        $issetCategory++;
                        $key = $_POST["colourSubmit"];
                        $sql = "SELECT * FROM Microphone_PC WHERE colour='$key'";
                        $result = $conn->query($sql);
                        if ($result->num_rows > 0) {
                            $issetStep = 0;
                            if (isset($_POST["connSubmit"]) and $issetStep == 0) {
                ...
                /////////////FOR 3 Submits --- START
                    if (isset($_POST["connSubmit"]) and isset($_POST["typeSubmit"]) and isset($_POST["colourSubmit"])) {
                        ...
                        $keywords = " type='$key'";
                        $key = $_POST["connSubmit"];
                        $sql = "SELECT * FROM Microphone_PC WHERE connection='$key' AND$keywords";
                        $result = $conn->query($sql);
                        if ($result->num_rows > 0) {
                            //Variables for connectivity --- START
                            $usb = 0;
                ...
                //CREATE OPTION BOXES-------------------------------START
                    ...
                    if ($usb > 0 or $jack > 0) {
                        ...
                        <center>';
                            ...
                            if ($jack > 0) {
                                echo '<label class="containerRadioButtonOnRow">3.5mm Jack ('. $jack. ')
                                    <input type="radio" name="connSubmit" id="Jack" value="3.5mm Jack" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                                    <span class="checkmarkRadioButton"></span>
                                </label>&nbsp;&nbsp;&nbsp;';
                            } else {
                                echo '<label class="containerRadioButtonOnRow"><font color="#b3b3b3">3.5mm Jack (0)</font>
                                    <input type="radio" name="connSubmit" id="Jack" value="3.mm Jack" disabled> <!--checked="checked"-->
                                    <span class="checkmarkRadioButton"></span>
                                </label>&nbsp;&nbsp;&nbsp;';
                            }
                        echo '</center>';
                        if ($desktop > 0 or $lapel > 0 or $go_device > 0 or $black > 0 or $white > 0 or $colourful > 0 or $red > 0 or $brown > 0 or $blue > 0 or $pink > 0 or $grey > 0 or $tirkouaz > 0 or $green > 0 or $orange > 0 or $yellow > 0 or $other_colors > 0) {
                            echo '<br><hr class="hrModalBox"><br>';
                        }
                    }
                    //CONNECTION-------connSubmit--------END
                    //TYPE-------typeSubmit-------START
                    if ($desktop > 0 or $lapel > 0 or $go_device > 0) {
                        echo '<p class="typesOfDisksInCategorySSD">
                            <b>Connectivity</b>
                        </p><br>';
                            if ($desktop > 0) {
                                echo '<label class="containerRadioButton">Desktop ('. $desktop. ')
                                    <input type="radio" name="typeSubmit" id="Desktop" value="Desktop" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                                    <span class="checkmarkRadioButton"></span>
                                </label>&nbsp;&nbsp;&nbsp;';
                            } else {
                                echo '<label class="containerRadioButton"><font color="#b3b3b3">Desktop (0)</font>
                                    <input type="radio" name="typeSubmit" id="Desktop" value="Desktop" disabled> <!--checked="checked"-->
                                    <span class="checkmarkRadioButton"></span>
                                </label>&nbsp;&nbsp;&nbsp;';
                            }
                            if ($lapel > 0) {
                                echo '<label class="containerRadioButton">Lapel ('. $lapel. ')
                                    <input type="radio" name="typeSubmit" id="Lapel" value="Lapel" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                                    <span class="checkmarkRadioButton"></span>
                                </label>&nbsp;&nbsp;&nbsp;';
                            } else {
                                echo '<label class="containerRadioButton"><font color="#b3b3b3">Label (0)</font>
                                    <input type="radio" name="typeSubmit" id="Label" value="Label" disabled> <!--checked="checked"-->
                                    <span class="checkmarkRadioButton"></span>
                                </label>&nbsp;&nbsp;&nbsp;';
                            }
                            if ($go_device > 0) {
                                echo '<label class="containerRadioButton">Portable devices ('. $go_device. ')
                                    <input type="radio" name="typeSubmit" id="Portabledevices" value="Portable devices" onclick="footerModal();submitForFilters()"> <!--checked="checked"-->
                                    <span class="checkmarkRadioButton"></span>
                                </label>&nbsp;&nbsp;&nbsp;';
                            } else {
                                echo '<label class="containerRadioButton"><font color="#b3b3b3">Portable devices (0)</font>
                                    <input type="radio" name="typeSubmit" id="Portabledevices" value="Portable devices" disabled> <!--checked="checked"-->
                                    <span class="checkmarkRadioButton"></span>
                                </label>&nbsp;&nbsp;&nbsp;';
                            }
              ...
              <!--SCRIPT FOR CLEAR FILTERS-->
                <script>
                  function clearFiltersFunction() {';
                    ...
                    //TYPE--------------START
                    if (isset($_POST["typeSubmit"])) {
                        $something_explode = explode(' ', $_POST["typeSubmit"]);
                        foreach($something_explode as $something_explode) {
                            $type_submit_explode .= $something_explode;
                        }
        ...
        if(isset($_POST["searchBar"])) {
          ...
          if ($searcher == 1) {
            if ($notSearch == 0) {
              ...
              $sql = "SELECT * FROM Microphone_PC WHERE Description LIKE '%$search_expression%'";
              $result = $conn->query($sql);
              if ($result->num_rows <= 0) {
                $sql = "SELECT * FROM Microphone_PC WHERE Description LIKE '%$search_post%'";
                $result = $conn->query($sql);
                if ($result->num_rows <=0 ) {
                  $sql = "SELECT * FROM Microphone_PC WHERE $keywords";
                  $result = $conn->query($sql);
            ...
            if ($result->num_rows > 0) {
              ...
              while($row=$result->fetch_assoc()) {
                ...
                echo '<form action="../../../Pages/PCBuilderPCBuild" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">';
                    ...
                    echo '<input type="hidden" id="MICROPiece" name="MICROPiece" value="Microphone">';
                ...
                echo '<input type="hidden" id="brandModelMICRO" name="brandModelMICRO" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                echo '<b><font size="2px">Product Code: '. $row["ProductCode"]. '</font></b>';  
                echo '<input type="hidden" id="ProductCodeMICRO" name="ProductCodeMICRO" value="'. $row["ProductCode"]. '">';
                echo '<br><br><br><br><br>';
                echo '<button type="button" class="productCard-Button"></font></button>
                  ...
                  echo '</div>';
                echo '</div>';
                echo '<input type="hidden" id="categoryMICRO" name="categoryMICRO" value="PC Microphone">';
                //INFO OF PRODUCTS-END
                //PRICE OF PRODUCTS
                echo '<div class="productCardpreview">';
                if ($ekptwshPrice == $PriceMod) {
                  echo '<h2 align="right">'. $row["Price"]. '€</h2>';
                  echo '<input type="hidden" id="PriceMICRO" name="PriceMICRO" value="'. $row["Price"]. '">';
                  echo '<input type="hidden" id="EkptwshMICRO" name="EkptwshMICRO" value="">';
                  ...
                  echo '<input type="hidden" id="PriceMICRO" name="PriceMICRO" value="'. $row["PriceEkptwsh"]. '">';
                  echo '<input type="hidden" id="EkptwshMICRO" name="EkptwshMICRO" value="'. $row["Price"]. '">';
                }
                if ($brINbutton = 0) {
                ...
                echo '<form action="../../../Pages/PCBuilderPCBuild" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">';
                  ...
                  echo '<input type="hidden" id="pieceMICRO" name="MICROPiece" value="Monitor">';
                  ...
                  echo '<input type="hidden" id="brandModelMICRO" name="brandModelMICRO" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                  echo '<input type="hidden" id="ProductCodeMICRO" name="ProductCodeMICRO" value="'. $row["ProductCode"]. '">';
                  echo '<input type="hidden" id="categoryMICRO" name="categoryMICRO" value="PC Microphone"><br><br>';
                  if ($ekptwshPrice == $PriceMod) {
        ...
        if ($clearStep == 0 and (isset($_POST["connSubmit"]) or isset($_POST["typeSubmit"]) or isset($_POST["colourSubmit"])) and $searcher == 0) {
          $keywords = "";
          $conn_submit = "";
          $type_submit = "";
          $colour_submit = "";
          ...
          $colour_submit_explode = "";
            ...
            if (isset($_POST["typeSubmit"])) {
                ...
                if ($keywords == "") {
                    $keywords = " type='$type_submit'";
                } else {
                    $keywords .= " AND type='$type_submit'";
                }
            }
            //TYPE--------------END
            //COLOUR---------------START
