...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-Ready PC Build-Category:<?php echo $_POST["categoryCPU"]; ?>/Software select</TITLE>
    ...
    * {
    ...
    if ($_POST["brandModelCPU"] != "") {
        ...
        if ($notSearch == 0) {
          ...
          $sql = "SELECT * FROM SOFTWARE WHERE Category='$category' AND Description LIKE '%$search_expression%'";
          $result = $conn->query($sql);
          if ($result->num_rows <=0 ) {
            $sql = "SELECT * FROM SOFTWARE WHERE Category='$category' AND Description LIKE '%$search_post%'";
            $result = $conn->query($sql);
            if ($result->num_rows <=0 ) {
                $sql = "SELECT * FROM SOFTWARE WHERE Category='$category'$keywords";
                $result = $conn->query($sql);
                if ($result->num_rows <= 0) {
          ...
          if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo '<form action="../../../Pages/PCBuilderPCBuild" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">';
                    ...
                    echo '<input type="hidden" id="SOFTPiece" name="SOFTPiece" value="Software">';
                    ...
                    echo '<input type="hidden" id="brandModelSOFT" name="brandModelSOFT" value="'. $row["Brand"]. ' '. $row["Model"]. '">';
                    echo '<b><font size="2px">Product Code: '. $row["ProductCode"]. '</font></b>';  
                    echo '<input type="hidden" id="ProductCodeSOFT" name="ProductCodeSOFT" value="'. $row["ProductCode"]. '">';
                    echo '<br><br><br><br><br>';
                    echo '<button type="button" class="productCard-Button"></font></button>
                            ...
                            echo '<center><font color="black"><table class="tableSpecs">
                                    <tr class="rowsOnSpecsTR">
                                        <td class="rowsOnSpecs">Software Kind</td>
                                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td class="rowsOnSpecs">'. $row["kind"]. '</td>
                                    </tr>
                                    <tr class="rowsOnSpecsTR">
                                        <td class="rowsOnSpecs">Software Type</td>
                                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td class="rowsOnSpecs">'. $row["type"]. '</td>
                                    </tr>
                                    <tr class="rowsOnSpecsTR">
                                        <td class="rowsOnSpecs">Language</td>
                                        <td class="rowsOnSpecs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td class="rowsOnSpecs">'. $row["language"]. '</td>
                                    </tr>
                                    <tr class="rowsOnSpecsTR">
                            ...
                            echo '</div>';
                    echo '</div>';
                    echo '<input type="hidden" id="categorySOFT" name="categorySOFT" value="'. $row["Category"]. '">';
                    //INFO OF PRODUCTS-END
                    //PRICE OF PRODUCTS
                    echo '<div class="productCardpreview">';
                    if ($ekptwshPrice == $PriceMod) {
                    echo '<h2 align="right">'. $row["Price"]. '€</h2>';
                    echo '<input type="hidden" id="PriceSOFT" name="PriceSOFT" value="'. $row["Price"]. '">';
                    echo '<input type="hidden" id="EkptwshSOFT" name="EkptwshSOFT" value="">';
                    ...
                    echo '<input type="hidden" id="PriceSOFT" name="PriceSOFT" value="'. $row["PriceEkptwsh"]. '">';
                    echo '<input type="hidden" id="EkptwshSOFT" name="EkptwshSOFT" value="'. $row["Price"]. '">';
                    }
                    if ($brINbutton = 0) {
                    ...
                    echo '<input type="hidden" id="SOFTPiece" name="SOFTPiece" value="Software">';
                    echo '<img src="'. $row["Picture"]. '" alt="Software Picture" class="cardImgMin"><br><br>';
                    ...
                    echo '<div class="contentMin">
                            ...
                            <!--ONE SPEC-->
                            <tr>  
                                <td class="NameOfSpecsMin">Software Kind</td>
                            </tr>
                            <tr>
                                <td class="FromDatabaseSpecsMin">'. $row["kind"]. '</td>
                            </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                            <tr>  
                                <td class="NameOfSpecsMin">Software Type</td>
                            </tr>
                            <tr>
                            ...
                            <!--ONE SPEC-->
                            <tr>  
                                <td class="NameOfSpecsMin">Language</td>
                            </tr>
                            <tr>
                                <td class="FromDatabaseSpecsMin">'. $row["language"]. '</td>
                            </tr>
                            <!--ONE SPEC-->
                            <!--ONE SPEC-->
                            <tr>  
