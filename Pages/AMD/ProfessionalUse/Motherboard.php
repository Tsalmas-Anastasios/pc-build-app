...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-AMD/Category: Heavy Professional Use/Motherboard select</TITLE>
          ...
          <?php
            if (isset($_POST["hiddenButton"])) {
              if ($_POST["hiddenInput"] == "CPU") {
                ...
                echo '<form action="../../../../Pages/AMD/ProfessionalUse/PCCase" method="post" id="formButtonChange" name="formButtonChange">
    ...
    <div class="goToList" id="goToList">
      <form method="post" id="goToListForm" name="goToListForm">
        <?php
            ...
            //DATA FROM BLUETOOTH ADAPTERS
        ?>
        <CENTER><a onclick="cpuFun()" class="readyPiece"><font color="#42a832"><B><i class="fas fa-check-circle"></i> CPU </font><font color="#b32400"><i class="fas fa-long-arrow-alt-right"></i></font></B></a>
        <b><u>Motherboard</u></b> <font color="#b32400"><i class="fas fa-long-arrow-alt-right"></i></font>
        Ram <font color="#b32400"><i class="fas fa-long-arrow-alt-right"></i></font>
        ...
        if ($notSearch == 0) {
          ...
          if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                  ...
                  if ($cpuMod == "AMD" && $row["Socket"] == $_POST["SocketCPU"]) {
                    foreach($microMod as $microMod) {     //echo $microMod. '<br>'; 
                      ...
                      if ($_POST["hiddenInput"] == "CPU") {
                        ...
                        echo '<form action="../../../../Pages/AMD/ProfessionalUse/PCCase" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                              <input type="hidden" id="hiddenInput" name="hiddenInput" value="CASE">';
                              //DATA FROM RAM CHOOSE
                              echo '<input type="hidden" id="RamPiece" name="RamPiece" value="Ram">';
                              echo '<input type="hidden" id="brandModelRAM" name="brandModelRAM" value="'. $_POST["brandModelRAM"]. '">';
