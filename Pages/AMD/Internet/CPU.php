...
<HEAD>
	...
	<TITLE>PC Build App-PC Builder-AMD/Category: Internet, Office, Simple Gaming, Movies/CPU select</TITLE>
    ...
    <link rel="stylesheet" href="../../../../StyleSheets/TabsInPCBuilderAMD.css">
...
<SECTION>
    ...
    <div class="backToCategoriesButton"> 
      ...
      <div class="goToList" id="goToList">
        <CENTER><B><U>CPU</U></B> <font color="#b32400"><i class="fas fa-long-arrow-alt-right"></i></font>
        Motherboard <font color="#b32400"><i class="fas fa-long-arrow-alt-right"></i></font>
      ...
      <?php
        ...
        if ($notSearch == 0) {
          ...
          $sql = "SELECT * FROM CPU WHERE Category='Internet, Office, Simple Gaming, Movies' AND Description LIKE '%$search_expression%'";
          $result = $conn->query($sql);
          if ($result->num_rows <=0 ) {
            $sql = "SELECT * FROM CPU WHERE Category='Internet, Office, Simple Gaming, Movies' AND Description LIKE '%$search_post%'";
            $result = $conn->query($sql);
            if ($result->num_rows <=0 ) {
              $sql = "SELECT * FROM CPU WHERE Category='Internet, Office, Simple Gaming, Movies'$keywords";
              $result = $conn->query($sql);
            }
          }
          if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
              ...
              if ($brandMod == "AMD") {
                ...
                echo '<div class="productCardContainer" id="productCardContainer'. $onoma_for_title. '">';
                  ...
                  echo '</div>';
                  echo '<input type="hidden" id="categoryCPU" name="categoryCPU" value="Internet, Office, Simple Gaming, Movies">';
		...
		<center><div class="no-results-search-message">
        	We do not have SOMETHING right now. Please search for an other product!
              ...
              $sql = "SELECT * FROM CPU WHERE Category='Internet, Office, Simple Gaming, Movies'";
              $result = $conn->query($sql);
