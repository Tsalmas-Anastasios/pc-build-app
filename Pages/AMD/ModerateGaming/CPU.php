...
<HEAD>
	...
	<TITLE>PC Build App-PC Builder-AMD/Category: Moderate Gaming/CPU select</TITLE>
    ...
    <div class="backToCategoriesButton"> 
      ...
      <?php
        ...
        if ($notSearch == 0) {
          ...
          $sql = "SELECT * FROM CPU WHERE Category='Moderate Gaming' AND Description LIKE '%$search_expression%'";
          $result = $conn->query($sql);
          if ($result->num_rows <=0 ) {
            $sql = "SELECT * FROM CPU WHERE Category='Moderate Gaming' AND Description LIKE '%$search_post%'";
            $result = $conn->query($sql);
            if ($result->num_rows <=0 ) {
              $sql = "SELECT * FROM CPU WHERE Category='Moderate Gaming'$keywords";
              $result = $conn->query($sql);
            }
          }
          if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
              ...
              if ($brandMod == "AMD") {
                ...
                echo '<div class="productCardContainer" id="productCardContainer'. $onoma_for_title. '">';
                  ...
                  echo '</div>';
                  echo '<input type="hidden" id="categoryCPU" name="categoryCPU" value="Moderate Gaming">';
		...
		<center><div class="no-results-search-message">
        	We do not have SOMETHING right now. Please search for an other product!
              ...
              $sql = "SELECT * FROM CPU WHERE Category='Moderate Gaming'";
              $result = $conn->query($sql);
