...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-AMD/Category: Moderate Gaming/Ram select</TITLE>
          ...
          if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
              ...
              if ($metra == "0") {
                ...
                echo "<br><br><br>";
                echo '<form action="../../../../Pages/AMD/ModerateGaming/Motherboard" method="post" name="NothingForm">';
