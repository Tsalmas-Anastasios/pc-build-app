...
<head>
	...
	<TITLE>PC Build App-PC Builder-AMD/Category: Moderate Gaming/PC Case select</TITLE>
...
<SECTION>
    ...
    <div class="backToCategoriesButton"> 
          ...
          <?php
            if (isset($_POST["hiddenButton"])) {
              if ($_POST["hiddenInput"] == "CPU") {
                echo '<form action="../../../../Pages/AMD/ModerateGaming/CPU" method="post" id="formButtonChange" name="formButtonChange">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="CPU">';
              } elseif ($_POST["hiddenInput"] == "MOTHERBOARD") {
                echo '<form action="../../../../Pages/AMD/ModerateGaming/Motherboard" method="post" id="formButtonChange" name="formButtonChange">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="MOTHERBOARD">';
              } elseif ($_POST["hiddenInput"] == "RAM") {
                echo '<form action="../../../../Pages/AMD/ModerateGaming/RAM" method="post" id="formButtonChange" name="formButtonChange">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="RAM">';
              } elseif ($_POST["hiddenInput"] == "GPU") {
                echo '<form action="../../../../Pages/AMD/ModerateGaming/GPU" method="post" id="formButtonChange" name="formButtonChange">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="GPU">';
              } elseif ($_POST["hiddenInput"] == "PSU") {
                echo '<form action="../../../../Pages/AMD/ModerateGaming/PSU" method="post" id="formButtonChange" name="formButtonChange">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="PSU">';
              } elseif ($_POST["hiddenInput"] == "HARD") {
                echo '<form action="../../../../Pages/AMD/ModerateGaming/HardDrive" method="post" id="formButtonChange" name="formButtonChange">
        ...
        <!--<br>-->
          <script>
              function cpuFun() {
                  document.getElementById("goToListForm").action = "../../../../Pages/AMD/ModerateGaming/CPU";
                  var submitForm = document.getElementsByName('goToListForm')
                  submitForm[0].submit();
              }

              function motherFun() {
                  document.getElementById("goToListForm").action = "../../../../Pages/AMD/ModerateGaming/Motherboard";
                  var submitForm = document.getElementsByName('goToListForm')
                  submitForm[0].submit();
              }

              function ramFun() {
                  document.getElementById("goToListForm").action = "../../../../Pages/AMD/ModerateGaming/Ram";
                  var submitForm = document.getElementsByName('goToListForm')
                  submitForm[0].submit();
              }

              function gpuFun() {
                        document.getElementById("goToListForm").action = "../../../../Pages/AMD/ModerateGaming/GPU";
                        var submitForm = document.getElementsByName('goToListForm')
                        submitForm[0].submit();
              }

              function psuFun() {
                        document.getElementById("goToListForm").action = "../../../../Pages/AMD/ModerateGaming/PSU";
                        var submitForm = document.getElementsByName('goToListForm')
                        submitForm[0].submit();
              }

              function hardFun() {
                        document.getElementById("goToListForm").action = "../../../../Pages/AMD/ModerateGaming/HardDrive";
                        var submitForm = document.getElementsByName('goToListForm')
                        submitForm[0].submit();
              }
            </script>
		...
		<center><div class="no-one-character-message">
            ...
            if ($result->num_rows > 0) {
              ...
              while($row=$result->fetch_assoc()) {
                ...
                if ($_POST["hiddenInput"] == "CPU") {
                  echo '<form action="../../../../Pages/AMD/ModerateGaming/CPU" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                    <input type="hidden" id="hiddenInput" name="hiddenInput" value="CPU">';
                } elseif ($_POST["hiddenInput"] == "MOTHERBOARD") {
                  echo '<form action="../../../../Pages/AMD/ModerateGaming/Motherboard" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                    <input type="hidden" id="hiddenInput" name="hiddenInput" value="MOTHERBOARD">';
                } elseif ($_POST["hiddenInput"] == "RAM") {
                  echo '<form action="../../../../Pages/AMD/ModerateGaming/RAM" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                    <input type="hidden" id="hiddenInput" name="hiddenInput" value="RAM">';
                } elseif ($_POST["hiddenInput"] == "GPU") {
                  echo '<form action="../../../../Pages/AMD/ModerateGaming/GPU" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                    <input type="hidden" id="hiddenInput" name="hiddenInput" value="GPU">';
                } elseif ($_POST["hiddenInput"] == "PSU") {
                  echo '<form action="../../../../Pages/AMD/ModerateGaming/PSU" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                    <input type="hidden" id="hiddenInput" name="hiddenInput" value="PSU">';
                } elseif ($_POST["hiddenInput"] == "HARD") {
                  echo '<form action="../../../../Pages/AMD/ModerateGaming/HardDrive" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                    <input type="hidden" id="hiddenInput" name="hiddenInput" value="HARD">';
                } elseif ($_POST["hiddenInput"] == "CASE") {
