...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-AMD/Category: Hard Gaming in 1440p/Ram select</TITLE>
          ...
          if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
              ...
              if ($metra == "0") {
                ...
                echo "<br><br><br>";
                echo '<form action="../../../../Pages/AMD/Gaming1440p/Motherboard" method="post" name="NothingForm">';
