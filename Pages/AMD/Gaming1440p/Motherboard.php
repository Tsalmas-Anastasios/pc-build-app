...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-AMD/Category: Hard Gaming in 1440p/Motherboard select</TITLE>
          ...
          <?php
            if (isset($_POST["hiddenButton"])) {
              if ($_POST["hiddenInput"] == "CPU") {
                ...
                echo '<form action="../../../../Pages/AMD/Gaming1440p/PCCase" method="post" id="formButtonChange" name="formButtonChange">
                  ...
                  if ($cpuMod == "AMD" && $row["Socket"] == $_POST["SocketCPU"]) {
                    foreach($microMod as $microMod) {     //echo $microMod. '<br>'; 
                      ...
                      if ($_POST["hiddenInput"] == "CPU") {
                        ...
                        echo '<form action="../../../../Pages/AMD/Gaming1440p/PCCase" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                              <input type="hidden" id="hiddenInput" name="hiddenInput" value="CASE">';
                              //DATA FROM RAM CHOOSE
                              echo '<input type="hidden" id="RamPiece" name="RamPiece" value="Ram">';
                              echo '<input type="hidden" id="brandModelRAM" name="brandModelRAM" value="'. $_POST["brandModelRAM"]. '">';
