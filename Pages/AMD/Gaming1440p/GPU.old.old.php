...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-AMD/Category: Hard Gaming in 1440p/GPU select</TITLE>
    ...
    <link rel="stylesheet" href="../../../../StyleSheets/AMD/buttonForCpuGpu.css">
...
<div id="myTopnav" class="topnav" style="z-index: 9999;">
  ...
  <a href="../../../Pages/eShop/eshop" target="_blank"><i class="fas fa-cart-arrow-down"></i> e-Shop</a>
  <div class="dropdown">
  ...
  <div class="dropdown">
	<button class="dropbtn"><i class="fas fa-question"></i> Tips
      <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-content">
...
<SECTION>
    ...
    <div class="backToCategoriesButton"> 
      ...
      <div class="goToList" id="goToList">
          ...
          ?>
				  ...
				  <b><font color="#42a832"><a onclick="ramFun()" class="readyPiece"><i class="fas fa-check-circle"></i> Ram</a></font></b><font color="#b32400"><i class="fas fa-long-arrow-alt-right"></i></font>
			  	  <b><u>GPU</u></b> <font color="#b32400"><i class="fas fa-long-arrow-alt-right"></i></font>
      ...
      if ($_POST["brandModelCPU"] != "") {
        ...
        <form action="../../../../Pages/AMD/Gaming1440p/PSU" method="post" name="NothingForm">
      ...
      $conn->close();
        if ($_POST["gpuCPU"] != "-") {
          echo '<br><br>';
          if ($_POST["hiddenInput"] == "CPU") {
            echo '<form action="../../../../Pages/AMD/Gaming1440p/CPU" method="post" id="formNoGPU" name="formNoGPU">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="CPU">';
          } elseif ($_POST["hiddenInput"] == "MOTHERBOARD") {
            echo '<form action="../../../../Pages/AMD/Gaming1440p/Motherboard" method="post" id="formNoGPU" name="formNoGPU">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="MOTHERBOARD">';
          } elseif ($_POST["hiddenInput"] == "RAM") {
            echo '<form action="../../../../Pages/AMD/Gaming1440p/GPU" method="post" id="formNoGPU" name="formNoGPU">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="GPU">';
          } elseif ($_POST["hiddenInput"] == "GPU") {
            echo '<form action="../../../../Pages/AMD/Gaming1440p/PSU" method="post" id="formNoGPU" name="formNoGPU">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="PSU">';
          } elseif ($_POST["hiddenInput"] == "PSU") {
            echo '<form action="../../../../Pages/AMD/Gaming1440p/PSU" method="post" id="formNoGPU" name="formNoGPU">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="PSU">';
          } elseif ($_POST["hiddenInput"] == "HARD") {
            echo '<form action="../../../../Pages/AMD/Gaming1440p/HardDrive" method="post" id="formNoGPU" name="formNoGPU">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="HARD">';
                  //DATA FROM PSU CHOOSE
                  echo '<input type="hidden" id="PSUPiece" name="PSUPiece" value="PSU">';
                  echo '<input type="hidden" id="brandModelPSU" name="brandModelPSU" value="'. $_POST["brandModelPSU"]. '">';
            ...
            echo '<form action="../../../../Pages/AMD/Gaming1440p/PCCase" method="post" id="formNoGPU" name="formNoGPU">
                  <input type="hidden" id="hiddenInput" name="hiddenInput" value="CASE">';
                  //DATA FROM PSU CHOOSE
                  echo '<input type="hidden" id="PSUPiece" name="PSUPiece" value="PSU">';
                  echo '<input type="hidden" id="brandModelPSU" name="brandModelPSU" value="'. $_POST["brandModelPSU"]. '">';
