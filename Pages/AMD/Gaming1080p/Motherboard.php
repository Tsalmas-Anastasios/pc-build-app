...
<html lang="en">
	...
	<TITLE>PC Build App-PC Builder-AMD/Category: Hard Gaming in 1080p/Motherboard select</TITLE>
...
<SECTION>
          ...
          <?php
            if (isset($_POST["hiddenButton"])) {
              if ($_POST["hiddenInput"] == "CPU") {
                ...
                echo '<form action="../../../../Pages/AMD/Gaming1080p/PCCase" method="post" id="formButtonChange" name="formButtonChange">
    ...
    if ($_POST["brandModelCPU"] != "") {
        ...
        if ($notSearch == 0) {
          ...
          $sql = "SELECT * FROM MOTHERBOARD WHERE Category='Hard Gaming in 1080p' AND Description LIKE '%$search_expression%'";
          $result = $conn->query($sql);
          if ($result->num_rows <=0 ) {
            $sql = "SELECT * FROM MOTHERBOARD WHERE Category='Hard Gaming in 1080p' AND Description LIKE '%$search_post%'";
            $result = $conn->query($sql);
            if ($result->num_rows <=0 ) {
              $sql = "SELECT * FROM MOTHERBOARD WHERE Category='Hard Gaming in 1080p'$keywords";
              $result = $conn->query($sql);
            }
          }
          if ($result->num_rows > 0) {
                  ...
                  if ($cpuMod == "AMD" && $row["Socket"] == $_POST["SocketCPU"]) {
                    foreach($microMod as $microMod) {     //echo $microMod. '<br>'; 
                      ...
                      if ($_POST["hiddenInput"] == "CPU") {
                        ...
                        echo '<form action="../../../../Pages/AMD/Gaming1080p/PCCase" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                              <input type="hidden" id="hiddenInput" name="hiddenInput" value="CASE">';
                              //DATA FROM RAM CHOOSE
                              echo '<input type="hidden" id="RamPiece" name="RamPiece" value="Ram">';
                              echo '<input type="hidden" id="brandModelRAM" name="brandModelRAM" value="'. $_POST["brandModelRAM"]. '">';
                    ...
                    //DATA FROM BLUETOOTH ADAPTERS
                        ...
                        echo '</div>';
                        echo '<input type="hidden" id="categoryMOTHER" name="categoryMOTHER" value="Hard Gaming in 1080p">';
		...
		<center><div class="no-results-search-message">
            ...
            $sql = "SELECT * FROM MOTHERBOARD WHERE Category='Hard Gaming in 1080p'";
            $result = $conn->query($sql);
