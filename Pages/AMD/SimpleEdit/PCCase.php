...
<head>
	...
	<TITLE>PC Build App-PC Builder-AMD/Category: Simple Edit/PC Case select</TITLE>
    ...
    <div class="backToCategoriesButton"> 
          ...
          <?php
            if (isset($_POST["hiddenButton"])) {
              if ($_POST["hiddenInput"] == "CPU") {
                ...
                echo '<form action="../../../../Pages/AMD/SimpleEdit/RAM" method="post" id="formButtonChange" name="formButtonChange">
        ...
        <!--<br>-->
          <script>
              ...
              function ramFun() {
                  document.getElementById("goToListForm").action = "../../../../Pages/AMD/SimpleEdit/Ram";
                  var submitForm = document.getElementsByName('goToListForm')
                  submitForm[0].submit();
              }

              function gpuFun() {
                        document.getElementById("goToListForm").action = "../../../../Pages/AMD/SimpleEdit/GPU";
                        var submitForm = document.getElementsByName('goToListForm')
                        submitForm[0].submit();
              }

              function psuFun() {
                        document.getElementById("goToListForm").action = "../../../../Pages/AMD/SimpleEdit/PSU";
                        var submitForm = document.getElementsByName('goToListForm')
                        submitForm[0].submit();
              }

              function hardFun() {
                        document.getElementById("goToListForm").action = "../../../../Pages/AMD/SimpleEdit/HardDrive";
                        var submitForm = document.getElementsByName('goToListForm')
                        submitForm[0].submit();
              }
            </script>
            ...
            if ($result->num_rows > 0) {
              ...
              while($row=$result->fetch_assoc()) {
                ...
                if ($_POST["hiddenInput"] == "CPU") {
                  ...
                  echo '<form action="../../../../Pages/AMD/SimpleEdit/RAM" method="post" id="form'. $onoma_for_title./*id for form in product card*/ '" name="form'. $onoma_for_title./*id for form in product card*/'">
                    <input type="hidden" id="hiddenInput" name="hiddenInput" value="RAM">';
                } elseif ($_POST["hiddenInput"] == "GPU") {
