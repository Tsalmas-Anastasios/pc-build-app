                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="order-condition">
                                                <?php
                                                    if ($row["order_condition"] == "Placed") {
                                                        echo '<div class="text placed">
                                                            <i class="fas fa-location-arrow"></i>'. $row["order_condition"]. '
                                                        </div>';
                                                    } elseif ($row["order_condition"] == "Saved") {
                                                        echo '<div class="text saved">
                                                            <i class="fas fa-bookmark"></i>'. $row["order_condition"]. '
                                                        </div>';
                                                    } elseif ($row["order_condition"] == "Deleted") {
                                                        echo '<div class="text delete">
                                                            <i class="fas fa-trash"></i>'. $row["order_condition"]. '
                                                        </div>';
                                                    } elseif ($row["order_condition"] == "Completed") {
                                                        echo '<div class="text complete">
                                                            <i class="fas fa-check-circle"></i>'. $row["order_condition"]. '
                                                        </div>';
                                                    }
                                                ?>
                                            </div>
